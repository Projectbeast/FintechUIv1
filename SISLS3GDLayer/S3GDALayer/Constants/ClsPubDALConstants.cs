...
namespace S3GDALayer.Constants
{
    public class ClsPubDALConstants
    {
        ...
        public const string CHK_RETDATE = "CHK_RETDATE"; //Collection Report
        ...
        public const string INPUTPARMMarkettingUserId = "@Marketting_User_Id";
        ...
        public const string INPUTPARAMDBTCOLL = "@DEBTCOLL";
        ...
        public const string SMECustomer = "@SMECustomer";
        public const string ComplianceId = "@ComplianceId";
        public const string NTDType = "@NTDType";
        public const string CashRangeFrom = "@CashRangeFrom";
        public const string CashRangeTo = "@CashRangeTo";
        ...
        public const string INPUTPARAMISCHEQUE = "@ISCHEQUE";

        public const string INPUTPARAMISOVERDUE = "@ISOVERDUE";

        public const string INPUTPARAMDEBTCOLLECTORCODE = "@DEBTCOLLECTOR_CODE";
        ...
        public const string ASSET_COST = "ASSET_COST";
        public const string FINANCE_AMOUNT = "FINANCE_AMOUNT";
        public const string TENURE = "TENURE";
        public const string MARKETING_OFFICER = "MARKETING_OFFICER";
        public const string RATE = "RATE";
        public const string COMPANY_IRR = "COMPANY_IRR";
        ...
        /* To display columns in SOA and CAG reports - Account Asset details Grid */
        public const string ACCOUNTSTATUS = "ACCOUNTSTATUS";
        public const string PA_SA_REF_ID = "PA_SA_REF_ID";

        public const string UNBILLED_PRINCIPAL = "UNBILLED_PRINCIPAL";

        public const string UNBILLED_INTEREST = "UNBILLED_INTEREST";
        /* Added by Sangeetha R on 12-Aug-2016 for Oracle Conversion from SQL Product end */

        public const string BILLED = "BILLED";

        public const string TOTALRECEIVABLE = "TOTALRECEIVABLE";
        ...
        public const string NOOFINSTDUE = "NOOFINSTDUE";
        ...
        public const string NOOFCHQRT = "NOOFCHQRT";
        ...
        public const string ACCOUNTDATE = "ACCOUNTDATE";
        ...
        public const string DEBTCOLLECTOR = "DEBTCOLLECTOR";
       ...
       // public const string AGEING60DAYS = "AGEING60DAYS";
        ...
        //Collection Report
        public const string MOBILENUMBER = "MOBILE";
       ...
       // public const string LOCATION_ID = "LOCATION_ID";
        ...
        public const string Prdt_ID = "@Prdt_ID";
        //Journal Query
        ...
        public const string INPUTDATE_1 = "INPUTDATE_1";

         // Added Input and Output Parameters for adding Drawee Bank and Instrument No by Manikandan. R
        public const string BANK = "BANK";
        public const string Instrument_Number = "INSTRUMENT_NUMBER";
        public const string INPUTDRAWEEBANK = "@BANK";
        // Added End
