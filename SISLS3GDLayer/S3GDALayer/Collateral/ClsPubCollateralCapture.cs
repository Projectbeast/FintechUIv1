            ...
            public int FunPubCreateCollateralCapture(SerializationMode SerMode, byte[] bytesObjCollateralCaptureDataTable, out string StrCollCap_No)
            {
                ...
                try
                {
                    ...
                    if (enumDBType == S3GDALDBType.ORACLE)
                    {
                        ...
                        param = new OracleParameter("@XML_LienAccountDetails",
                           OracleType.Clob, ObjCollateralCaptureRow.XML_Lien_Accounts.Length,
                           ParameterDirection.Input, true, 0, 0, String.Empty,
                           DataRowVersion.Default, ObjCollateralCaptureRow.XML_Lien_Accounts);
                        command.Parameters.Add(param);
                    ...
                    else
                    {
                        ...
                        db.AddInParameter(command, "@XML_LienAccountDetails", DbType.String, ObjCollateralCaptureRow.XML_Lien_Accounts);
                    }
                    ...
                    db.AddInParameter(command, "@CrossCollateralRef_Number", DbType.String, ObjCollateralCaptureRow.CrossCollateralReferenceNumber);
                    db.AddInParameter(command, "@GroupCollateralRef_Number", DbType.String, ObjCollateralCaptureRow.GroupCollateralReferenceNumber);
                    db.AddInParameter(command, "@Remarks", DbType.String, ObjCollateralCaptureRow.Remarks);
                    db.AddInParameter(command, "@AmountApproved", DbType.String, ObjCollateralCaptureRow.AmountApproved);
