...
function LoadDynamictTabIframe(name, value, tabcount) {
    ...
    tabID++;
   // alert(tabID);
    $('#ulContainer').append($('<li id="li' + tabID + '" class="active"><a href="#tab' + tabID + '" role="tab" data-toggle="tab" onclick="LoadbasedonTab(this)"> ' + name + '<button   class="close ml-2" style="margin-top:-2px;" type="button" title="Close">×</button></a></li>'));
...
function LoadbasedonTab(obj) {
   ...
   $('#ulContainer >li').removeClass('active');
