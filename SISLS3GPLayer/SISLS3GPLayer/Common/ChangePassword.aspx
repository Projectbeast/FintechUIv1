                        ...
                        <div id="tab-content" class="tab-content">
                            <div class="tab-pane fade in active show" id="tab1">
                                ...
                                <div align="right">
                                    ...
                                    <button class="btn btn-success" id="btnSaveChg" onclick="if(fnCheckPageValidators('btnSaveChgPWD'))" causesvalidation="false" onserverclick="btnSave_Click" runat="server"
                                        type="button" validationgroup="btnSaveChgPWD">
                                        <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>C</u>hange Password
                                    </button>
                                   <button class="btn btn-success" id="btnCancel" onclick="if(fnConfirmExit())" causesvalidation="false" onserverclick="btnCancel_Click" runat="server"
