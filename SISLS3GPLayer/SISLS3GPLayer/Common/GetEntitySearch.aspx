                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="row" style="float: right; margin-top: 5px;">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <button id="btnGo" runat="server" accesskey="G" causesvalidation="false" class="btn btn-success" onserverclick="btnGo_Click" title="Go[Alt+G]" type="button">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <button class="btn btn-success" id="btnExit" title="Exit[Alt+X]" onclick="ScreenClose();" causesvalidation="false" runat="server"
