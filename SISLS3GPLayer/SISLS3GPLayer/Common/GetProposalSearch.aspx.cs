...
public partial class Common_GetAccountSearch : ApplyThemeForProject
{
    ...
    protected void gvList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            LinkButton lblProposalNo = (LinkButton)e.Row.FindControl("lblProposalNo");
            ...
            lblProposalNo.Attributes.Add("onclick", strScripts);
    ...
    {
        if (txtAccountNumber.Text.Trim() == string.Empty && txtBranchName.Text.Trim() == string.Empty && txtcustomerName.Text.Trim() == string.Empty && txtCustomerCode.Text.Trim() == string.Empty && txtApplicationNo.Text.Trim() == string.Empty  )
        {
    ...
    {
        txtCustomerCode.Text = txtcustomerName.Text = txtBranchName.Text = txtAccountNumber.Text  = string.Empty;
        txtAccountNumber.Focus();
