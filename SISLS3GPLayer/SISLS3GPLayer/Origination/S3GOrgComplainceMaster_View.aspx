<%@ Page Language="C#" AutoEventWireup="true" CodeFile="S3GOrgComplainceMaster_View.aspx.cs"
    MasterPageFile="~/Common/S3GMasterPageCollapse.master" Inherits="Origination_S3GOrgComplainceMaster_View" %>
            ...
            <div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="md-input">
                            <asp:TextBox ID="txtEffectiveFromDate" runat="server" ToolTip="Effective From Date"
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="md-input">
                            <asp:TextBox ID="txtEffectiveToDate" runat="server" ToolTip="Effective To Date"
                                class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                            ...
                            <span class="bar"></span>
                            <label>
                                <asp:Label ID="lblEffectiveTo" runat="server" Text="Effective To Date" ToolTip="Effective To Date" />
                            </label>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="md-input">
                            <asp:DropDownList ID="ddlComplainceType" runat="server" ToolTip="Compliance Type" class="md-form-control form-control">
                            </asp:DropDownList>
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label class="tess">
                                <asp:Label ID="lblComplainceType" runat="server" Text="Compliance Type" ToolTip="Compliance Type" />
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <asp:GridView ID="grvTransLander" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="styleGridHeader"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnQuery" runat="server" CommandArgument='<%# Bind("COMPLAINCE_ID") %>' CommandName="Query" CssClass="styleGridQuery" ImageUrl="~/Images/spacer.gif" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    <HeaderStyle CssClass="styleGridHeader" />
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnEdit" runat="server" CommandArgument='<%# Bind("COMPLAINCE_ID") %>' CommandName="Modify" CssClass="styleGridEdit" ImageUrl="~/Images/spacer.gif" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Left">
                                    <HeaderStyle CssClass="styleGridHeader" />
                                    <HeaderTemplate>
                                        <asp:Label ID="lblHTComplainceType" runat="server" Text="Compliance Type"></asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblITComplainceType" runat="server" Text='<%# Bind("Complaince_Type") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblComplainceTypeID" Visible="false" runat="server" Text='<%# Bind("Complaince_Type_ID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Left">
                                    <HeaderStyle CssClass="styleGridHeader" />
                                ...
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCreatedOn" Visible="false" runat="server" Text='<%#Eval("Created_on")%>'></asp:Label>
                ...
                <%--<div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row" style="float: right; margin-top: 5px;">
                            <div class="col-lg-3 col-md-4 col-sm-9 col-xs-12" style="margin-left: 10px;">
                                ...
                                <asp:Button Text="Search" ValidationGroup="RFVDTransLander" ID="btnSearch" runat="server"
                                    CssClass="save_btn fa fa-floppy-o" UseSubmitBehavior="true" ToolTip="Search,Alt+F" AccessKey="F" OnClick="btnSearch_Click" />
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-9 col-xs-12" style="margin-left: 10px;">
                                <i class="fa fa-eraser btn_i" aria-hidden="true"></i>
                                <asp:Button Text="Create" ID="btnCreate" runat="server" CssClass="save_btn fa fa-eraser-o"
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-9 col-xs-12" style="margin-left: 10px;">
                                ...
                                <asp:Button Text="Clear" ID="btnClear" runat="server" CssClass="save_btn fa fa-share-o" ToolTip="Clear,Alt+L" AccessKey="L"
                ...
                <%--  <div align="right" class="fixed_btn">
                    <button class="css_btn_enabled" id="btnSearch" title="Search[Alt+F]" causesvalidation="false"
                        onserverclick="btnSearch_Click" runat="server"
                        type="button" accesskey="F">
                        <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>S</u>earch
                    </button>
                    ...
                    <button class="css_btn_enabled" id="btnClear" title="Clear[Alt+L]" onclick="if(fnConfirmClear())" causesvalidation="false"
                        ...
                        <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;C<u>l</u>ear
                    </button>
                </div>--%>
                <div align="right" class="fixed_btn">
