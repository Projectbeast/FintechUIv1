...
public partial class Origination_S3GOrgGlobalCreditParameter_View : ApplyThemeForProject 
{
    #region Paging Config

    string strRedirectPage = "~/Origination/S3GOrgGlobalCreditParameter_Add.aspx";
    int intNoofSearch = 3;
    //string[] arrSortCol = new string[] { "LOB", "Product", "Constitution", "" };
    ...
    string strProcName = "S3G_ORG_GetGlobalCreditParameter_Paging";
    ...
    protected void grvPaging_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case "modify":
                Response.Redirect(strRedirectPage + "?qsGCPID=" + FormsAuthentication.Encrypt(Ticket) + "&qsMode=M");
                break;
            case "query":
                Response.Redirect(strRedirectPage + "?qsGCPID=" + FormsAuthentication.Encrypt(Ticket) + "&qsMode=Q");
                break;
        }
    }
