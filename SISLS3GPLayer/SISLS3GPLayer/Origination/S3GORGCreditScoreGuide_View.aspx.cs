...
/// Purpose         :   To view credit score guide details
...
public partial class S3GORGCreditScoreGuide_View : ApplyThemeForProject
{
    #region Paging Config

    string strRedirectPage = "~/Origination/S3GORGCreditScoreGuide_Add.aspx";
    int intNoofSearch = 3;
    ...
    //string[] arrSortCol = new string[] { "LOB_Code", "Product_Code", "Constitution_Code", "" };
    string strProcName = "S3G_ORG_GetCreditScore_Paging";
