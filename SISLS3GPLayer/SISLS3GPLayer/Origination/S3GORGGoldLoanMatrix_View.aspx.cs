...
public partial class Origination_S3GORGGoldLoanMatrix_View : ApplyThemeForProject
{
    #region Paging Config
    string strRedirectPage = "~/Origination/S3GORGGoldLoanMatrix_Add.aspx";
    int intNoofSearch = 5;
    int intSortNoofSearch = 6;
    string strDateFormat;
    string[] arrSortCol = new string[] { "Name", "Asset_Description", "Product_Name", "Constitution_Name", "LocationCat_Description", "Eff_Date" };
    string strProcName = "S3G_ORG_GetgoldLoanMatrix_Paging";
    ...
    {
        arrSearchVal = new ArrayList(intSortNoofSearch);
    ...
    protected void grvPaging_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        Int32 intRowID = int.Parse(e.CommandArgument.ToString());
