        ...
        <ContentTemplate>
            <div>
                <div class="row m-0">
                    ...
                    <div class="col mr-3">
                        <div class="float-right">
                            <button runat="server" id="btnCancel" accesskey="T" title="Exit[Alt+T]" text="Exit" onclick="if(fnConfirmExit())"
                                validationgroup="PRDDC" causesvalidation="false" class="btn btn-outline-success btn-create" onserverclick="btnCancel_Click" type="submit">
                ...
                <div class="scrollable-content">
                    <div class="mx-2 py-3 section-box">
                        ...
                        <div align="right">
                            <button class="btn btn-success mr-2" id="btnGo" title="Go[Alt+G]" accesskey="G" runat="server"
                                onserverclick="btnGo_Click" validationgroup="PRDDC" type="button">
                                <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>&emsp;<u>G</u>o
                            </button>
                            <button id="lnkCopyProfile" runat="server" title="Copy Profile,Alt+C" onclick="return fnCopyProfile();" class="btn btn-success mr-2" causesvalidation="false"
                                type="button" accesskey="C">
                                <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>C</u>opy Profile
                            </button>
                            <button id="lnkHideCopyProfile" runat="server" class="btn btn-success" title="Hide Copy Profile,Alt+H" style="display: none;" onclick="return fnHideCopyProfile();" causesvalidation="false"
                        ...
                        Text="Copy Profile" ID="lnkCopyProfile" runat="server"></asp:Button>--%>
                            <%--<button id="lnkCopyProfile" onclick="if(fnCopyProfile())" causesvalidation="false" accesskey="B" title="Copy Profile[Alt+B]" class="btn btn-success"
                        ...
                        <%--   <div class="row">
                    <div class="gird">--%>
                        <div class="row mx-3" style="margin-top: 10px; align-content: center">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gird">
                                <div visible="false" id="divPRDDC"
                                    runat="server" class="row mx-3 section-box m-0 p-0">
                                    <asp:GridView runat="server" ID="grvPRDDCDocuments" OnRowDataBound="grvPRDDCDocuments_RowDataBound" class="gird_details"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Priority Type">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPriorityType" runat="server" Text='<%#Eval("DESCRIPTION")%>' ToolTip="Priority Type" Width="74px" ></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Doc Category">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPriorityTypeVal" runat="server" Text='<%#Eval("doc_category_desc")%>' ToolTip="Doc Category" Width="74px" ></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="PRDDC Type" FooterStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPRDDCType" runat="server" Text='<%#Eval("PRDDCType")%>' ToolTip="PRDDC Type" ></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div class="md-input" style="margin: 0px;">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtPRDDCDesc" runat="server" Text="--Select--" MaxLength="50" ToolTip="Description"
                                                                AutoPostBack="true" OnTextChanged="txtPRDDCDesc_TextChanged" Enabled="False" CssClass="md-form-control form-control login_form_content_input"></asp:TextBox>
                                            ...
                                            <asp:TemplateField HeaderStyle-Wrap="true" HeaderText="Mandatory" FooterStyle-HorizontalAlign="center">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Scan" FooterStyle-HorizontalAlign="center">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="CheckList" FooterStyle-HorizontalAlign="center">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-Wrap="false" FooterStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="lnkRemovePRDDC" runat="server" Text="Remove" ToolTip="Remove [Alt+R]" OnClientClick="return confirm('Do you want to Remove Line Item?');" AccessKey="R" OnClick="lnkRemovePRDDC_Click"
                                                ...
                                                <ItemStyle Width="8%" />
                                                <FooterTemplate>
                                                    <%--<button ID="addPRDDC" runat="server" accesskey="T" title="Add[Alt+T]" class="btn btn-success"  type="button"
                                                onserverclick="lnkAAdd_Click" CausesValidation="false">
                                                <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>A</u>dd
                                            </button>--%>
                                                    <asp:LinkButton ID="addPRDDC" runat="server" Text="Add" AccessKey="T" ToolTip="Add,Alt+T" CssClass="btn btn-success btn-sm"
                                                        OnClick="lnkAAdd_Click" CausesValidation="false"><i class="fa fa-plus" aria-hidden="true"></i> Add</asp:LinkButton>
                                                </FooterTemplate>
                                                <FooterStyle Width="8%" />
                                            </asp:TemplateField>
                                        </Columns>
                        ...
                        <div class="row">
                            <div class="fixed_btn">
                                <button runat="server" id="btnSave" accesskey="S" title="Save[Alt+S]" onclick="if(fnCheckPageValidation('PRDDC'))"
                                    class="btn btn-success mr-2" validationgroup="PRDDC" onserverclick="btnSave_Click" type="submit">
                                    <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>S</u>ave    
                                </button>
                                <button runat="server" id="btnClear" accesskey="R" title="Clear[Alt+R]" causesvalidation="false" class="btn btn-outline-success"
