                                                ...
                                                <tr align="center">
                                                    <th style="padding: 0px !important; background: none !important; border: none">
                                                        <asp:LinkButton ID="lnkbtnSort2" runat="server"
                                                            OnClick="FunProSortingColumn" ToolTip="Sort By Model Description" Text="Model Description" CssClass="styleGridHeaderLinkBtn"></asp:LinkButton>
                                                ...
                                                <tr align="center">
                                                    <th style="padding: 0px !important; background: none !important; border: none">
                                                        <asp:LinkButton ID="lnkbtnSort3" runat="server"
                                                            OnClick="FunProSortingColumn" ToolTip="Sort By ROI Rule Number" Text="ROI Rule Number" CssClass="styleGridHeaderLinkBtn"></asp:LinkButton>
