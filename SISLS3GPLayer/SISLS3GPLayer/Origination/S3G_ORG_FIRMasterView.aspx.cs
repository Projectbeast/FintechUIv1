...
//Screen Name      :   S3G_ORG_FIRMasterView.aspx
...
public partial class Origination_S3G_ORG_FIRMasterView : ApplyThemeForProject
{
    #region Paging Config

    string strRedirectPage = "~/Origination/S3G_ORG_FIRMasterAdd.aspx";
    int intNoofSearch = 3;
    ...
    //string[] arrSortCol = new string[] { "LOB_Code + ' - ' + LOB_Name", "Product_Code+' - '+Product_Name", "Convert(Varchar,Constitution_Code)+' - '+Constitution_Name" };
    string strProcName = "S3G_ORG_GetFIR_Paging";
