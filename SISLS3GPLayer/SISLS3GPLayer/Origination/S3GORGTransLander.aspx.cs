        ...
        try
        {
            ...
            switch (ProgramCode)
            {
                ...
                case strApplicationProcessAC:
                    ...
                    lblProgramIDSearch.Visible = true;
                    //ddlDocumentNumb.Visible = true;
                    strRedirectPage = "~/Origination/S3G_ORG_ApplicationProcessing_AC.aspx";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    ucAccountLov.strLOV_Code = "ACC_APP";
                    dvAccountNo.Visible = true;
                    btnCreate.Enabled_False();
                ...
                case strApplicationVer:
                    ...
                    lblProgramIDSearch.Visible = true;
                    //ddlDocumentNumb.Visible = true;
                    strRedirectPage = "~/Origination/S3gOrgApplication_Verification_Add.aspx";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    dvAccountNo.Visible = true;
                    break;
                ...
                case strCustomerGroup:
                    ...
                    lblProgramIDSearch.Visible = true;
                    strRedirectPage = "~/Origination/S3GORGCustomerGroup_Add.aspx";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    dvAccountNo.Visible = false;
