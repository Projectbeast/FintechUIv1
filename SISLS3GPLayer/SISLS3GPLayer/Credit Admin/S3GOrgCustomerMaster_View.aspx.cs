...
public partial class Origination_S3GOrgCustomerMaster_View : ApplyThemeForProject
{
    ...
    protected void FunProSortingColumn(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (strDirection == "ASC")
            {
                ((Label)grvPaging.HeaderRow.FindControl(imgbtnSearch)).CssClass = "styleImageSortingAsc";
            }
            else
            {

                ((Label)grvPaging.HeaderRow.FindControl(imgbtnSearch)).CssClass = "styleImageSortingDesc";
            }
        }
        catch (FaultException<UserMgtServicesReference.ClsPubFaultException> objFaultExp)
        {
