...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel21" runat="server">
        <ContentTemplate>
            ...
            <div class="section-box scrollable-content mx-3">
                            ...
                            <asp:GridView ID="grvPaging" runat="server" AutoGenerateColumns="False" Width="100%"
                                ...
                                <Columns>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="imgbtnQuery" ImageUrl="~/Images/spacer.gif" CssClass="styleGridQuery"
                                    ...
                                    <asp:TemplateField HeaderText="Modify" SortExpression="Customer_ID" Visible="true"
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="imgbtnEdit" ImageUrl="~/Images/spacer.gif" CssClass="styleGridEdit"
                                                AlternateText="Modify" CommandArgument='<%# Bind("Customer_ID") %>' runat="server"
                                                CommandName="Modify"><i class="fa fa-pencil-square-o" ></i></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="styleGridHeader" />
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Customer Code">
                                        <HeaderTemplate>
                                            <table cellpadding="0" cellspacing="0" border="0" class="no-th-td-border">
                                                <thead>
                                                    <tr align="center">
                                                        <th style="padding: 0px !important; background: none !important;">
                                                            ...
                                                            <asp:Label ID="imgbtnSort2" runat="server" ImageAlign="Middle" CssClass="styleImageSortingAsc" />
                                                        </th>
                                                    </tr>
                                                    <tr align="left">
                                                        <th style="padding: 0px !important; background: none !important;">
                                                            <div class="md-input" style="margin: 0px;">
                                                                <asp:TextBox AutoCompleteType="None" ID="txtHeaderSearch2" runat="server" AutoPostBack="true"
                                                                    OnTextChanged="FunProHeaderSearch" class="form-control-sm md-form-control form-control login_form_content_input"></asp:TextBox>
                                                                <span class="highlight"></span>
                                                                <span class="bar"></span>
                                                            </div>
                                                        </th>
                                                    ...
                                                    <tr align="center">
                                                        <th style="padding: 0px !important; background: none !important;">
                                                            <asp:LinkButton ID="lnkbtnSort1" runat="server" Text="Customer Name" ToolTip="Sort By CustomerName"
                                                                CssClass="styleGridHeaderLinkBtn" OnClick="FunProSortingColumn"> </asp:LinkButton>
                                                            <asp:Label ID="imgbtnSort1" runat="server" ImageAlign="Middle" CssClass="styleImageSortingAsc" />
                                                        </th>
                                                    </tr>
                                                    <tr align="left">
                                                        <th style="padding: 0px !important; background: none !important;">
                                                    ...
                                                    <tr align="center">
                                                        <th style="padding: 0px !important; background: none !important;">
                                                            <asp:LinkButton ID="lnkbtnSort3" runat="server" Text="Customer Type" ToolTip="Sort By CustomerType"
                                                                CssClass="styleGridHeaderLinkBtn" OnClick="FunProSortingColumn"> </asp:LinkButton>
                                                            <asp:Label ID="imgbtnSort3" runat="server" ImageAlign="Middle" CssClass="styleImageSortingAsc" />
                                                        </th>
                                                    </tr>
                                                    <tr align="left">
                                                        <th style="padding: 0px !important; background: none !important;">
