        ...
        <ContentTemplate>
            ...
            <div class="scrollable-content">
                ...
                <div class="row m-0">
                    <div class="col">
                        <cc1:TabContainer ID="tcCustomerMaster" runat="server" CssClass="styleTabPanel"
                                ...
                                <ContentTemplate>
                                    <asp:UpdatePanel ID="updMain" runat="server">
                                        <ContentTemplate>
                                            <asp:Panel GroupingText="Customer Informations" ID="pnlCustomerInfo" runat="server" ToolTip="Customer Informations"
                                                ...
                                                <div style="margin-top: 10px;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                            <button class="btn btn-success btn-sm" id="btnDeDup" onserverclick="btnDeDup_Click" runat="server" causesvalidation="false" title="De dupe[Alt+Shift+D]"
                                            ...
                                            <div>
                                                <div class="row m-0" style="padding: 0px !important;">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="row">
                                            ...
                                            <div class="row mx-2">
                                                <div class="col">
                                                    <button class="btn btn-success btn-sm mr-2" id="btnAddAdds" onserverclick="btnAddAdds_Click" runat="server"
                                                    ...
                                                    <button class="btn btn-success btn-sm" id="btnModifyAdds" onserverclick="btnModifyAdds_Click" runat="server"
                                            ...
                                            <div id="grvAddressDetail" class="row m-3 mb-5">
                                                <div class="md-input">
                                                    <div class="gird">
                                                        <asp:GridView ID="grvAddressDetails" runat="server" AllowPaging="True" HeaderStyle-CssClass="styleGridHeader" class="gird_details" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderStyle-CssClass="px-5">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="lnkbtnDelete" runat="server" CommandName="Delete" CssClass="grid_btn_delete" CausesValidation="false"
                                                                    ...
                                                                    <div class="gird">
                                                                        <asp:GridView runat="server" ShowFooter="true" ToolTip="Share Holder Details"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField ItemStyle-Wrap="false" HeaderText="Share Holder&#8217;s Nationality" HeaderStyle-Width="20%">
                                                                                    <ItemTemplate>
                                                                                ...
                                                                                <asp:TemplateField>
                                                                                    <ItemTemplate>
                                                                                        <asp:LinkButton ID="lnkDelete" runat="server" CssClass="grid_btn_delete" CommandName="Delete" CausesValidation="false" Text="Remove"
                                                                                            OnClientClick="return confirm('Are you sure you want to Remove this record?');" ToolTip="Remove the Details, Alt+Shift+E" AccessKey="E">
                                                                                            <i class="fa fa-trash" aria-hidden="true"></i> Remove
                                                                                        </asp:LinkButton>
                                                                                    </ItemTemplate>
                                                                                    <FooterTemplate>
                                                                                        <asp:LinkButton ID="btnAddShare" runat="server" CommandName="AddNew"
                                                                                            CssClass="btn btn-success btn-sm mb-2" Text="Add" ValidationGroup="ShareAdd" ToolTip="Add the Details, Alt+T" AccessKey="T">
                                                                ...
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12" runat="server" id="dvLimitHis" visible="false">
                                                                            <div class="md-input">
                                                                                <button class="btn btn-success mt-3" id="btnLimitHistory" onserverclick="btnLimitHistory_Click" runat="server" causesvalidation="false" title="Limit History[Alt+Shift+H]"
                                                                                    type="button" accesskey="H">
                                                                                    <i class="fa fa-history" aria-hidden="true"></i>&emsp;Limit <u>H</u>istory
                                                                                </button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                            ...
                                                                            <div class="gird">
                                                                                <asp:GridView ID="grvCustSubLimit" HorizontalAlign="Center" runat="server" AutoGenerateColumns="false" ToolTip="Factoring  Sublimit"
                                                                                    ...
                                                                                    <Columns>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <div class="md-input" style="margin: 0px;">
                                                                                                    <asp:TextBox ID="txtCutOffDateF" runat="server" Width="90%" ToolTip="Cut off Date"
                                                                                                        Style="text-align: right;" CssClass="styleDisplayText form-control"></asp:TextBox>
                                                                                        ...
                                                                                        <asp:TemplateField>
                                                                                            <ItemTemplate>
                                                                                                <asp:LinkButton ID="lnkRemove" CssClass="grid_btn_delete" AccessKey="Z" ToolTip="Add [Alt+Z]" runat="server" Text="Remove" CommandName="Delete"
                                                                    ...
                                                                    <asp:LinkButton ID="lnkCancel" runat="server" Text="Cancel" CommandName="Cancel"
                                                                        CausesValidation="false"></asp:LinkButton>
                                                                                            ...
                                                                                            <FooterTemplate>
                                                                                                <asp:LinkButton ID="lnkAdd" runat="server" CssClass="btn btn-success btn-sm" AccessKey="Y" ToolTip="Add [Alt+Y]" Text="Add" CommandName="Add" ValidationGroup="vgAdd"
                                    ...
                                    <asp:Panel GroupingText="Customer Account Informations" ID="pnlBankDtls" runat="server" ToolTip="Customer Account Informations"
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12 text-right">
                                                <button class="btn btn-success mr-2" id="btnAdd" onserverclick="btnAdd_Click" runat="server" onclick="if(fnCheckPageValidators('Add','f'))"
                                                ...
                                                <button class="btn btn-success mr-2" id="btnModify" onserverclick="btnModify_Click" runat="server" onclick="if(fnCheckPageValidators('Add','f'))"
                                                ...
                                                <button class="btn btn-outline-success" id="btnBnkClear" onserverclick="btnBnkClear_Click" causesvalidation="false" runat="server" type="button" accesskey="E" title="Clear the Details[Alt+E]" validationgroup="Add">
                                                    <i class="fa fa-refresh"></i>&emsp;R<u>e</u>set
                                                </button>
                                                ...
                                                <asp:GridView ID="grvBankDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False" ToolTip="Bank Details"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lnkbtnDeleteBank" runat="server" CommandName="Delete" CssClass="grid_btn_delete" Text="Remove" AccessKey="B" OnClientClick="return confirm('Are you sure you want to Remove this record?');" ToolTip="Remove,Alt+B" >
                                                                <i class="fa fa-trash" aria-hidden="true"></i> Remove    
                                                                </asp:LinkButton>
                                                            </ItemTemplate>
                            ...
                            <cc1:TabPanel runat="server" ID="TabCreditDetails" CssClass="tabpan row m-0" BackColor="Red" ToolTip="Customer Credit Details">
                                <HeaderTemplate>
                ...
                <div class="fixed_btn">
                    ...
                    <button class="btn btn-success mr-2" id="btnSave" onserverclick="btnSave_Click" runat="server" onclick="if(fnSaveValidation())"
                    ...
                    <asp:LinkButton ID="btnProceedSave" runat="server" CssClass="btn btn-success" CausesValidation="False"
                        Text="Proceed Save" OnClick="btnProceedSave_Click" Style="display: none">
                        <i class="fa fa-floppy-o" aria-hidden="true"></i> &emsp; <u>P</u>roceed Save
                    </asp:LinkButton>
    ...
    <asp:Panel ID="plSMEIndicator" GroupingText="" Height="150px" Width="300px" runat="server" Style="padding: 8px; text-wrap: normal; display: none;"
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <button class="btn btn-success" id="btnOk" title="Ok" causesvalidation="false" onserverclick="btnOk_Click"
                            runat="server" type="button">
                            <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;Ok
                        </button>
                        <button class="btn btn-success" id="btnSMECancel" title="Exit" causesvalidation="false" onserverclick="btnSMECancel_Click"
                            runat="server" type="button">
            ...
            <asp:Panel ID="plCreditLimithis" GroupingText="Limit History Details" CssClass="stylePanel" runat="server"
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <button class="btn btn-success" id="btnHistoryCancel" title="Exit[Alt+I]" accesskey="I" causesvalidation="false" onserverclick="btnHistoryCancel_Click"
                                    runat="server" type="button">
    ...
    <asp:Panel ID="plHotList" GroupingText="" Height="150px" Width="300px" runat="server" Style="padding: 8px; text-wrap: normal; display: none;"
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            <ContentTemplate>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <button class="btn btn-success" id="btnSaveOk" title="Ok[Alt+1]" accesskey="1" causesvalidation="false" onserverclick="btnSaveOk_Click"
                            runat="server" type="button">
                            <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;Ok
                        </button>
                        <button class="btn btn-success" id="btnSaveCancel" title="Cancel[Alt+2]" accesskey="2" causesvalidation="false" onserverclick="btnSaveCancel_Click"
                            runat="server" type="button">
                            <i class="fa fa-reply" aria-hidden="true"></i>&emsp;Cancel
                        </button>
                    </div>
