...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row m-0">
        <div class="col">
            <h6 class="title_name">
                <asp:Label runat="server" ID="lblHeading" CssClass="styleInfoLabel" Text="Application Processing">
                </asp:Label>
        ...
        <div class="col mr-3">
            <div class="float-right">
                <button class="btn btn-outline-success btn-create" id="btnExit" title="Return[Alt+T]" onclick="if(fnConfirmExit())" causesvalidation="false" onserverclick="btnCancel_Click" runat="server"
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" class="scrollable-content">
        <ContentTemplate>



            <asp:Panel runat="server" ID="pnlProposalhdrDisplayDetails" CssClass="stylePanel mx-2 section-box px-3 mb-4 pt-3 " HorizontalAlign="Center" GroupingText="Proposal Details">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">

                        <div class="md-input">
                            <label class="tess float-left">
                            ...
                            <ContentTemplate>
                                ...
                                <div>
                                    ...
                                    <div align="right">
                                        ...
                                        <br />
                                        <br />
                                        <button class="btn btn-success" id="btnModalAdd" visible="true" onserverclick="btnyes_Click" runat="server" accesskey="M"
                                            type="button" causesvalidation="false" title="Yes[Alt+M]">
                                            <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>Y</u>es
                                        </button>

                                        <button class="btn btn-success" id="btnModalCancel" onserverclick="btnNo_Click" runat="server" causesvalidation="false" title="Hide[Alt+B]"
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <cc1:TabContainer ID="TabContainerAP" runat="server" CssClass="styleTabPanel" Width="100%"
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <asp:Panel ID="pnlLeaseInputCriteria" runat="server" GroupingText="Input Criteria" CssClass="stylePanel"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div style="margin-top: 20px" class="md-input">
                                                                <button class="btn btn-success btn-sm" id="btnViewCustomer" causesvalidation="false" runat="server"
                                                                    type="button">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="md-input">
                                                                ...
                                                                <%-- <asp:Button ID="btnAddDealTransfer" runat="server" Text="Add Deal" AccessKey="Q" ToolTip="Add Deal [Alt+A]" class="btn btn-success" OnClick="btnAddDealTransfer_Click" CausesValidation="false" UseSubmitBehavior="false" />--%>
                                                                <div class="md-input">
                                                                    <button class="btn btn-success" id="btnAddDeal" title="Add Deal[Alt+Q]" causesvalidation="false" onserverclick="btnAddDealTransfer_Click" runat="server"
                                                ...
                                                <div class="mx-2">
                                                    <asp:Panel ID="pnlCustomerCreditDetailsHdr" runat="server" CssClass="accordionHeader accordionHeader-bg">
                                                        <div class="float-left sub_styleInfoLabel" style="margin-top: -10px !important;">
                                                            Customer Credit Details 
                                                        </div>
                                                        <div class="float-left ml-2 sub_styleInfoLabel" style="margin-top: -10px !important;">
                                                ...
                                                <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="Server" TargetControlID="pnlLifeInsurance"
                                                    ...
                                                    CollapsedText="(Show Details...)" ExpandedImage="~/Images/collapse_blue.jpg"
                                                    CollapsedImage="~/Images/expand_blue.jpg" SuppressPostBack="true" SkinID="CollapsiblePanelDemo" />
                                                <div id="divLife" runat="server" class="life-insurance-box">
                                                    <asp:Panel ID="pnlLifeInsuranceHdr" runat="server" CssClass="accordionHeader accordionHeader-bg ">
                                                        <div class="float-left sub_styleInfoLabel" style="margin-top: -10px !important;">
                                                    ...
                                                    <asp:Panel runat="server" ID="pnlLifeInsurance" ScrollBars="Auto" CssClass="stylePanel px-3" GroupingText="Life Insurance">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                <div class="md-input">
                                                                    <label class="tess">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div style="margin-top: 10px" class="md-input">
                                                                <button class="btn btn-success" id="btnViewClient" causesvalidation="false" runat="server"
                                                                    type="button">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                            <div class="md-input">
                                                                ...
                                                                <button class="btn btn-success" id="lnkAdd" title="Add [Alt+V]" causesvalidation="false" validationgroup="vgAdd" onserverclick="lnkAddCustomerMapFWC_Click" runat="server"
                                                ...
                                                <cc1:CollapsiblePanelExtender ID="clpSublimitHistory" runat="Server" TargetControlID="pnlSublimitHistory"
                                                    ...
                                                    CollapsedText="(Show Details...)" ExpandedImage="~/Images/collapse_blue.jpg"
                                                    CollapsedImage="~/Images/expand_blue.jpg" SuppressPostBack="true" SkinID="CollapsiblePanelDemo" />
                                                <div id="divSubLimitHistory" runat="server" visible="false">
                                                    <asp:Panel ID="pnlSublimitHistoryHdr" runat="server" CssClass="accordionHeader accordionHeader-bg">
                                                ...
                                                <div id="TbLeaseTabContainerMainTab" runat="server" class="row m-0 mt-3">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <cc1:TabPanel ID="TabDocumentDetails" runat="server" BackColor="Red" CssClass="tabpan"
                                                                ...
                                                                <ContentTemplate>
                                                                    ...
                                                                    <cc1:CollapsiblePanelExtender ID="collapseAccountDues" runat="Server" TargetControlID="pnlConstitutionDocumentDetails"
                                                                        ...
                                                                        CollapsedText="(Show Details...)" ExpandedImage="~/Images/collapse_blue.jpg"
                                                                        CollapsedImage="~/Images/expand_blue.jpg" SuppressPostBack="true" SkinID="CollapsiblePanelDemo" />
                                                                    <div class="life-insurance-box mb-3">
                                                                        <asp:Panel ID="pnlConstitutionDocumentDetailsHdr" runat="server" CssClass="accordionHeader accordionHeader-bg">
                                                                            <div class="float-left sub_styleInfoLabel" style="margin-top: -10px !important;">
                                                                        ...
                                                                        <asp:Panel runat="server" ID="pnlConstitutionDocumentDetails" CssClass="stylePanel px-3" GroupingText="Constitution Document Details">
                                                                    ...
                                                                    <cc1:CollapsiblePanelExtender ID="collapseCad" runat="Server" TargetControlID="pnlPreDisbursementDocumentDetails"
                                                                        ...
                                                                        CollapsedText="(Show Details...)" ExpandedImage="~/Images/collapse_blue.jpg"
                                                                        CollapsedImage="~/Images/expand_blue.jpg" SuppressPostBack="true" SkinID="CollapsiblePanelDemo" />
                                                                    <div class="life-insurance-box" style="margin-bottom: 80px;">
                                                                        <asp:Panel ID="collapseCadHdr" runat="server" CssClass="accordionHeader accordionHeader-bg">
                                                                            <div class="float-left sub_styleInfoLabel" style="margin-top: -10px !important;">
                                                                        ...
                                                                        <asp:Panel runat="server" ID="pnlPreDisbursementDocumentDetails" Visible="false" CssClass="stylePanel px-3" GroupingText="Documents of Proposal(CAD)">
                                                                                ...
                                                                                <asp:GridView ID="gvPRDDT" runat="server" Width="99%" AutoGenerateColumns="False"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Collected/Waived By">
                                                                                            <ItemTemplate>
                                                                                                <div class="md-input mt-2" style="width: 240px">
                                                                                                    <uc:Suggest ID="ddlCollectedBy" ToolTip="Collected/Waived By" cssclass="md-form-control form-control login_form_content_input" runat="server" SelectedText='<%# Bind("CollectedBy") %>' ServiceMethod="GetUserList" AutoPostBack="false"
                                                                                                        IsMandatory="false" />
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="CAD Verified By">
                                                                                            <ItemTemplate>
                                                                                                <div class="md-input mt-2" style="width: 240px">
                                                                                                    <uc:Suggest ID="ddlCADVerifiedBy" ToolTip="CAD Verified By" cssclass="md-form-control form-control login_form_content_input" runat="server" SelectedText='<%# Bind("CADVerifiedBy") %>' ServiceMethod="GetUserList" AutoPostBack="false"
                                                                                                        IsMandatory="false" />
                                                                                                    <span class="highlight"></span>
                                                                                                    <span class="bar"></span>
                                                                                                </div>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="CAD Received By">
                                                                                            <ItemTemplate>
                                                                                                <div class="md-input mt-2" style="width: 240px">
                                                                                                    <uc:Suggest ID="ddlCADReceivedBy" ToolTip="CAD Received By" cssclass="md-form-control form-control login_form_content_input" runat="server" SelectedText='<%# Bind("CADReceivedBy") %>' ServiceMethod="GetUserList" AutoPostBack="false"
                                                                                                        IsMandatory="true" />
                                                                                                    <span class="highlight"></span>
                                                                                                    <span class="bar"></span>
                                                                                                </div>
                                                                        ...
                                                                        <div id="Div1" style="height: 300px; overflow: auto;" runat="server">
                                                                            <div class="row">
                                                                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="float: right;">
                                                                                    ...
                                                                                    <div class="md-input">
                                                                                        <button class="btn btn-success" id="btnAddAsset" title="Add Asset [Alt+T]" causesvalidation="false" runat="server"
                                                                                            type="button" accesskey="T">
                                                                                        ...
                                                                                        <asp:GridView ID="gvAssetDetails" class="gird_details" runat="server" AutoGenerateColumns="False" OnRowDeleting="gvAssetDetails_RowDeleting"
                                                                                            ...
                                                                                            <asp:BoundField DataField="Chasis_No" HeaderText="Chasis No" ItemStyle-HorizontalAlign="Right" />--%>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:LinkButton ID="lnRemove" CssClass="btn-warning p-1 rounded" AccessKey="3" OnClientClick="return confirm('Are you sure want to delete this record?');" ToolTip="Remove [Alt+3]" CausesValidation="false" runat="server" CommandName="Delete"
                    ...
                    <cc1:TabPanel runat="server" ID="TabOfferTerms" CssClass="tabpan" BackColor="Red"
                        ...
                        <ContentTemplate>
                            <asp:UpdatePanel ID="upOfferTerms" runat="server" class="mx-2">
                                <ContentTemplate>
                                    ...
                                    <asp:Panel ID="pnlOfferTerms" runat="server">
                                        ...
                                        <div>
                                            <asp:Panel ID="divRoiRules" runat="server" CssClass="accordionHeader accordionHeader-bg">
                                                <div class="float-left sub_styleInfoLabel" style="margin-top: -10px !important;">
                                            ...
                                            <asp:Panel ID="divROIRuleInfo" Style="overflow: auto; height: 150px; width: 100%"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="md-input" style="margin-top: 37px;">

                                                            <%-- <asp:Button ID="btnFetchROI" Text="Go" runat="server" AccessKey="G" ToolTip="Fetch ROI Details[Alt+G]" class="btn btn-success"
                                                                OnClientClick="return FunddlRoiOnChange('ROI')" OnClick="btnFetchROI_Click" Style="display: block" />--%>

                                                            <div class="md-input">
                                                                <button class="btn btn-success btn-sm" id="btnFetchROI" title="Go [Alt+G]" onclick="if(FunddlRoiOnChange('ROI'))" onserverclick="btnFetchROI_Click" causesvalidation="false" runat="server"
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        <div class="md-input" style="margin-top: 37px;">
                                                            ...
                                                            <%--<asp:Button ID="btnFetchPayment" runat="server" AccessKey="H" ToolTip="Fetch Payment Rule Details[Alt+H]" class="btn btn-success"
                                                                OnClick="btnFetchPayment_Click" Text="Go" Style="display: block" OnClientClick="return FunddlRoiOnChange('Payment')" />--%>

                                                            <div class="md-input">
                                                                <button class="btn btn-success btn-sm" id="btnFetchPayment" title="Go [Alt+H]" onclick="if(FunddlRoiOnChange('Payment'))" onserverclick="btnFetchPayment_Click" causesvalidation="false" runat="server"
                                                    ...
                                                    <asp:GridView ID="gvInflow" runat="server" AutoGenerateColumns="False" class="gird_details" OnRowDeleting="gvInflow_RowDeleting"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Customer Name" ItemStyle-Width="25%" FooterStyle-Width="25%">
                                                                ...
                                                                <FooterTemplate>
                                                                    <div class="md-input mt-2" style="margin: 0px;">
                                                            ...
                                                            <asp:TemplateField FooterStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnRemove" runat="server" AccessKey="5" ToolTip="Remove[Alt+5]" OnClientClick="return confirm('Are you sure want to delete this record?');" CssClass="grid_btn_delete" CausesValidation="false" CommandName="Delete"
                                                                        Text="Remove"><i class="fa fa-trash" aria-hidden="true"></i> Remove</asp:LinkButton>
                                                                </ItemTemplate>
                                                                <FooterTemplate>
                                                                    <div class="md-input" style="margin-top: -8px;">

                                                                        <asp:LinkButton ID="btnAdd" runat="server" Text="Add" ToolTip="Add Inflow[Alt+J]" AccessKey="J" CausesValidation="true" ValidationGroup="Inflow"
                                                                            OnClick="btnAddInflow_OnClick" CssClass="btn btn-success btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Add</asp:LinkButton>
                                        ...
                                        <asp:Panel runat="server" ID="pnlOutflow" ScrollBars="Auto" CssClass="stylePanel mb-5 pb-3" GroupingText="Payment Details"
                                            Width="100%">
                                            <div style="overflow: auto; width: 100%;">
                                                <div class="gird">
                                                            ...
                                                            <asp:TemplateField ItemStyle-Width="7%" FooterStyle-Width="7%" FooterStyle-HorizontalAlign="Center"
                                                                ...
                                                                <FooterTemplate>
                                                                    <div class="md-input" style="margin-top: -8px;">
                                                                        ...
                                                                        <asp:LinkButton ID="btnAddOut" runat="server" Text="Add" CausesValidation="true" AccessKey="B" ToolTip="Add Outflow [Alt+B]" ValidationGroup="Outflow"
                                                                            OnClick="btnAddOutflow_OnClick" CssClass="btn btn-success btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Add </asp:LinkButton>
                            ...
                            <asp:UpdatePanel ID="upRepayment" runat="server">
                                <ContentTemplate>
                                                            ...
                                                            <div class="md-input">
                                                                <label class="tess">
                                                                    <asp:Label ID="lblTenureTypeDisplay" Text="Tenure Type" runat="server" CssClass="styleDisplayLabel"
                                                                        Font-Bold="false"></asp:Label></label>
                                                ...
                                                <div class="gird">
                                                    <asp:GridView ID="gvRepaymentDetails" class="gird_details" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Add" ItemStyle-Width="6%" FooterStyle-Width="6%">
                                                                <ItemStyle HorizontalAlign="Center" />
                                                                <FooterStyle HorizontalAlign="Center" />
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnRemoveRepayment" ToolTip="Remove [Alt+6]" OnClientClick="return confirm('Are you sure want to delete this record?');" AccessKey="6" CausesValidation="false" runat="server" CommandName="Delete"
                                                                        Text="Remove" Visible="false" CssClass="grid_btn_delete"><i class="fa fa-trash" aria-hidden="true"></i> Remove</asp:LinkButton>
                                                                </ItemTemplate>
                                                                <FooterTemplate>
                                                                    <div class="md-input" style="margin: 0px;">

                                                                        <asp:LinkButton ID="btnAddRepayment" runat="server" Text="Add" ToolTip="Add [Alt+W]" AccessKey="W" CssClass="grid_btn"
                                                                            OnClick="btnAddRepayment_OnClick" CausesValidation="false" ValidationGroup="TabRepayment1" OnClientClick="return fnCheckPageValidators('TabRepayment1',false)">
                                    ...
                                    <div class="row mx-1 mb-3">
                                        <div class="col-12">
                                            <div class="float-right">
                                                <button class="btn btn-success" id="btnCalIRR" title="Calculate IRR [Alt+M]" onclick="if(Confirmmsg('Are you sure want to Calculate IRR?'))" onserverclick="btnCalIRR_Click" causesvalidation="false" runat="server"
                                                    type="button" accesskey="M">
                                                    <i class="fa fa-calculator" aria-hidden="true"></i>&emsp;<u></u>Calculate IRR 
                                                </button>

                                                <button class="btn btn-success" id="btnReset" title="Reset Structure [Alt+N]" onclick="if(Confirmmsg('Are you sure want to Reset Repayment Structure?'))" onserverclick="btnReset_Click" causesvalidation="false" runat="server"
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:Panel ID="pnlGuarantorHid" runat="server">
                                        <div class="row m-0 mx-3 mb-5">
                                                        ...
                                                        <asp:GridView ID="gvGuarantor" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Co-App/Guarantor">
                                                                    ...
                                                                    <FooterTemplate>
                                                                        <table class="no-th-td-border">
                                                                            <tr>
                                                                                <td>
                                                                                    <UC4:ICM ID="ucCustomerLov" ReadOnly="true" ButtonEnabled="false" ToolTip="Guarantor Name" onblur="fnLoadCustomerg()" CssClass="md-form-control form-control login_form_content_input requires_true" HoverMenuExtenderLeft="true" runat="server" ShowHideAddressImageButton="false" AutoPostBack="false" DispalyContent="Both"
                                                                ...
                                                                <asp:TemplateField HeaderText="" FooterStyle-Width="6%">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="lnRemove" CausesValidation="false" runat="server" OnClientClick="return confirm('Are you sure you want to delete this record?');" AccessKey="1" ToolTip="Remove [Alt+1]" CommandName="Delete"
                                                                            Text="Remove" CssClass="grid_btn_delete"><i class="fa fa-trash" aria-hidden="true"></i> Remove</asp:LinkButton>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <div class="md-input" style="margin: 0px;">

                                                                            <asp:LinkButton ID="LbtnAddInvoice" runat="server" AccessKey="A" ToolTip="Add [Alt+A]" CausesValidation="true" OnClick="btnAddGuarantor_OnClick"
                                                                                Text="Add" ValidationGroup="Guarantor" class="btn btn-success btn-sm mt-3"><i class="fa fa-plus" aria-hidden="true"></i> Add</asp:LinkButton>
                                                                        </div>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                            ...
                                            <asp:Panel runat="server" ID="pnlLienAccount" Width="100%" CssClass="stylePanel mb-5" GroupingText="Lien Account">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        <%--  <div class="md-input">--%>
                                                        <%-- <i class="fa fa-arrow-circle-right btn_i" aria-hidden="true" style="top: 10px !important; left: 25px"></i>--%>
                                                        <%--  <asp:Button ID="btnLienAccount" runat="server" Text="Add Lien Account" AccessKey="A" ToolTip="Add Deal [Alt+A]" class="btn btn-success" OnClick="btnLienAccount_Click" CausesValidation="false" UseSubmitBehavior="false" />--%>
                                                        <%-- </div>--%>

                                                        <div class="md-input m-0 mt-3">
                                                            <button class="btn btn-success" id="btnLienAccount" title="Add Lien Account[Alt+Y]" causesvalidation="false" onserverclick="btnLienAccount_Click" runat="server"
                                            ...
                                            <asp:Panel runat="server" ID="pnlCollateralDetails" Width="100%" CssClass="stylePanel mb-5" Style="display: none" GroupingText="Collateral Details">
                    ...
                    <cc1:TabPanel runat="server" ID="TabAlerts" CssClass="tabpan mb-5" Width="80%" BackColor="Red">
                        <HeaderTemplate>
                            Alerts
                        </HeaderTemplate>
                        <ContentTemplate>
                                                            ...
                                                            <asp:TemplateField FooterStyle-Width="10%">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnRemove" CausesValidation="false" OnClientClick="return confirm('Are you sure want to Remove this record?');" runat="server" AccessKey="8" CommandName="Delete"
                                                                        Text="Remove" ToolTip="Remove [Alt+8]" CssClass="grid_btn_delete"><i class="fa fa-trash" aria-hidden="true"></i> Remove</asp:LinkButton>
                                                                </ItemTemplate>
                                                                <FooterTemplate>
                                                                    <div class="md-input" style="margin: 0px;">

                                                                        <asp:LinkButton ID="btnAddAlert" runat="server" Text="Add" CausesValidation="true" ToolTip="Add [Alt+0]" AccessKey="0" CssClass="btn btn-success btn-sm"
                                                                            OnClick="btnAddAlert_OnClick" ValidationGroup="Alert">
                                                                            <i class="fa fa-plus" aria-hidden="true"></i> Add
                                                                        </asp:LinkButton>
                                                                    </div>
                                                                </FooterTemplate>
                                ...
                                <ContentTemplate>
                                    <asp:Panel ID="pnlFollowup" runat="server" >
                                        ...
                                        <asp:Panel runat="server" ID="Panel7" CssClass="stylePanel" GroupingText="Followup details"
                                            ...
                                            <div id="DivFollow" runat="server" style="width: 100%; overflow: auto;">
                                                <div class="gird">
                                                    <br />
                                                    <asp:GridView ID="gvFollowUp" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="From User Name" FooterStyle-Width="20%">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="To User Name" ItemStyle-Width="20%" FooterStyle-Width="20%">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField FooterStyle-Width="7%">
                                                                ...
                                                                <FooterTemplate>
                                                                    <div class="md-input" style="margin: 0px;">
                                                                        ...
                                                                        <asp:LinkButton ID="btnAddFollowup" runat="server" Text="Add" AccessKey="A" ToolTip="Add [Alt+A]" CausesValidation="true"
                                                                            class="btn btn-success btn-sm" OnClick="btnAddFollowUp_OnClick" ValidationGroup="FollowUp">
                                                                            <i class="fa fa-plus" aria-hidden="true"></i> Add
                                                                        </asp:LinkButton>
                                        ...
                                        <asp:Panel ID="pnlIdAdditionalParameter" runat="server" CssClass="stylePanel" GroupingText="Additional Parameter Informations" style="margin-bottom: 100px;">
                                            <div class="row m-0">
                    ...
                    <cc1:TabPanel runat="server" ID="TabAppraisalInfo" CssClass="tabpan" BackColor="Red"
                        ...
                        <ContentTemplate>
                            <asp:Panel ID="pnlAppraisalInfo" runat="server" style="margin-bottom:85px">
                    ...
                    <cc1:TabPanel runat="server" ID="TabRisk" CssClass="tabpan" BackColor="Red"
                        ...
                        <ContentTemplate>
                            ...
                            <div class="row px-3" style="margin-bottom: 100px !important;">
    ...
    <div align="right" class="fixed_btn">
        <div class="row">
            <div class="col-12 col-md-4" runat="server" id="dvprint" visible="true">
                <div class="md-input mb-0">
            ...
            <div class="col-12 col-md-8 mt-3">
                <button class="btn btn-success mr-2" id="btnSave" title="Save[Alt+S]" causesvalidation="false" onclick="if(fnSaveValidation())" onserverclick="btnSave_OnClick" runat="server"
                    type="button" accesskey="S" style="margin-right: 8px;">
                    <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>S</u>ave
                </button>
                <%--onclick="if(fnSaveValidation())" --%>
                <button class="btn btn-outline-success mr-2" id="btnClear" title="Reset[Alt+R]" onclick="if(fnConfirmClear())" causesvalidation="false" onserverclick="btnClear_OnClick" runat="server"
                    type="button" accesskey="R">
                    <i class="fa fa-refresh" aria-hidden="true"></i>&emsp;<u>R</u>eset
                </button>

                <button class="btn btn-outline-danger mr-2" id="btnApplicationCancel" title="WithDraw Application[Alt+W]" onclick="if(fnConfirmDealCancel())" causesvalidation="false" onserverclick="btnApplicationCancel_Click" runat="server"
                    type="button" accesskey="W">
                    <i class="fa fa-times" aria-hidden="true"></i>&emsp;<u>W</u>ithDraw Application
                </button>

                <button class="btn btn-outline-success" id="btnKYCPDFPrint" title="Print the Details[Alt+P]" causesvalidation="false" visible="false" onserverclick="btnKYCPDFPrint_ServerClick" runat="server"
    ...
    <%-- <div id="btndiv" runat="server" align="right" class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           <div class="row" style="float: right; margin-top: 5px;">
                ...
                <button class="btn btn-success" id="btnSave" title="Save[Alt+S]" onclick="if(fnSaveValidation())" causesvalidation="false" onserverclick="btnSave_OnClick" runat="server"
                    type="submit" accesskey="S">
                    <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>S</u>ave
                </button>
                <button class="btn btn-success" id="btnClear" title="Clear[Alt+L]" onclick="if(fnConfirmClear())" causesvalidation="false" onserverclick="btnClear_OnClick" runat="server"
                    type="button" accesskey="L">
                    <i class="fa fa-eraser" aria-hidden="true"></i>&emsp;C<u>l</u>ear
                </button>
                <button class="btn btn-success" id="btnExit" title="Exit[Alt+X]" onclick="if(fnConfirmExit())" causesvalidation="false" onserverclick="btnCancel_Click" runat="server"
                    type="button" accesskey="X">
                    <i class="fa fa-times" aria-hidden="true"></i>&emsp;E<u>x</u>it
                </button>
                <button class="btn btn-success" id="btnApplicationCancel" title="Cancel CheckList[Alt+C]" onclick="if(fnConfirmDealCancel())" causesvalidation="false" onserverclick="btnApplicationCancel_Click" runat="server"
                    type="button" accesskey="W">
                ...
                if (txtStatus.value == '2' || txtStatus.value == '4' || txtStatus == '5') {
                    if (lobcode2.toLowerCase() == "ft") {
                        ...
                        if (typeof (btnApplicationCancel) != "undefined") {
                            ...
                            btnApplicationCancel.className = "btn btn-success";
                        }
                    }
                }
            }
