        ...
        <ContentTemplate>
            <div class="row m-0">
                ...
                <div class="col mr-3">
                    <div class="float-right">
                        <button class="btn btn-outline-success btn-create" id="btnCreate" title="Create[Alt+C]" causesvalidation="false" onserverclick="btnCreate_Click" runat="server"
            ...
            <div id="tab-content" class="tab-content scrollable-content">
                <div class="tab-pane fade in active show" id="tab1">
                    ...
                    <div class="section-box px-3 mx-2 pt-4">
                        <div class="row">
                    ...
                    <div class="fixed_btn">
                        <button class="btn btn-success mr-2" id="btnSearch" title="Search[Alt+S]" causesvalidation="false" onserverclick="btnSearch_Click" runat="server"
                            type="button" accesskey="S">
                            <i class="fa fa-search" aria-hidden="true"></i>&emsp;<u>S</u>earch
                        </button>

                        <button class="btn btn-outline-success" id="btnClear" title="Clear[Alt+R]" onclick="if(fnConfirmClear())" causesvalidation="false" onserverclick="btnClear_Click" runat="server"
