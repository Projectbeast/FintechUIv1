        ...
        <ContentTemplate>
            ...
            <div id="tab-content" class="tab-content scrollable-content-details">
                <div class="tab-pane fade in active show" id="tab1">
                    ...
                    <div class="row mx-2 section-box p-3 pt-3">
                        <asp:Panel runat="server" ID="Panel5" CssClass="" HorizontalAlign="Left" Width="100%" GroupingText="">
                            <div>
                                <div class="row">
                                        ...
                                        <ContentTemplate>
                                            <div>
                                                <div class="row m-0 mt-2">
                                                    <asp:Panel runat="server" ID="panInputCriteria" CssClass="stylePanel" GroupingText="Basic Details">
                                                        <div>
                                                            <div class="row">
                                                                    ...
                                                                    <div class="md-input">
                                                                        <table style="width: 100%">
                                                                            <tr>
                                                                                ...
                                                                                <td >
                                                                                      <button id="btnViewPropect" runat="server" title="View Prospect Information" causesvalidation="false" onserverclick="btnViewPropect_ServerClick" class="btn btn-success mt-2"><i class="fa fa-eye"></i></button>
                                                                    ...
                                                                    <div class="md-input">
                                                                        ...
                                                                        <table style="width: 100%">
                                                                            <tr>
                                                                                ...
                                                                                <td >
                                                                                           <button id="btnCreateCustomer" runat="server" causesvalidation="false" onserverclick="btnCreateCust_Click" class="btn_control mb-2"><i class="fa fa-plus"></i></button>
                                                                ...
                                                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                    ...
                                                                    <button class="btn btn-success mt-3" id="btnCopyProfile" title="Copy Profile [Alt+Y]" causesvalidation="false" onserverclick="btnLoadCustomerCopyProfile_OnClick" runat="server"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderStyle-Width="10%">
                                                                                <ItemTemplate>
                                                                                    ...
                                                                                    <asp:LinkButton ID="btnRemoveDays" Text="Remove" CssClass="grid_btn_delete" AccessKey="R" ToolTip="Delete [Alt+R]"
                                                                                        CommandName="Delete" runat="server" CausesValidation="false" OnClientClick="return confirm('Are you sure want to delete this record?');" >
                                                                                ...
                                                                                <FooterTemplate>
                                                                                    ...
                                                                                    <button class="btn btn-success btn-sm" id="btnAddrowDays" validationgroup="btnAddPdc" title="Add [Alt+A]" accesskey="A" runat="server" onserverclick="btnAddrowDays_Click"><i class="fa fa-plus" aria-hidden="true"></i> Add</button>
                                                ...
                                                <div style="display: none" class="row">
                                                    <asp:Panel ID="pnlPrint" HorizontalAlign="Center" CssClass="stylePanel" runat="server" Width="99%" GroupingText="Mail/Print Details">
                                                        <div class="row">
                                                            ...
                                                            <%--  <button class="btn btn-success" id="btnPdf" title="PDF [Alt+O]"  causesvalidation="false" onserverclick="btnCheckListPrint" runat="server"
                                                            ...
                                                            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                                                ...
                                                                <button class="btn btn-success" id="btnEmail" title="Email [Alt+E]" style="display: none" causesvalidation="false" runat="server"
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
                                                                    ...
                                                                    <asp:Button ID="btnAddNew" runat="server" AccessKey="C" ToolTip="Add [Alt+C]" OnClientClick="return funcalassetMarginAmt_dp();" CausesValidation="true" ValidationGroup="TabAddAssetDetails" CssClass="btn btn-success btn-sm" OnClick="btnAddAsset_OnClick"
                                                                        Text="Add" />
                                                                        

                                                                    <%--  <button class="btn btn-success" id="btnAddNew" title="Add [Alt+C]" onclick="if(fnAddAssetValidation())" causesvalidation="false" onserverclick="btnAddAsset_OnClick" runat="server"
                                                                        type= accesskey="C">
                                                            ...
                                                            <asp:Panel runat="server" ID="pnlAssetDtl" CssClass="stylePanel p-0" GroupingText="Asset Details"
                                                                >
                                                                <div >
                                                                    <div>
                                                                        <table width="100%">
                                                ...
                                                <div id="Div1"  runat="server">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
                                                            ...
                                                            <button class="btn btn-success" id="lnkUpdateDocuments" visible="false" title="Update [Alt+U]" onclick="if(fnConfirmUpdate())" onserverclick="lnkUpdateDocuments_Click" causesvalidation="false" runat="server"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
                                                            <div class="md-input">
                                                                <button class="btn btn-success" id="btnUploadROPDocuments" onserverclick="btnUploadROPDocuments_ServerClick" runat="server"
                                                    ...
                                                    <asp:Panel  runat="server" ID="pnlCustomerDocuments" CssClass="stylePanel" GroupingText="Customer Documents"
                                                       >
                                                        <div class="gird">
                                                            ...
                                                            <asp:GridView ID="gvPRDDT" runat="server" Width="99%" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <div class="md-input">
                                                                                <asp:TextBox ID="txtRemarks" ToolTip="Marketing Officer Remarks" onchange="funSetValidationValues();" runat="server" Width="200px" Text='<%# Eval("Remarks")%>'
                                                                                    TextMode="MultiLine" onkeyup="maxlengthfortxt(100)" MaxLength="100" CssClass="form-control"></asp:TextBox>
                                                                                <span class="highlight"></span>
                                                                                <span class="bar"></span>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <div class="md-input">
                                                                                <asp:UpdatePanel ID="updRemarks" runat="server">
                                                                                    <ContentTemplate>
                                                                                        <asp:LinkButton runat="server" ToolTip="View" CausesValidation="false" CssClass="btn btn-success btn-sm" ID="ImgButtonViewPrvRemarks" OnClick="ImgButtonViewPrvRemarks_Click" Text="View">
                                                                    ...
                                                                    <asp:TemplateField FooterStyle-HorizontalAlign="Center">
                                                                        ...
                                                                        <FooterTemplate>
                                                                            <div class="md-input">
                                                                                <asp:LinkButton ID="addPRDDC" CssClass="btn btn-success btn-sm" runat="server" ValidationGroup="DOC" Text="Add" AccessKey="J" ToolTip="Add [Alt+J]"
                                                                                    OnClick="lnkAAddPRDDCGrid_Click" CausesValidation="true">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                     ...
                                                     <div class="col mt-3 text-right" >
                                                            <button class="btn btn-success mr-2" id="btnGoDealerDoc" validationgroup="DealerGO" accesskey="K" onserverclick="btnGoDealerDoc_Click" runat="server"
                                                                type="button" causesvalidation="false" title="Go,Alt+K">
                                                                <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>&emsp;<u>G</u>o
                                                            </button>
                                                            <button class="btn btn-success mr-2" id="btnUpdateDocumentsDealer" accesskey="J" onserverclick="btnUpdateDocumentsDealer_ServerClick" runat="server"
                                                                type="button" causesvalidation="false" title="Update,Alt+J">
                                                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>&emsp;<u></u>Update
                                                            </button>
                                                            <button class="btn btn-outline-success" id="btnClearDealerDocInfo" accesskey="E" onserverclick="btnClearDealerDocInfo_ServerClick" runat="server"
                                                                type="button" causesvalidation="false" title="Clear,Alt+E">
                                                                <i class="fa fa-refresh" aria-hidden="true"></i>&emsp;R<u>e</u>set
                                                            </button>
                                                        </div>                                           
                                                </div>
                                                            ...
                                                            <asp:TemplateField HeaderText="Prv.Remarks">
                                                                <ItemTemplate>
                                                                    <div class="md-input">
                                                                        <asp:UpdatePanel ID="updRemarks" runat="server">
                                                                            <ContentTemplate>
                                                                                <asp:LinkButton runat="server" ToolTip="View" CausesValidation="false" CssClass="grid_btn" ID="ImgButtonViewPrvRemarksDeal" OnClick="ImgButtonViewPrvRemarksDeal_Click" Text="View">
                                                                                    <i class="fa fa-eye" aria-hidden="true"></i> View
                                                                                </asp:LinkButton>
                                                                            </ContentTemplate>
                                                                            <Triggers>
                                ...
                                <ContentTemplate>
                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div>
                                                <asp:Panel runat="server" ID="Panel11" HorizontalAlign="Center"  CssClass="stylePanel" GroupingText="Alert Details">
                    ...
                    <div class="fixed_btn">
                        <div class="col p-0">
                                ...
                                <button class="btn btn-success mr-2" id="btnSave" title="Save[Alt+S]" onclick="if(fnSaveValidation())" causesvalidation="false" onserverclick="btnSave_Click" runat="server"
                                    type="button" accesskey="S">
                                    <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>S</u>ave
                                </button>

                                <button class="btn btn-outline-success mr-2" id="btnClear" onserverclick="btnClear_Click" causesvalidation="false" runat="server" onclick="if(return fnConfirmClear())"
                                    type="button" accesskey="R" title="Clear_FA,Alt+R">
                                    <i class="fa fa-refresh"></i>&emsp;<u>R</u>eset
                                </button>
                                

                                <button class="btn btn-outline-danger mr-2" id="btnCancelCheckList" title="Cancel CheckList[Alt+W]" onclick="if(fnConfirmDealCancel())" causesvalidation="false" onserverclick="btnCancelCheckList_Click" runat="server"
                                ...
                                <button class="btn btn-outline-success" id="btnPdf" title="PDF [Alt+O]" causesvalidation="false" onserverclick="btnCheckListPrint" runat="server"
                                    type="button" accesskey="O">
                                    <i class="fa fa-file-pdf-o text-danger" aria-hidden="true"></i>&emsp;<u></u>PDF
                                </button>
                                <%-- </div>--%>
        ...
        <table width="100%">
            ...
            <tr>
                <td align="center" colspan="2">
                    <button class="btn btn-success" id="btnUploadMulti" onserverclick="btnUpload_Click" runat="server" causesvalidation="false" title="Upload"
                        type="button">
                        <i class="fa fa-upload" aria-hidden="true"></i>&emsp;<u></u>Upload
                    </button>
                    <button class="btn btn-success" id="btnUploadCancel" onserverclick="btnUploadCancel_Click" runat="server" causesvalidation="false" title="Exit" onclick="if(fnConfirmExit())"
                        type="button">
        ...
        <table width="100%">
            ...
            <tr>
                <td align="center" colspan="2">
                    ...
                    <button class="btn btn-success" id="btnCancelRemarkHis" onserverclick="btnCancelRemarkHis_Click" runat="server" accesskey="Z" causesvalidation="false" title="Exit[Alt+Z]" onclick="if(fnConfirmExit())"
                        type="button">
                        <i class="fa fa-times" aria-hidden="true"></i>&emsp;<u></u>Exit
                    </button>
                </td>
