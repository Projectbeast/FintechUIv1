        ...
        try
        {
            ...
            switch (intModeID)
            {
                ...
                case 1://Modify
                    ...
                    //btnCancelCheckList.Attributes.Add("disabled", "disabled");  // enable false
                    //btnCancelCheckList.Attributes.Add("class", "btn btn-success");  // enable false css
                    //btnViewDocuments.Visible = false;
                    ...
                    btnCreateCustomer.Attributes.Add("class", "btn_control_disable mb-2");  // enab
    ...
    protected void ddlCustomerType_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddlCustomerType.SelectedValue == "1")
            {
                ...
                btnCreateCustomer.Attributes.Add("class", "btn_control mb-2");  // enab
                btnLoadAccount.Enabled = false;
                ucCustomerCodeLov.Enabled = false;
