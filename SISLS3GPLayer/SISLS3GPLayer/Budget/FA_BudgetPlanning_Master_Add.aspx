                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div id="divLocationCatDetails" runat="server">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-1 mt-2 styleFieldLabel">
                                                <button class="btn btn-success" style="min-width: 84px !important;" id="btnGo" onserverclick="onGoclick" runat="server"
                                            ...
                                            <div class="col-md-2 mt-2 styleFieldLabel">
                                                <button class="btn btn-success" style="min-width: 84px !important;" id="btnCopyProfile" runat="server" title="Exit[Alt+P]" accesskey="P"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">
                                                                    ...
                                                                    <FooterTemplate>
                                                                        ...
                                                                        <button id="btnAddNew" class="btn btn-success" style="min-width: 84px !important;" runat="server"
                            ...
                            <div align="right" class="fixed_btn">
                                <button class="btn btn-success" id="btnSave" runat="server" type="button" accesskey="S" causesvalidation="false" title="Save[Alt+S]" onserverclick="btnSaveClick" onclick="if(fnCheckPageValidators())">
                                    <i class="fa fa-floppy-o"></i>&emsp;<u>S</u>ave
                                </button>

                                <button class="btn btn-success" id="btnClear" runat="server"
                                ...
                                <button class="btn btn-success" id="btnExit" runat="server" causesvalidation="false" onserverclick="btnExitClick" title="Exit[Alt+X]" onclick="if(fnConfirmExit())"
                    ...
                    <div class="modal-dialog" style="width: 60%">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-success" accesskey="C" title="Exit[Alt+C]" data-dismiss="modal"><i class="fa fa-times"></i>&emsp;<u>C</u>lose</button>
                            </div>
                        </div>
