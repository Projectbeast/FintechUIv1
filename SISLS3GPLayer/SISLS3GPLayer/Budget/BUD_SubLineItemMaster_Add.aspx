            ...
            <div>
                ...
                <div class="row">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Modify">
                                            ...
                                            <FooterTemplate>
                                                ...
                                                <button class="btn btn-success" id="btnAdd" title="Add,Alt+A" onserverclick="btnAdd_ServerClick" runat="server"
                                            ...
                                            <EditItemTemplate>
                                                ...
                                                <button class="btn btn-success" id="btnUpdate" title="Add,Alt+U" onserverclick="btnUpdate_ServerClick" runat="server"
                                                    type="button" accesskey="U" validationgroup="Modify">
                                                    <i class="fa fa-edit" aria-hidden="true"></i>&emsp;<u>U</u>pdate</button>

                                                <button class="btn btn-success" id="btnCancel" title="Add,Alt+C" onserverclick="btnCancel_ServerClick" runat="server"
                    ...
                    <div align="right" class="fixed_btn">
                        <button class="btn btn-success" id="btnSave" title="Save[Alt+S]" onserverclick="btnSave_Click"
                            runat="server" validationgroup="Save"   onclick="if(fnCheckPageValidators('Save'))" causesvalidation="false"
                            type="button" accesskey="S">
                            <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>S</u>ave
                        </button>
                        <%-- <button class="btn btn-success" id="btnSave" title="Save[Alt+S]" onclick="if(fnConfirmSave())"
                        ...
                        <button class="btn btn-success" id="btnClear" onserverclick="btnClear_ServerClick" causesvalidation="false" runat="server"
                            type="button" accesskey="L" title="Clear, Alt+L" onclick="if(fnConfirmClear())">
                            <i class="fa fa-eraser" aria-hidden="true"></i>&emsp;C<u>l</u>ear
                        </button>
                        <button class="btn btn-success" id="btnExit" onserverclick="btnExit_ServerClick" causesvalidation="false" runat="server"
