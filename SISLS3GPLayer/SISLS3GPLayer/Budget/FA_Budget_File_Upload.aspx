            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div id="divLocationCatDetails" runat="server">
                    ...
                    <div class="m-2 text-center">
                        <button class="btn btn-success" style="min-width: 84px !important;" id="btnFileupload" runat="server" onclick="if(fnCheckPageValidators_Extn())"
                        ...
                        <%--<button class="btn btn-success" style="min-width: 84px !important;" onclick="return confirm('Do you want to Clear?');" id="btnClear" runat="server"
                          ...
                          <button class="btn btn-success" id="Button1" runat="server"
                        ...
                        <button class="btn btn-success" style="min-width: 84px !important;" id="btnSearch" runat="server"
                        ...
                        <button class="btn btn-success" style="min-width: 84px !important;" id="btnCancel" runat="server"
