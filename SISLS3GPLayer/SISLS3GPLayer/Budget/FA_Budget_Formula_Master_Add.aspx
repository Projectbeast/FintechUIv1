            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div id="divLocationCatDetails" runat="server">
                    ...
                    <div class="m-2 text-center">
                        <button class="btn btn-success" style="min-width: 84px !important;" id="BtnCurrentYBudgetSave" runat="server"
                            type="button" accesskey="S" causesvalidation="false" title="Save[Alt+S]">
                            <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>S</u>ave
                        </button>
                        <button class="btn btn-success" style="min-width: 84px !important;" id="Button1" runat="server"
                            type="button" accesskey="R" title="Clear[Alt+R]" causesvalidation="false">
                            <i class="fa fa-trash"></i>&emsp;<u>C</u>lear
                        </button>
                        <button class="btn btn-success" style="min-width: 84px !important;" id="Button2" runat="server"
