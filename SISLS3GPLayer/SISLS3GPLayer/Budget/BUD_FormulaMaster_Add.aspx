        ...
        <ContentTemplate>
            <div style="margin-bottom: 50px;">
                                        ...
                                        <div class="grid">
                                            <asp:GridView runat="server" ID="grvGLCode" AutoGenerateColumns="false" ShowFooter="true">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <button class="btn btn-success" id="btnDelete" title="Delete,Alt+D" onserverclick="btnDelete_ServerClick" runat="server"
                ...
                <div align="right" class="fixed_btn">
                    <button class="btn btn-success" id="btnSave" title="Save[Alt+S]" onserverclick="btnSave_ServerClick"
