...
public partial class System_Admin_FA_Sys_ScheduledJobs : ApplyThemeForProject_FA
{
    ...
    FAAdminServiceReference.FAAdminServicesClient objFAAdminServiceClient = null;
    FASession ObjFASession = null;
    string strKey = "Insert";
    string strAlert = "alert('__ALERT__');";
    string strRedirectPage = "FA_Sys_ScheduledJobs.aspx";
    string strRedirectPageView = "FA_Sys_ScheduledJobsView.aspx";
    string strConnectionName = string.Empty;
    string strRedirectPageAdd = "window.location.href='../System Admin/FA_Sys_ScheduledJobs.aspx';";
    string strRedirectPageView1 = "window.location.href='../System Admin/FA_Sys_ScheduledJobsView.aspx';";
    ...
    private void FunPriLoadLov()
    {
        ...
        ddlFrequency.BindDataTable_FA("FA_SCH_LOADLOV", Procparam, new string[] { "Lookup_Code", "Lookup_Desc" });
        Procparam.Clear();
        Procparam.Add("@Option", "2");
        Procparam.Add("@CompanyID", intCompanyID.ToString());
        ddlJobNature.BindDataTable_FA("FA_SCH_LOADLOV", Procparam, new string[] { "Lookup_Code", "Lookup_Desc" });

        Procparam.Clear();
        Procparam.Add("@Option", "3");
        Procparam.Add("@CompanyID", intCompanyID.ToString());
        ddlJob.BindDataTable_FA("FA_SCH_LOADLOV", Procparam, new string[] { "Lookup_Code", "Lookup_Desc" });
        Procparam.Clear();
    ...
    {
        return;
        objFAAdminServiceClient = new FAAdminServiceReference.FAAdminServicesClient();
        try
        {
            ...
            intErrCode = objFAAdminServiceClient.FunPubCreateScheduledJobs(SerMode, byteobjScheduledJobsDataTable,strConnectionName,out strSch_ID);
            if (intErrCode == 0)
            {
