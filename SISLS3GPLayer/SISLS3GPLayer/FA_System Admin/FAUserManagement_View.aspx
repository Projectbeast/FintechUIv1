        ...
        <ContentTemplate>
            <div>
                ...
                <div align="right" class="fixed_btn">
                    <button id="btnCreate" runat="server" class="btn btn-success" onserverclick="btnCreate_Click" causesvalidation="false" accesskey="C" title="Create[Alt+C]"
                        type="button"  visible="false">
                        <i class="fa fa-plus-square" aria-hidden="true"></i>&emsp;<u>C</u>reate
                    </button>
                    <button id="btnShowAll" runat="server" class="btn btn-success" type="button" accesskey="H" title="Show All[Alt+H]"
