...
public partial class System_Admin_FA_Report_AccountMapping_View : ApplyThemeForProject_FA
{
    #region Paging Config
    static string strPageName = "Report Account mapping";
    string strRedirectPage = "~/System Admin/Fa_Report_Account_mapping.aspx";
    int intNoofSearch = 1;
    //string[] arrSortCol = new string[] { "LOB", "Product", "Constitution", "Name", "Program", "" };
    string[] arrSortCol = new string[] { "Program_Code + ' - ' + Program_Name", "" };
    string strProcName = "FA_GET_ReportAccount_PAGING";
    ...
    private void FunPriBindGrid()
    {
        try
        {
            ...
            grvPaging.BindGridView_FA(strProcName, Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
    ...
    protected void FunProHeaderSearch(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            for (int iCount = 0; iCount < arrSearchVal.Capacity; iCount++)
            {
                ...
                {
                    //Modified By Chandrasekar K On 24-Sep-2012 For Oracle Case Sensitive Issue
