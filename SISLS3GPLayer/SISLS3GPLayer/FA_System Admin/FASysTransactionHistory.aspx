                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <asp:Panel ID="PnlInputCriteria0" GroupingText="Input Criteria" runat="server" CssClass="stylePanel">
                                        ...
                                        <div align="right">
                                            <button class="btn btn-success" id="btnGo" onserverclick="btnGo_Click" validationgroup="GO" runat="server"
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <asp:Panel ID="Panel2export" GroupingText="Export" runat="server" CssClass="stylePanel">
                                        <div align="right">
                                            <button class="btn btn-success" id="btnExportToExcel" onserverclick="btnExcel_Click" runat="server"
