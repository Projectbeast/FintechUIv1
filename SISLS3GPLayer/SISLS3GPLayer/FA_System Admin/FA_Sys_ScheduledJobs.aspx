<%@ Page Title="" Language="C#" MasterPageFile="~/Common/FAMasterPageCollapse.master" AutoEventWireup="true" CodeFile="FA_Sys_ScheduledJobs.aspx.cs" Inherits="System_Admin_FA_Sys_ScheduledJobs" %>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table width="100%" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="btnSave" Text="Save" runat="server" OnClick="btnSave_Click" CssClass="styleSubmitButton" OnClientClick="return fnCheckPageValidators('Save')" ToolTip="Save,Alt+S" AccessKey="S" />
                        <asp:Button ID="btnClear" Text="Clear_FA" runat="server" OnClick="btnClear_Click" CssClass="styleSubmitButton" ToolTip="Clear_FA,Alt+L" AccessKey="L" OnClientClick="return fnConfirmClear();" />
                        <asp:Button ID="btnCancel" Text="Exit" runat="server" OnClick="btnCancel_Click" CssClass="styleSubmitButton" ToolTip="Exit,Alt+X" AccessKey="X" OnClientClick="return fnConfirmExit();" />
                    </td>
                </tr>
                <tr>
                    <td class="styleFieldLabel">
