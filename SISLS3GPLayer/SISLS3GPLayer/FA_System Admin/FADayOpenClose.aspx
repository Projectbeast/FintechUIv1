                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <asp:UpdatePanel ID="UpdatePanel2" UpdateMode="Conditional" ChildrenAsTriggers="true" runat="server">
                        <ContentTemplate>
                            ...
                            <div align="right">
                                <button class="btn btn-success" id="btnSave" onserverclick="btnSave_Click" runat="server" onclick="if(fnCheckPageValidators('Main'))"
                                ...
                                <button class="btn btn-success" id="btnClear" causesvalidation="false" onserverclick="btnClear_ServerClick" runat="server" onclick="if(fnConfirmClear())"
                                    type="button" accesskey="L" title="Clear,Alt+L">
                                    <i class="fa fa-eraser" aria-hidden="true"></i>&emsp;C<u>l</u>ear
                                </button>
                                <button class="btn btn-success" id="btnCancel" onserverclick="btnCancel_Click1" causesvalidation="false" runat="server" onclick="if(fnConfirmExit())"
