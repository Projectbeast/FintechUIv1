...
public partial class System_Admin_FA_Report_Master : ApplyThemeForProject_FA
{
    #region Initialisation
    public static System_Admin_FA_Report_Master Obj_Page;
    ...
    protected void FunProInitializeGridData()
    {
        ...
        dtReport.Columns.Add("Report_Name");
        dtReport.Columns.Add("Short_Name");
        dtReport.Columns.Add("Heading");
        dtReport.Columns.Add("Type");
        dtReport.Columns.Add("Frequency");
    ...
    private void FunPriLoadlookupValues()
    {
        try
        {
            ...
            dictParam.Add("@LookupType_Code", "120");
            ddlReportType.BindDataTable_FA(SPNames.GETLOOKUPVALUES, dictParam, new string[] { "Lookup_Code", "Lookup_Desc" });
