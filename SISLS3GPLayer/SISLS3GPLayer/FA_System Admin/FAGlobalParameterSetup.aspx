    ...
    <asp:UpdatePanel ID="upGPS" runat="server">
        <ContentTemplate>
            <div align="right">
                ...
                <button class="btn btn-success" id="btnClear" causesvalidation="false" onserverclick="btnClear_Click" runat="server" onclick="if(fnConfirmClear())"
                    type="button" accesskey="L" title="Clear_FA,Alt+L">
                    <i class="fa fa-eraser" aria-hidden="true"></i>&emsp;C<u>l</u>ear
                </button>

                <button class="btn btn-success" id="btnCancel" onserverclick="btnCancel_Click" causesvalidation="false" runat="server" onclick="if(fnConfirmExit())"
