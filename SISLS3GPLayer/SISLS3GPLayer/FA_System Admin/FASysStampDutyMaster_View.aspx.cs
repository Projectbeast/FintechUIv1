...
public partial class System_Admin_FASysStampDutyMaster_View : ApplyThemeForProject_FA
{

    #region Paging Config
    string strRedirectPage = "~/System Admin/FASysStampDutyMaster_Add.aspx";
    int intNoofSearch = 1;
    string[] arrSortCol = new string[] { "LRMAP.LocationCat_Description" }; //
    //string strProcName = "S3G_CLN_TransLanderApproLogic";
    static string strPageName = "Stamp Duty Master View";
    ...
    private void FunPriBindGrid()
    {
        try
        {
            ...
            grvPaging.BindGridView_FA("FA_StampDuty_MST_PAGING", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow); //
