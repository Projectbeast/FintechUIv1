...
public partial class Sysadm_FASysExchangeMaster_View : ApplyThemeForProject_FA
{

    #region Paging Config
    string strRedirectPage = "~/FA_System Admin/FASysExchangeMaster_Add.aspx";
    int intNoofSearch = 3;
    string[] arrSortCol = new string[] { "CMB.Currency_Name", "LOCAT.LocationCat_Description", "CME.Currency_Name" };
    //string strProcName = "S3G_CLN_TransLanderApproLogic";
    static string strPageName = "Exchange Rate Master View";
    ...
    private void FunPriBindGrid()
    {
        try
        {
            ...
            grvPaging.BindGridView_FA(SPNames.ExchangeRate_Paging, Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
