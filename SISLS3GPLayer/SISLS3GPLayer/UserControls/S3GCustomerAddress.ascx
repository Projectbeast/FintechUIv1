                ...
                <td id="V1FirstColumn1">
                    <div class="md-input">
                        <asp:TextBox ID="txtCustomerCode" runat="server" ReadOnly="True" TabIndex="-1"
                            ToolTip="Customer Code" CssClass="md-form-control form-control login_form_content_input"></asp:TextBox>
            ...
            <tr>
                <td id="V1FirstColumn2">
                    <div class="md-input">
                        ...
                        "
                            ToolTip="Customer Name" CssClass="md-form-control form-control login_form_content_input"></asp:TextBox>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>
                ...
                <td id="V1FirstColumn4">
                    <div class="md-input">
                        ...
                        <asp:TextBox ID="txtPhone" runat="server" ReadOnly="True" TabIndex="-1"
                            CssClass="md-form-control form-control login_form_content_input float_left" Width="40%" ToolTip="Phone"></asp:TextBox>
                        ...
                        <asp:TextBox ID="txtMobile" runat="server" TabIndex="-1" ReadOnly="true" Width="40%"
                            CssClass="md-form-control form-control login_form_content_input float_left" ToolTip="Mobile"></asp:TextBox>
                        </div>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>
                ...
                <td id="V1FirstColumn5">
                    <div class="md-input">
                        <asp:TextBox ID="txtEmail" runat="server" ReadOnly="True" TabIndex="-1"
                            CssClass="md-form-control form-control login_form_content_input" ToolTip="EMail ID"></asp:TextBox>
                ...
                <td  id="V1FirstColumn6">
                    <div class="md-input">
                        <asp:TextBox ID="txtWebSite" runat="server" ReadOnly="True" TabIndex="-1"
                            CssClass="md-form-control form-control login_form_content_input" ToolTip="Website"></asp:TextBox>
    ...
    <asp:View ID="CustomerDetailV2" runat="server">
        <table cellspacing="0" width="100%" runat="server" id="tblView2">
            <tr>
                ...
                <td class="styleFieldAlign" id="SecondColumn1" >
                    <asp:TextBox ID="txtCustomerCode1" runat="server" ReadOnly="True" TabIndex="-1" Width="65%" ToolTip="Customer Code" CssClass="md-form-control form-control login_form_content_input"></asp:TextBox>
                </td>
                ...
                <td class="styleFieldAlign" id="FourthColumn1">
                    <asp:TextBox ID="txtCustomerName1" runat="server" ReadOnly="True" TabIndex="-1" ToolTip="Customer Name"
                        Width="95%" CssClass="md-form-control form-control login_form_content_input mb-1"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td rowspan="3" class="styleFieldAlign" id="SecondColumn2">
                    <asp:TextBox ID="txtCusAddress1" runat="server" ReadOnly="true" TabIndex="-1" Width="95%" Rows="4"
                        TextMode="MultiLine" ToolTip="Address" CssClass="md-form-control form-control login_form_content_input"></asp:TextBox>
                </td>
                ...
                <td class="styleFieldAlign d-flex mb-1" id="FourthColumn2" style="width:90%">
                    <asp:TextBox ID="txtPhone1" runat="server" ReadOnly="True" Width="44%" TabIndex="-1" ToolTip="Phone" CssClass="md-form-control form-control login_form_content_input"></asp:TextBox>
                    <asp:Label ID="lblMobile1" runat="server" CssClass="styleDisplayLabel p-2" Text="[M]"></asp:Label>
                    <asp:TextBox ID="txtMobile1" runat="server" ReadOnly="True" Width="37%" TabIndex="-1" ToolTip="Mobile" CssClass="md-form-control form-control login_form_content_input"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td class="styleFieldAlign" id="FourthColumn3">
                    <asp:TextBox ID="txtEmail1" runat="server" ReadOnly="True" TabIndex="-1" Width="90%" ToolTip="EMail ID" CssClass="md-form-control form-control login_form_content_input"></asp:TextBox>
                </td>
            </tr>
            <tr style="display:none">
                ...
                <td class="styleFieldAlign" id="FourthColumn4">
                    <asp:TextBox ID="txtWebSite1" runat="server" ReadOnly="True" TabIndex="-1" Width="90%" ToolTip="Website" CssClass="md-form-control form-control login_form_content_input"></asp:TextBox>
                </td>
            </tr>
        </table>
    </asp:View>
