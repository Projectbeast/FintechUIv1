...
<table cellpadding="0" cellspacing="0" runat="server" id="tblContent" style="width: 100%;" class="no-th-td-border">
    <tr>
        <td style="width: 100%; padding: 0px !important;">
            <asp:UpdatePanel ID="dfd" runat="server">
                <ContentTemplate>
                    <div>
                        <table style="width: 100%" class="no-th-td-border">
                            <tr>
                                <td style="padding: 0px !important">
                                    ...
                                    <asp:TextBox ID="txtLastSelectedText" Style="display: none; width:auto !important" runat="server"
                                        class="md-form-control form-control login_form_content_input Auto_Complete_txt"></asp:TextBox>
                                ...
                                <td style="padding: 0px !important">
                                 ...
                                 <td style="padding: 0px !important">
                                    <asp:Button ID="btnOpenProgram" runat="server" Style="display: none; position: absolute"
                                        OnClick="btnOpenProgram_Clicked" CausesValidation="false" />
                                </td>
                            </tr>
                        </table>
                    </div>
