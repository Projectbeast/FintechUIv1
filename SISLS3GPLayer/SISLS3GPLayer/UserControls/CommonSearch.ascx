...
<table style="width: 100%;" class="no-th-td-border gird-details-no-row-bg">
    <tr>
        <td style="padding: 0px !important; padding-right: 5px !important;">
            <asp:TextBox ID="TxtName" runat="server" CssClass="md-form-control form-control" Style="width: 100%;"></asp:TextBox>
            <%-- <cc1:TextBoxWatermarkExtender ID="txtBranchSearchExtender" runat="server" TargetControlID="TxtName"
                WatermarkText="--Select--">
            </cc1:TextBoxWatermarkExtender>--%>
