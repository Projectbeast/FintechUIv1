            ...
            <div class="row m-0">
                ...
                <div class="col mr-3">
                    <div class="float-right">
                        <button class="btn btn-outline-success btn-create" id="btnCancel" title="Exit[Alt+T]" onclick="if(fnConfirmExit())" causesvalidation="false" onserverclick="btnCancel_Click" runat="server"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row mt-2">
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <div class="col d-flex mt-3">
                                                                    <asp:CheckBox runat="server" AutoPostBack="True" ID="chkCopyProfile" OnCheckedChanged="chkCopyProfile_CheckedChanged"
                                                                        Text=" " CssClass="d-flex user-management-check" />
                                                                    <asp:Label runat="server" ID="lblcpyProfile" CssClass="mt-2 styleFieldLabel"
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <div class="md-input ">
                                                                    <label>
                                                                        <asp:Label runat="server" Text="Password" ID="lblPassword" CssClass="styleFieldLabel"></asp:Label>
                                                                    </label>
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12" id="divReset" style="display: none" runat="server">
                                                                <div class="col p-0 d-flex mt-3">
                                                                    <asp:Label runat="server" Text="Reset Password" ID="Label4" CssClass="styleFieldLabel  mr-2 mt-2"></asp:Label>
                                                                    <asp:CheckBox runat="server" ID="chkResetPwd"
                                                                        Text=" " OnClick="fnEnablePwd();" CssClass="d-flex user-management-check" />
                                                      ...
                                                      <%--  <asp:Image ID="imgDOR" runat="server" ImageUrl="~/Images/calendaer.gif" />--%>
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                <div class="col d-flex mt-3">
                                                                    <asp:Label runat="server" Text="Active" ID="lblActive" CssClass="mr-2 mt-2"></asp:Label>
                                                                    <asp:CheckBox ID="chkActive" Checked="True" runat="server" CssClass="d-flex user-management-check" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                        <ContentTemplate>
                                            <div class="mx-3">
                                                ...
                                                <div class="row gird mt-2 m-0 mb-3 py-3 px-1" id="divAction" runat="server">
                                                    <div class="col-md-6 md-input col-12">
                                                        <label>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="row">
                                                            <div class="col-md-6 md-input p-0">
                                                                <asp:Panel ID="pnlLobList" runat="server" CssClass="stylePanel" GroupingText="Line Of Business">
                                                                    <div style="overflow: auto; height: 200px">
                                                                        <asp:GridView ID="GrvLOBList" runat="server" OnRowDataBound="GrvLOBList_RowDataBound" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderStyle-CssClass="col text-center">
                                                                                    <HeaderTemplate>
                                                                                        <asp:CheckBox ID="chkLOBAll" runat="server" AutoPostBack="true" OnCheckedChanged="chkLOBAll_CheckedChanged" CssClass="checkbox-align" />
                                                                                    </HeaderTemplate>
                                                                                    <ItemTemplate>
                                                                                        <asp:CheckBox ID="chkLOB" runat="server" AutoPostBack="true" OnCheckedChanged="chkLOB_OnCheckedChanged" CssClass="checkbox-align" />
                                                                        ...
                                                                        <asp:GridView ID="grdActivity" runat="server" OnRowDataBound="grdActivity_RowDataBound" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderStyle-CssClass="col-10">
                                                                                    <ItemTemplate>
                                                                                ...
                                                                                <asp:TemplateField HeaderStyle-CssClass="col text-center">
                                                                                    <HeaderTemplate>
                                                                                        <asp:CheckBox ID="chkActivityAll" runat="server" AutoPostBack="true" OnCheckedChanged="Activity_CheckedChanged" CssClass="mr-3" />
                                                                                    </HeaderTemplate>
                                                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Panel ID="pnlLocation" runat="server" CssClass="stylePanel" GroupingText="Location">
                                                            <div style="overflow: auto; height: 300px">
                                                                <asp:TreeView ID="treeview" runat="server" ImageSet="Simple" ShowCheckBoxes="Parent,Leaf"
                                                                    ...
                                                                    RootNodeStyle-Font-Size="14px" LeafNodeStyle-Font-Size="14px" ParentNodeStyle-Font-Size="14px" Font-Names="'Funnel Sans', sans-serif !important" CssClass="tree_view_node">
                                                                    <DataBindings>
                                                                    ...
                                                                    <asp:TemplateField>
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" CausesValidation="false" Text="Remove"
                                                                                OnClientClick="return confirm('Are you sure you want to Remove this record?');" ToolTip="Remove the Details, Alt+D" AccessKey="D" CssClass="btn grid_btn_delete">
                                                                                <i class="fa fa-trash" aria-hidden="true"></i> Remove
                                                                            </asp:LinkButton>
                                                                        </ItemTemplate>
                                                                        <FooterTemplate>
                                                                            <asp:LinkButton ID="btnAdd" runat="server" CommandName="AddNew"
                                                                                CssClass="btn btn-sm btn-success" Text="Add" ToolTip="Add the Details, Alt+T" AccessKey="T"><i class="fa fa-plus" aria-hidden="true"></i> Add</asp:LinkButton>
                                                                        </FooterTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                                <HeaderStyle CssClass="styleGridHeader" />
