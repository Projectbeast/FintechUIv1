...
public partial class System_Admin_S3GSysAdminUserLoc_View : ApplyThemeForProject
{
    ...
    string strRedirectPage = "~/System Admin/S3GSysAdminUserLoc_Add.aspx";
    ...
    private void FunGetUserDetails()
    {
        ...
        try
        {
            ...
            grvUserManagement.BindGridView("S3G_SYSAD_LOCUSERMAPMST_PAGING", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
            if (bIsNewRow)
            {
    ...
    protected void FunProHeaderSearch(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (strSearchVal1 != "")
            {
                strSearchVal += "USERLOCMAP_NAME like '%" + strSearchVal1 + "%'";
            }
        ...
        try
        {
            ...
            switch (lnkbtnSearch.ID)
            {
                case "lnkbtnUserGroupName":
                    strSortColName = "USERLOCMAP_NAME";
                    break;
            }
