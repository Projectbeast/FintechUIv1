                        ...
                        <div class="row">
                            <asp:Panel GroupingText="Item Profile Setup" Width="100%" ID="pnlLookInfo" runat="server"
                                ...
                                <div align="right" style="margin-top: 15px;">
                                    <button class="btn btn-success" id="btnGo" onserverclick="btnGoProgramName_TextChanged" validationgroup="Go" runat="server"
                                        type="button" causesvalidation="true" accesskey="G" title="Go,Alt+G">
                                        <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>&emsp;<u>G</u>o
                                    </button>
                                    <button class="btn btn-success" id="Button1" onclick="if(fnConfirmClear())" causesvalidation="false" title="Clear,Alt+C" onserverclick="btnClear_Click" runat="server"
