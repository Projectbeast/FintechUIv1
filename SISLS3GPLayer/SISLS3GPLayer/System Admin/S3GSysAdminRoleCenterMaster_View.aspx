                    ...
                    <div class="row mx-3">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gird p-0">
                            <asp:GridView runat="server" ID="grvRoleCenterMaster" AutoGenerateColumns="false"
                                ...
                                OnRowDataBound="grvRoleCenterMaster_RowDataBound" OnRowCommand="grvRoleCenterMaster_RowCommand" class="gird_details" Width="100%">
                                <Columns>
                                            ...
                                            <thead>
                                                <tr align="center">
                                                    <th style="padding: 0px !important; background: none !important; border: none">
                                                        <asp:LinkButton ID="lnkbtnRoleCenterCode" OnClick="FunProSortingColumn" CssClass="styleGridHeaderLinkBtn"
                                                            runat="server" ToolTip="Sort By Role Center Name" Text="Role Center Name"></asp:LinkButton>
                                                        <asp:Label ID="imgbtnRoleCenterCode" runat="server" ImageAlign="Middle" CssClass="styleImageSortingAsc"></asp:Label>
                                                    </th>
                                                </tr>
                                                <tr align="left">
                                                    <th style="padding: 0px !important; background: none !important; border: none">
                                                        <div class="md-input" style="margin: 0px;">
                                                            <asp:TextBox AutoCompleteType="None" ID="txtHeaderRoleCenterCode" class="form-control form-control-sm mt-1" onpaste="return false;"
                                    ...
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <thead>
                                                <tr align="center">
                                                    <th style="padding: 0px !important; background: none !important; border: none">
                                                        <asp:LinkButton ID="lnkbtnRoleCode" OnClick="FunProSortingColumn" CssClass="styleGridHeaderLinkBtn"
                                                            runat="server" ToolTip="Sort By Role Code" Text="Role Code"></asp:LinkButton>
                                                        <asp:Label ID="imgbtnRoleCode" runat="server" ImageAlign="Middle" CssClass="styleImageSortingAsc"></asp:Label>
                                                    </th>
                                                </tr>
                                                <tr align="left">
                                                    <th style="padding: 0px !important; background: none !important; border: none">
                                                        <asp:TextBox AutoCompleteType="None" ID="txtHeaderRoleCode" class="form-control form-control-sm mt-1" onpaste="return false;"
                                                            runat="server" AutoPostBack="true" OnTextChanged="FunProHeaderSearch"></asp:TextBox>
                                                    </th>
                                                </tr>
                                            </thead>
                                    ...
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <thead>
                                                <tr align="center">
                                                    <th style="padding: 0px !important; background: none !important; border: none">
                                                        <asp:LinkButton ID="lnkbtnModuleCode" OnClick="FunProSortingColumn" CssClass="styleGridHeaderLinkBtn"
                                                            runat="server" ToolTip="Sort By Module Name" Text="Module Name"></asp:LinkButton>
                                                        <asp:Label ID="imgbtnModuleCode" runat="server" ImageAlign="Middle" CssClass="styleImageSortingAsc"></asp:Label>
                                                    </th>
                                                </tr>
                                                <tr align="left">
                                                    <th style="padding: 0px !important; background: none !important; border: none">
                                                        <asp:TextBox AutoCompleteType="None" ID="txtHeaderModuleCode" class="form-control form-control-sm mt-1" onpaste="return false;"
                                                            runat="server" AutoPostBack="true" OnTextChanged="FunProHeaderSearch"></asp:TextBox>
                                                    </th>
                                                </tr>
                                            </thead>
                                    ...
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <thead>
                                                <tr align="center">
                                                    <th style="padding: 0px !important; background: none !important; border: none">
                                                        <asp:LinkButton ID="lnkbtnProgramCode" CssClass="styleGridHeaderLinkBtn"
                                                            runat="server" ToolTip="Sort By Program Name" OnClick="FunProSortingColumn" Text="Program Name"></asp:LinkButton>
                                                        <asp:Label ID="imgbtnProgramCode" runat="server" ImageAlign="Middle" CssClass="styleImageSortingAsc"></asp:Label>
                                                    </th>
                                                </tr>
                                                <tr align="left">
                                                    <th style="padding: 0px !important; background: none !important; border: none">
                                                        <asp:TextBox AutoCompleteType="None" ID="txtHeaderProgramCode" class="form-control form-control-sm mt-1" onpaste="return false;"
                                                            runat="server" AutoPostBack="true" OnTextChanged="FunProHeaderSearch"></asp:TextBox>
                                                    </th>
                                                </tr>
                                            </thead>
