            ...
            <table width="100%" align="center" cellpadding="0" cellspacing="0">
                <div id="tab-content" class="tab-content">
                    ...
                    <div align="right" class="fixed_btn">
                        <button class="btn btn-success" id="btnSave" title="Save[Alt+S]" onclick="if(fnCheckPageValidators())" causesvalidation="false"
                        ...
                        <button class="btn btn-success" id="btnDelete" title="Delete[Alt+D]" causesvalidation="false" onserverclick="btnDelete_Click" runat="server"
