                                            ...
                                            <div style="height: 310px; overflow-y: scroll;">
                                                <asp:UpdatePanel ID="UpTransDetails" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        ...
                                                        <div align="right">
                                                            <button class="btn btn-success" id="btnSearchTrans" onserverclick="btnSearchTrans_Click" title="Filter, Alt+F" runat="server"
                                                        ...
                                                        <div align="right">
                                                            <button id="BtnExportTrans" runat="server" accesskey="X" title="Export To Excel[Alt+X]" class="btn btn-success" type="button"
                                                            ...
                                                            <button id="BtnCloseTransPanel" runat="server" accesskey="C" title="Close[Alt+C]" class="btn btn-success" type="button"
