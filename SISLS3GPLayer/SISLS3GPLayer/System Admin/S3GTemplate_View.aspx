        ...
        <ContentTemplate>
            <div>
                ...
                <div align="right" class="fixed_btn">
                    <button id="btnCreate" runat="server" class="btn btn-success" onserverclick="btnCreate_Click" causesvalidation="false" title="Create, Alt+C" accesskey="C"
                        type="button">
                        <i class="fa fa-plus-square" aria-hidden="true"></i>&emsp;<u>C</u>reate
                    </button>
                    <button id="btnShowAll" runat="server" onserverclick="btnShowAll_Click" class="btn btn-success" title="Show All, Alt+H" accesskey="H">
