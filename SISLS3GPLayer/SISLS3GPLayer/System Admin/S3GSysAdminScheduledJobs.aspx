                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Panel ID="pnlScheduleDetails" Width="100%" GroupingText="Schedule Details" CssClass="stylePanel"
                            ...
                            <div class="row" style="float: right; margin-top: 5px;">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                    <div class="md-input">
                                        <button class="btn btn-success" id="btnStartStopTimer" title="Start/Stop Refresh Timer[Alt+X]" causesvalidation="false" onserverclick="btnStartStopTimer_ServerClick" runat="server"
                                            type="button" accesskey="X">
                                            <i class="fa fa-reply" aria-hidden="true"></i>&emsp;<u></u>Stop Timer
                                        </button>
                                        <button class="btn btn-success" id="btnDownloadOcbExcpetion" title="DownLoad OCB Exception" causesvalidation="false" onserverclick="btnDownloadOcbExcpetion_ServerClick" runat="server"
                                            type="button">
