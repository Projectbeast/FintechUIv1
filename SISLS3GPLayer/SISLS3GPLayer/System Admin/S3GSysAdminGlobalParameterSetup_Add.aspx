            ...
            <div>
                <div class="row">
                    ...
                    <div class="col mr-3">
                        <div class="float-right">
                            <button class="btn btn-outline-success btn-create" id="btnExitHeader" title="Exit[Alt+X]" onclick="if(fnConfirmExit())" causesvalidation="false" onserverclick="btnExit_Click" runat="server"
                            ...
                            <cc1:TabContainer ID="tcGlobalParamSetup" runat="server" CssClass="styleTabPanel"
                                                    ...
                                                    <asp:Panel runat="server" ID="panGeneralParameters" GroupingText="General Parameters"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <label class="tess">
                                                                    <asp:Label ID="lblSystemType" runat="server" Text="System Type" CssClass="styleFieldLabel"></asp:Label>
                                                                </label>
                                                                <div class="md-input">
                                                                    <asp:RadioButton ID="rbtnIntegratedSystem" runat="server" GroupName="SystemType"
                                                                        Text="Integrated System" TextAlign="Left" Checked="True" CssClass="form-check-input" />
                                                                    <span class="highlight"></span>
                                                                    <span class="bar"></span>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <label class="tess">
                                                                    <asp:Label ID="lblSystemTypeAlt" runat="server" Text="Alternative System" CssClass="styleFieldLabel"></asp:Label>
                                                                </label>
                                                                <div class="md-input">
                                                                    <asp:RadioButton ID="rbtnStandAlone" runat="server" GroupName="SystemType" Text="Stand alone System"
                                                                        TextAlign="Left" CssClass="form-check-input" />
                                                                    <span class="highlight"></span>
                                                                    <span class="bar"></span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row" id="divMLA" runat="server" visible="false">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <label class="tess">
                                                                    <asp:Label ID="lblAccountType" runat="server" Text="Account Type" CssClass="styleFieldLabel"></asp:Label>
                                                                </label>
                                                                <div class="md-input">
                                                                    <asp:RadioButton ID="rbtnMLA" runat="server" GroupName="AccountType" Checked="True"
                                                                        Text="Only MLA" TextAlign="Left" Visible="False" CssClass="form-check-input" />
                                                                    <span class="highlight"></span>
                                                                    <span class="bar"></span>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <label class="tess">
                                                                    <asp:Label ID="lblAccountTypeAlt" runat="server" Text="MLA & SLA Type" CssClass="styleFieldLabel"></asp:Label>
                                                                </label>
                                                                <div class="md-input">
                                                                    <asp:RadioButton ID="rbtnMLASLA" runat="server" GroupName="AccountType" Text="MLA and SLA"
                                                                        TextAlign="Left" Visible="False" CssClass="form-check-input" />
                                                                    <span class="highlight"></span>
                                                                    <span class="bar"></span>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                    <asp:Panel ID="PnlPassword" Style="display: none; vertical-align: middle" runat="server"
                                                                        ...
                                                                        <a id="hideModalPopupClientButton" href="#" onclick="hideModalPopupViaClient();">
                                                                            <center>
                                                                                <button class="btn btn-success" id="btnpopupExit" causesvalidation="false" runat="server" type="button">
                                ...
                                <cc1:TabPanel runat="server" HeaderText="Month End Parameters" ID="TbCustomerRange" CssClass="tabpan"
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="row m-0 p-0 mt-3" style="margin-bottom: 100px !important;">
                                            <div class="col">
                                                <%--asp:Panel ID="pnlcustomerRange" runat="server" CssClass="cssStylePanel">--%>
                                                    <%--<div id="div2" style="overflow: auto; height: 345px;" width="99%">--%>
                                                        <div class="gird">
                                                            <asp:GridView ID="grvcustomerrange" runat="server" AutoGenerateColumns="False" Width="99%" OnRowDeleting="gvInflow_Deleting" ShowFooter="true" >
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="LOB">
                                                                        ...
                                                                        <FooterTemplate>
                                                                            <asp:DropDownList ID="ddlLOB" runat="server" ToolTip="Line of Business" CssClass="form-control form-control-sm">
                                                                            </asp:DropDownList>
                                                                        </FooterTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="CashFlow Flag">
                                                                        ...
                                                                        <FooterTemplate>
                                                                            <uc:Suggest ID="ddlflag" Width="100%" runat="server" ServiceMethod="GetSearchOptionList" />
                                                                        </FooterTemplate>
                                                                        <HeaderStyle CssClass="styleGridHeader" Width="25%" />
                                                                        <FooterStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="GL Code">
                                                                        ...
                                                                        <FooterTemplate>
                                                                            <uc:Suggest ID="ddlGl_code" Width="50%" runat="server" AutoPostBack="true" ServiceMethod="GetGLCodeList"></uc:Suggest>
                                                                        </FooterTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="SL Code">
                                                                        ...
                                                                        <ItemStyle HorizontalAlign="Left" />
                                                                        <FooterTemplate>
                                                                            <uc:Suggest ID="ddlSl_code" Width="50%" runat="server" AutoPostBack="true" ServiceMethod="GetSLCodeList"></uc:Suggest>
                                                                        </FooterTemplate>
                                                                         <HeaderStyle CssClass="styleGridHeader" Width="20%" />
                                                                        <FooterStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:LinkButton ID="lnkDelete" runat="server" Text="Remove"  CommandName="Delete" OnClientClick="return confirm('Are you sure want to Remove this record?');" CssClass="btn btn-link text-danger" >
                                                                        ...
                                                                        <FooterTemplate>
                                                                           <%-- <asp:Button ID="btnAdd" runat="server" CommandName="Add" CssClass="grid_btn" AccessKey="T"
                                                                              ...
                                                                              <asp:LinkButton ID="btnAdd" runat="server" Text="Add" CommandName="Add" ValidationGroup="Grid"
                                                                                    ToolTip="Add" CausesValidation="true" OnClick="btnAdd_Click" CssClass="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add</asp:LinkButton>
                                                                        </FooterTemplate>
                ...
                <div class="fixed_btn" style="bottom: 9px;">
                    <div class="col p-0">
                        ...
                        <button class="btn btn-outline-success" id="btnClear" onserverclick="btnClear_Click" causesvalidation="false" runat="server" onclick="return fnConfirmClear()"
