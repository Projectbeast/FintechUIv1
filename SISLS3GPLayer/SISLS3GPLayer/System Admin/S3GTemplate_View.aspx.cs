...
public partial class System_Admin_S3GTemplate_View : ApplyThemeForProject
{
    ...
    string[] arrSortCol = new string[] { "LOB", "Location", "TemplateRefNo", "TemplateType" };
    ...
    private void FunPriLoadPage()
    {
        ...
        if (!IsPostBack)
        {
            ...
            TextBox txtHeaderSearch1 = (TextBox)grvTemplatePaging.HeaderRow.FindControl("txtHeaderSearch1");
    ...
    protected void FunProSortingColumn(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (strDirection == "ASC")
            {
                ((Button)grvTemplatePaging.HeaderRow.FindControl(imgbtnSearch)).CssClass = "styleImageSortingAsc";
            }
            else
            {
                ((Button)grvTemplatePaging.HeaderRow.FindControl(imgbtnSearch)).CssClass = "styleImageSortingDesc";
            }
        }
        catch (FaultException<UserMgtServicesReference.ClsPubFaultException> objFaultExp)
        {
