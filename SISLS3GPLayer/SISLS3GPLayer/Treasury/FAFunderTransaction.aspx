    ...
    <div class="row">
        <div class="col">
            <h6 class="title_name px-3 p-2">
                <asp:Label runat="server" Text="Terms Details" ID="lblHeading" CssClass="styleInfoLabel">
                </asp:Label>
            </h6>
        </div>
        <div class="col mr-3">
    ...
    <div id="tab-content" class="tab-content scrollable-content-details">
                                                                    ...
                                                                    <div class="row ml-2 mt-1">
                                                                        <div align="right">
                                                                            <div align="right" style="margin-top: 15px;">
                                                                                <button class="btn btn-success btn-sm" id="btnValidate" onserverclick="btnValidate_Click" validationgroup="btnValidate" runat="server"
                                                                                    type="button" causesvalidation="true" accesskey="P" title="Proceed,Alt+P">
                                                                                    <i class="fa fa-arrow-circle-right"></i>&emsp;<u>P</u>roceed
                                                                                </button>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <asp:Panel ID="pnlLetterNo" runat="server" GroupingText="Letter Number">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                        <div class="mt-4">
                                                                            <asp:LinkButton runat="server" ID="btnDrawdown" Text="Report" ToolTip="Report"
                                                                                CausesValidation="false" CssClass="btn btn-success btn-sm" OnClick="btnDrawdown_Click">
                                                                               <i class="fa fa-share-square" aria-hidden="true"></i> Report
                                                                            </asp:LinkButton>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <ContentTemplate>
                                        <div class="row m-0 pt-2 mt-3">
                                            ...
                                            <div align="right" class="mt-3">
                                                <button class="btn btn-success btn-sm" id="btnGo" onserverclick="btnGoR_Click" validationgroup="btngo" runat="server"
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandArgument='<%#Container.DataItemIndex%>'
                                                                                    ToolTip="Edit" CommandName="Edit" CausesValidation="false" CssClass="grid_btn_success mr-1"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</asp:LinkButton>
                                                                                ...
                                                                                <asp:LinkButton ID="lnkRemove" runat="server" Text="Delete" CommandName="Delete"
                                                                                    ...
                                                                                    CausesValidation="false" CssClass="grid_btn_delete"><i class="fa fa-trash" aria-hidden="true"></i> Delete</asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <EditItemTemplate>
                                                                                <asp:LinkButton ID="lnkUpdate" runat="server" Text="Update" CommandName="Update"
                                                                                    ToolTip="Update" ValidationGroup="vgUpdate" CausesValidation="false" CssClass="grid_btn_success p-1 mr-2"><i class="fa fa-floppy-o" aria-hidden="true"></i> Update</asp:LinkButton>

                                                                                <asp:LinkButton ID="lnkCancel" runat="server" Text="Cancel" CommandName="Cancel"
                                                                                    ToolTip="Cancel" CausesValidation="false" CssClass="grid_btn_cancel p-1"><i class="fa fa-times" aria-hidden="true"></i> Cancel</asp:LinkButton>
                                                                            </EditItemTemplate>
                                                                            <FooterTemplate>
                                                                                <%-- <button class="grid_btn" id="lnkAdd" validationgroup="vgAdd" title="Alt+A" accesskey="A" runat="server" onserverclick="btnAdd_ServerClick"><i class="fa fa-plus" ></i>Add</button>  --%>
                                                                                <asp:LinkButton ID="lnkAdd" runat="server" Text="Add" CommandName="Add" ValidationGroup="vgAdd"
                                                                                    ToolTip="Add" CausesValidation="true" CssClass="btn btn-success btn-sm mt-2"><i class="fa fa-plus" aria-hidden="true"></i> Add</asp:LinkButton>
                                                                            </FooterTemplate>
                                                    ...
                                                    <asp:GridView ID="grvMorotorium" runat="server" Width="98%" AutoGenerateColumns="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <FooterTemplate>
                                                                    <button class="btn btn-success btn-sm" id="btnAddMor" validationgroup="btnAddMor" title=",Alt+F" accesskey="F" runat="server">
                                                                        <i class="fa fa-plus mr-1"></i>Add</button>
                                    ...
                                    <ContentTemplate>
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                <div class="md-input">
                                                    ...
                                                    <asp:TextBox ID="txtRepayDate" runat="server" ToolTip="Repayment Date"
                                                        ...
                                                        CssClass="md-form-control form-control  requires_true" />
                                        ...
                                        <div class="row m-0  py-2">
                                            <div class="col text-right mr-3">
                                                <button class="btn btn-success mr-2" id="btnGoB" onserverclick="btnGoB_Click" validationgroup="btngoB" runat="server"
                                                    type="button" causesvalidation="true" accesskey="O" title="Go,Alt+O">
                                                    <i class="fa fa-arrow-circle-right"></i>&emsp;<u>G</u>o
                                                </button>

                                                <button class="btn btn-success" id="btnGoInt" onserverclick="btnGoInt_Click" validationgroup="btnGoInt" runat="server"
                                                    type="button" causesvalidation="true" accesskey="I" title="Interest Schedule,Alt+I">
                                                    <i class="fa fa-arrow-circle-right"></i>&emsp;<u>Int</u>Schedule
                                                </button>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="grid">
                                                                <asp:GridView ID="gvBorrowerRepay" runat="server" AutoGenerateColumns="false" ShowFooter="true"
                                                                    ...
                                                                    CssClass="gird_details gird-details-no-row-bg">
                                                                    <Columns>
                                                                        <%--Serial Number--%>
                                                                        <asp:TemplateField HeaderText="Sl.No" HeaderStyle-CssClass="font-weight-bold">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblSno" runat="server" Text='<%#Container.DataItemIndex+1%>' ToolTip="Serial Number" />
                                                                                <asp:HiddenField ID="hdnSlno" runat="server" Value='<%#Eval("Serial_Number") %>' />
                                                        ...
                                                        <asp:Label ID="lblJVNo" runat="server" Text='<%#Eval("JV_No") %>' ToolTip="JV Reference Number" />
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Principal Schedule">
                                                                            <HeaderTemplate>
                                                                                <table id="table2" runat="server" width="100%" class="no-th-td-border">
                                                                                    <tr align="center" class="border-b">
                                                                                        <td colspan="2" align="center" class="font-weight-bold">Principal Schedule
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td width="50%" style="text-align: left" class="font-weight-bold">Due Date
                                                                                        </td>
                                                                                        <td width="50%" style="text-align: right" class="font-weight-bold">Due Amount
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <table id="table3" runat="server" width="100%" class="no-th-td-border">
                                                                                    <tr>
                                                                            ...
                                                                            <EditItemTemplate>
                                                                                <table id="table4" runat="server" width="100%" class="no-th-td-border">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <asp:TextBox ID="txtRepayDate" Width="120px" Text='<%#Eval("Repay_Date") %>' runat="server"
                                                                                                onmouseover="txt_MouseoverTooltip(this)" ToolTip="Due Date" CssClass="form-control" />
                                                                                            <cc1:CalendarExtender runat="server" Format="dd/MM/yyyy" TargetControlID="txtRepayDate"
                                                                                                PopupButtonID="txtRepayDate" ID="CalRepayDate" Enabled="True" CssClass="form-control">
                                                                                            </cc1:CalendarExtender>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:TextBox ID="txtRepayAmount" Width="120px" onkeypress="fnAllowNumbersOnly(false,false,this)"
                                                                                                onmouseover="txt_MouseoverTooltip(this)" Style="text-align: right;" MaxLength="12"
                                                                                                Text='<%#Eval("Repay_Amount") %>' runat="server" ToolTip="Repay Amount" CssClass="form-control float-right" />
                                                                            ...
                                                                            <FooterTemplate>
                                                                                <table id="table5" runat="server" width="100%" class="no-th-td-border">
                                                                                    <tr valign="top">
                                                                                        <td width="50%">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <asp:TextBox ID="txtRepayDate" Width="120px" onmouseover="txt_MouseoverTooltip(this)"
                                                                                                runat="server" ToolTip="Repay Date" CssClass="form-control" />
                                                                                            <cc1:CalendarExtender runat="server" Format="dd/MM/yyyy" TargetControlID="txtRepayDate"
                                                                                                PopupButtonID="txtRepayDate" ID="CalRepayDate" Enabled="True" CssClass="form-control">
                                                                                            </cc1:CalendarExtender>
                                                                                            <asp:RequiredFieldValidator ID="rfvRePayDate" runat="server" ControlToValidate="txtRepayDate"
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:TextBox ID="txtRepayAmount" Width="120px" onkeypress="fnAllowNumbersOnly(false,false,this)"
                                                                                                onmouseover="txt_MouseoverTooltip(this)" Style="text-align: right;" MaxLength="12"
                                                                                                runat="server" ToolTip="Repay Amount" CssClass="form-control float-right" />
                                                                                            <cc1:FilteredTextBoxExtender ID="ftxtRepayAmt" TargetControlID="txtRepayAmount" FilterType="Numbers"
                                                                                                runat="server" Enabled="True" />
                                                                                            <asp:RequiredFieldValidator ID="rfvRepayAmount" runat="server" ControlToValidate="txtRepayAmount"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Interest Amount">
                                                                            <HeaderTemplate>
                                                                                <table id="table6" runat="server" width="100%" class="no-th-td-border">
                                                                                    <tr align="center" class="border-b">
                                                                                        <td colspan="2" align="center" class="font-weight-bold">Interest Schedule
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td width="50%" style="text-align: left" class="font-weight-bold">Due Date
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <table id="table7" runat="server" width="100%" class="no-th-td-border">
                                                                                    <tr>
                                                                                        <td style="text-align: left" width="50%">
                                                                            ...
                                                                            <FooterTemplate>
                                                                                <table id="table12" runat="server" width="100%" class="no-th-td-border" style="margin-top: -22px;">
                                                                                    <tr valign="top">
                                                                                        <td width="50%">
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Hedge">
                                                                            <HeaderTemplate>
                                                                                <table id="table8" runat="server" width="100%" class="no-th-td-border">
                                                                                    <tr align="center"  class="border-b">
                                                                                        <td colspan="2" align="center" class="font-weight-bold">Hedge
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td width="50%" style="text-align: left" class="font-weight-bold">Ref No
                                                                                        </td>
                                                                                        <td width="50%" style="text-align: right" class="font-weight-bold">Amount
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <table id="table9" runat="server" width="100%" class="no-th-td-border">
                                                                                    <tr>
                                                                            ...
                                                                            <EditItemTemplate>
                                                                                <table id="table10" runat="server" width="100%">
                                                                                    <tr>
                                                                                        <td width="50%">
                                                                                            <asp:DropDownList ID="ddlHedgeNo" runat="server" Width="150px">
                                                                                                <asp:ListItem Value="0" Text="--Select--" />
                                                                                            </asp:DropDownList>
                                                                                            <asp:Label ID="lblHedgeNo" runat="server" Text='<%#Eval("Hedge_No") %>' ToolTip="Hedge No"
                                                                                                Visible="false" />
                                                                                        ...
                                                                                        <td width="50%">
                                                                                            <asp:TextBox ID="txtHedgeAmount" Width="120px" onkeypress="fnAllowNumbersOnly(false,false,this)"
                                                                                                onmouseover="txt_MouseoverTooltip(this)" Style="text-align: right;" MaxLength="12"
                                                                                                Text='<%#Eval("Hedge_Amount") %>' runat="server" ToolTip="Hedge Amount" CssClass="form-control float-right" />
                                                                    ...
                                                                    <asp:HiddenField ID="hdnHedgeAmount" runat="server" Value='<%#Eval("Hedge_Amount") %>' />--%>
                                                                            ...
                                                                            <FooterTemplate>
                                                                                ...
                                                                                <center>
                                                                                    <div class="md-input" style="margin: 0px; margin-top: 33px;">
                                                                                ...
                                                                                <td>
                                                                                    <div class="md-input" style="margin: 0px; margin-top: 30px;">
                                                                                        <asp:LinkButton ID="lnkAdd" runat="server" Text="Add" CommandName="Add" ValidationGroup="vgBRAdd"
                                                                                            ToolTip="Add" CssClass="btn btn-success btn-sm" CausesValidation="true"><i class="fa fa-plus" aria-hidden="true"></i> Add</asp:LinkButton>
                                                                                    </div>
                                                                                </td>
                                                                                </tr>
                                                                                </table>
                                                                        ...
                                                                        <%--JV Reference Number--%>
                                                                        <asp:TemplateField HeaderText="JV Reference Number" HeaderStyle-CssClass="font-weight-bold">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblJVNo" runat="server" Text='<%#Eval("JV_No") %>' ToolTip="JV Reference Number" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle Width="15%" HorizontalAlign="Left" />
                                                        ...
                                                        <asp:Label ID="lblJVNo" runat="server" Text='<%#Eval("JV_No") %>' ToolTip="JV Reference Number" />
                                                                        ...
                                                                        <%--Add Edit Update Cancel Delete--%>
                                                                        <asp:TemplateField ItemStyle-CssClass=" border-0">
                                                                            <ItemTemplate>
                                                                                <div class="d-flex mt-1">
                                                                                    <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandArgument='<%#Container.DataItemIndex%>'
                                                                                        ToolTip="Edit" CommandName="Edit" CausesValidation="false" CssClass="grid_btn_success mr-2 d-flex"><i class="fa fa-pencil mr-2" aria-hidden="true"></i> Edit</asp:LinkButton>

                                                                                    <asp:LinkButton ID="lnkRemove" runat="server" Text="Delete" CommandName="Delete"
                                                                                        ToolTip="Delete" OnClientClick="return confirm('Are you sure want to delete?');"
                                                                                        CausesValidation="false" CssClass="grid_btn_delete d-flex"><i class="fa fa-trash mr-2" aria-hidden="true"></i> Delete</asp:LinkButton>
                                                                                </div>
                                                                            </ItemTemplate>
                                                                            <EditItemTemplate>
                                                                                <div class="d-flex mt-1">
                                                                                    <asp:LinkButton ID="lnkUpdate" runat="server" Text="Update" CommandName="Update" CssClass="grid_btn_success mr-2 d-flex"
                                                                                        ToolTip="Update" ValidationGroup="vgBRUpdate" CausesValidation="true"><i class="fa fa-floppy-o mr-2" aria-hidden="true"></i> Update</asp:LinkButton>

                                                                                    <asp:LinkButton ID="lnkCancel" runat="server" Text="Cancel" CommandName="Cancel"
                                                                                        ToolTip="Cancel" CausesValidation="false" CssClass="grid_btn_cancel d-flex"><i class="fa fa-times mr-2" aria-hidden="true"></i> Cancel</asp:LinkButton>
                                                                                </div>
                                                                            </EditItemTemplate>
        ...
        <div class="fixed_btn" style="bottom: 9px;">
            <div class="col p-0">
                ...
                <button class="btn btn-outline-success" id="btnClear" onserverclick="btnClear_Click" causesvalidation="false" runat="server" onclick="if(return fnConfirmClear())"
                    type="button" accesskey="R" title="Clear_FA,Alt+R">
