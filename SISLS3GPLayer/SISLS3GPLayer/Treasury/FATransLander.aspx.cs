...
public partial class Financial_Accounting_FATransLander : ApplyThemeForProject_FA
{
    ...
    protected void ddlMultipleDNC_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlMultipleDNC.SelectedIndex > 0)
        {
            ...
            cmbDocumentNumberSearchDiv.Visible = lblProgramIDSearch.Visible = true;
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)                // If data Row then check the data type and set the style - Alignment.
        {
            ...
            if (ProgramCodeToCompare == "FUNT")
            {
                if (e.Row.Cells[11].Text.Trim().ToUpper() != "PENDING")
                {
                    imgbtnEdit.Enabled = false;
                    imgbtnEdit.CssClass = "styleGridEditDisabled";
                    e.Row.Cells[11].CssClass = "text-center";
                    e.Row.Cells[11].Text = "<span class='badge badge-success'><i class='fa fa-check mr-2'></i>" + e.Row.Cells[11].Text.Trim() + "</span>";
                }
                else
                {
                    e.Row.Cells[11].CssClass = "text-center";
                    e.Row.Cells[11].Text = "<span class='badge badge-warning'><i class='fa fa-exclamation-circle mr-2'></i>" + e.Row.Cells[11].Text.Trim() + "</span>";
    ...
    private void FunPriPageLoad()
    {
        ...
        if ((!IsPostBack) || (IsQueryStringChanged))                                // refresh the page even if the query string of the URL varys - it mean the user navigates to some other page.
        {
            ...
            detailHeaderDiv.Visible = ucCustomPaging.Visible = false;
    ...
    protected void FunProMJV(string ProgCode)
    {
        if (ProgCode == "MAJ" || ProgCode == "SJV")
        {
            ...
            cmbJournalNoDiv.Visible = cmbJournalNo.Visible = true;
        }
        else
        {
            ...
            cmbJournalNoDiv.Visible = cmbJournalNo.Visible = false;
        }
    ...
    protected void InitPage()
    {
        ...
        switch (ProgramCode)
        {
            ...
            case strFunderTransaction:
                ...
                lblHeading.Text = " Funder Transaction - Search";
    ...
    private void FunPriLoadMultiDNCCombo()
    {
        ...
        ddlDNCOptionDiv.Visible = ddlDNCOption.Visible = intDNCOption == 1 ? true : false;
    }
