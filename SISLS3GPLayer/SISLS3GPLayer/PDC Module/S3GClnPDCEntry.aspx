    ...
    <div id="tab-content" class="tab-content">
        <div class="tab-pane fade in active show" id="tab1">
                                                    ...
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:Panel ID="pnlGeneral" runat="server" CssClass="stylePanel" GroupingText="General">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                    <div class="md-input">
                                                                        <button class="btn btn-success" id="btnGo" title="Go,[Alt+G]" onclick="if(fnCheckPageValidators('VGPDC','false'))" causesvalidation="false" onserverclick="btnGo_Click"
            ...
            <div align="right" class="fixed_btn">
                <button class="btn btn-success" id="btnSave" title="Save[Alt+S]" onclick="if(fnCheckPageValidators('VGPDC'))" causesvalidation="false" onserverclick="btnSave_Click"
                    runat="server" type="button" accesskey="S">
                    <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>S</u>ave
                </button>
                <button class="btn btn-success" id="btnClear" title="Clear[Alt+L]" onclick="if(fnConfirmClear())" causesvalidation="false" onserverclick="btnClear_Click"
                    runat="server" type="button" accesskey="L">
                    <i class="fa fa-eraser" aria-hidden="true"></i>&emsp;C<u>l</u>ear
                </button>
                <button class="btn btn-success" id="btnCancel" title="Exit[Alt+X]" onclick="if(fnConfirmExit())" causesvalidation="false" onserverclick="btnCancel_Click"
            ...
            <asp:Panel ID="pnlAccountStructure" Style="display: none; vertical-align: middle; padding-top: 50px;" runat="server"
                ...
                <asp:UpdatePanel ID="updtpnlAccountStructure" runat="server">
                    <ContentTemplate>
                        ...
                        <div align="center">
                            <button class="btn btn-success" id="btnhldExit" title="Exit" causesvalidation="false" onserverclick="btnhldExit_ServerClick"
        ...
        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
            ...
            <asp:Panel ID="pnlConfirmation" runat="server" CssClass="styleTabPanel"
                ...
                <div id="div1" runat="server" class="gird" style="height: 200px; display: block;">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 25px;">
                        <div align="center">
                            <button class="btn btn-success" id="btnModalCNF" title="Ok" causesvalidation="false" onserverclick="btnModalCNF_Click"
                                runat="server" type="button">
                                <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;Ok
                            </button>
                            <button class="btn btn-success" id="btnCanelModalCNF" title="Ok" causesvalidation="false"
