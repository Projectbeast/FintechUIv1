                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <asp:Panel GroupingText="Upload Details" ID="pnlUploadDetails" runat="server" CssClass="stylePanel">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="md-input">
                                            <button class="btn btn-success" id="btnUpload" title="Upload,[Alt+U]" causesvalidation="false" runat="server" type="button" onserverclick="btnUpload_ServerClick"
                                                accesskey="U">
                                                <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>&emsp;<u>U</u>pload
                                            </button>
                                            <button class="btn btn-success" id="btnDownloadFormat" title="Download Format[Alt+W]" onclick="if(fnCheckPageValidators('vgSave',false))" causesvalidation="false"
                                            ...
                                            <button class="btn btn-success" id="btnException" title="View Exception,[Alt+G]" causesvalidation="false" runat="server" type="button">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 styleFieldLabel">
                            <div align="right" class="fixed_btn">
                                <button class="btn btn-success" id="btnSave" title="Save[Alt+S]" onclick="if(fnCheckPageValidators('btnSave'))" causesvalidation="false" onserverclick="btnSave_ServerClick"
                                    runat="server" type="button" accesskey="S">
                                    <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>S</u>ave
                                </button>
                                <button class="btn btn-success" id="btnDelete" title="Delete[Alt+W]" onclick="if(funPriCheckDeleteValidation())" causesvalidation="false" onserverclick="btnDelete_ServerClick"
                                    runat="server" type="button" accesskey="W">
                                    <i class="fa fa-times" aria-hidden="true"></i></i>&emsp;Delete
                                </button>
                                <button class="btn btn-success" id="btnClear" title="Clear[Alt+L]" onclick="if(fnConfirmClear())" causesvalidation="false" onserverclick="btnClear_ServerClick"
                                    runat="server" type="button" accesskey="L">
                                    <i class="fa fa-eraser" aria-hidden="true"></i>&emsp;C<u>l</u>ear
                                </button>
                                <button class="btn btn-success" id="btnCancel" title="Exit[Alt+X]" onclick="if(fnConfirmExit())" causesvalidation="false"
