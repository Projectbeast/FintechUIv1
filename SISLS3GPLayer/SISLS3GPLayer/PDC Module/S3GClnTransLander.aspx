                ...
                <div class="tab-pane fade in active show" id="tab1">
                    ...
                    <div align="right" class="fixed_btn">
                        <button id="btnSearch" runat="server" validationgroup="RFVDTransLander" title="Search[Alt+S]" accesskey="S"
                            class="btn btn-success" onserverclick="btnSearch_Click" type="button">
                            <i class="fa fa-search" aria-hidden="true"></i>&emsp;<u>S</u>earch
                        </button>
                        <button id="btnCreate" runat="server" type="button" class="btn btn-success" title="Create[Alt+C]" accesskey="C"
                            onserverclick="btnCreate_Click">
                            <i class="fa fa-plus-square" aria-hidden="true"></i>&emsp;<u>C</u>reate
                        </button>
                        <button id="btnClear" runat="server" type="button" class="btn btn-success" title="Clear[Alt+L]" accesskey="L"
