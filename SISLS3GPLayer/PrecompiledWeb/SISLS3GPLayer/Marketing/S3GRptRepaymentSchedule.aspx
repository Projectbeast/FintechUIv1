<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Reports_S3GRptRepaymentSchedule, App_Web_ru52obyl" title="Repayment Schedule" %>
                                        ...
                                        <asp:GridView ID="grvRepayDetails" runat="server" Width="80%" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Income" ItemStyle-HorizontalAlign="Right">
                                                 ...
                                                 <asp:TemplateField HeaderText="LIP" ItemStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblLIP" runat="server" Text='<%# Bind("InsuranceAmount") %>' ToolTip="LIP"></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblTotLIP" runat="server" ToolTip="Total LIP"></asp:Label>
                                                    </FooterTemplate>
                                                    <FooterStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="LIP. o/s" ItemStyle-HorizontalAlign="Right" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblLIPOS" runat="server" Text='<%# Bind("LIP_OS") %>' ToolTip="LIP. o/s"></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblLIP_OSF" runat="server"></asp:Label>
                                                    </FooterTemplate>
                                                    <FooterStyle HorizontalAlign="Right" />
                                                </asp:TemplateField>
