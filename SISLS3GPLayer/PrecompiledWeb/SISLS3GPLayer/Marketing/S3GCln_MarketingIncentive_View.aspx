<%@ page title="" language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Collection_S3GCln_MarketingIncentive_View, App_Web_ct41cc2n" %>
                ...
                <div class="tab-pane fade in active show" id="tab1">
                                ...
                                <asp:GridView ID="grvPaging" runat="server" AutoGenerateColumns="False" Width="100%" OnRowDataBound="grvPaging_RowDataBound" OnRowCommand="grvPaging_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Line of Business">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblLOB" runat="server" Text='<%# Bind("Line_of_Business") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                            ...
                                            <HeaderTemplate>
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <thead>
                                                        <tr align="center">
                                                            <th style="padding: 0px !important; background: none !important;">
                                                                <asp:LinkButton ID="lnkbtnSort3" runat="server" Text="Group Name" ToolTip="Sort by Group Name"
                                                                    OnClick="FunProSortingColumn"> </asp:LinkButton>
                                                        ...
                                                        <tr align="left">
                                                            <th style="padding: 0px !important; background: none !important;">
                                                                 <div class="md-input" style="margin: 0px;">
                                                                    <asp:TextBox AutoCompleteType="None" ID="txtHeaderSearch3" runat="server"
                                                                        AutoPostBack="true" class="md-form-control form-control login_form_content_input" OnTextChanged="FunProHeaderSearch"></asp:TextBox>
                                                                    <span class="highlight"></span>
                                                                    <span class="bar"></span>
                                                                </div>   
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                             ...
                                             <HeaderTemplate>
                                                <asp:Label ID="lblgvStartDate" runat="server" Text="Start Date" ></asp:Label>
                                            </HeaderTemplate>
                                        </asp:TemplateField>
                                         ...
                                         <asp:TemplateField>
                                            <ItemTemplate>
                                             ...
                                             <HeaderTemplate>
                                                <asp:Label ID="lblgvEndDate" runat="server" Text="End Date" ></asp:Label>
                                            </HeaderTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Active">
                                            ...
                                            <HeaderTemplate>
                                                <asp:Label ID="lblgvActive" runat="server" Text="Active" ></asp:Label>
                                            </HeaderTemplate>
                    ...
                    <div align="right" class="fixed_btn">
                        <button class="css_btn_enabled" id="btnCreate" onserverclick="btnCreate_Click" runat="server"
                            type="button" accesskey="C" tooltip="Create the Details, Alt+C" title="Create[Alt+C]">
