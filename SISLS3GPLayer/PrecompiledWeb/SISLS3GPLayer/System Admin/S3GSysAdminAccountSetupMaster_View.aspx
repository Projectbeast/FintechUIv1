<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="System_Admin_S3G_SysAdminAccountSetupMaster_View, App_Web_vm4o5lue" %>
                                ...
                                <asp:TemplateField HeaderText="Branch" SortExpression="Branch">
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <td>
                                                <asp:LinkButton ID="lnkbtnSortBranch" runat="server" Text="Branch" CssClass="styleGridHeaderLinkBtn"
                                                    ToolTip="Sort By Branch" OnClick="FunProSortingColumn"></asp:LinkButton>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblEBranch" runat="server" Text='<%# Bind("BRANCH") %>'></asp:Label></ItemTemplate>
                                    <HeaderStyle CssClass="styleGridHeaderLinkBtn" Font-Underline="false" HorizontalAlign="Center" />
                                </asp:TemplateField>
