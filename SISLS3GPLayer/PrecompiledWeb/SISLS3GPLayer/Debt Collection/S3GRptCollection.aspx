<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Common/S3GMasterPageCollapse.master" title="Collection Report" inherits="Reports_S3GRptCollection, App_Web_zgoknvek" %>
                            ...
                            <asp:Panel ID="pnlInput" runat="server" GroupingText="Input Criteria" CssClass="stylePanel" Width="100%">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                     ...
                                     <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                        <div class="md-input">
                                            <asp:CheckBox ID="chkOverdue" runat="server" ToolTip="Over Due collection" AutoPostBack="true" OnCheckedChanged="chkOverdue_CheckedChanged" />
                                            <span class="highlight"></span>
                                            <span class="bar"></span>
                                            <asp:Label runat="server" Text="Over Due collection" ToolTip="Over Due collection" ID="lblOverdueColl">
                                            </asp:Label>
