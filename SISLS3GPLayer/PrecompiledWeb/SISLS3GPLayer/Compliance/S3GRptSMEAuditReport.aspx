<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Reports_S3GRptSMEAuditReport, App_Web_aojrc4jn" title="SME Audit Report" %>
    ...
    <div id="tab-content" class="tab-content">
        <div class="tab-pane fade in active show" id="tab1">
            <div class="row">
                <div class="col">
                    <h6 class="title_name">
                        <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="SME Audit Report">
                        </asp:Label>
                    </h6>
                </div>
            </div>
            ...
            <div align="right">
                ...
                <button class="css_btn_enabled" id="btnPrint" onserverclick="btnPrint_Click" runat="server"
                    type="button" causesvalidation="true" title="Print, Alt+A" accesskey="A" >
                    <i class="fa fa-print" aria-hidden="true"></i>&emsp;<u>A</u>udit Report
                </button>
                <button class="css_btn_enabled" id="btnPrint1" onserverclick="btnPrint1_Click" runat="server"
                    type="button" causesvalidation="true" title="Print, Alt+S  " accesskey="S" >
                    <i class="fa fa-print" aria-hidden="true"></i>&emsp;<u>S</u>ME Application
                </button>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <asp:Panel ID="pnlJournalDetails" runat="server" CssClass="stylePanel" GroupingText="SME Audit Report" Width="100%">
                        ...
                        <div id="divJournalDetails" runat="server" style="height: 350px; width: 100%; overflow-x: scroll; overflow-y: scroll;">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="gird  gird_details" runat="server" id="GrdDiv1">
