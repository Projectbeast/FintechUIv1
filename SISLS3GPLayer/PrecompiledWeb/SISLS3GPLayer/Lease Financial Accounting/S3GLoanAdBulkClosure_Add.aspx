<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="LoanAdmin_S3GLoanAdBulkClosure_Add, App_Web_vhgjxht5" %>
                                        ...
                                        <div class="gird">
                                            <asp:GridView ID="gvAccClosure" runat="server" CssClass="styleInfoLabel" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                        ...
                                                        <HeaderTemplate>
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:CheckBox ID="chkAll" OnCheckedChanged="chkSelected_CheckedChanged" AutoPostBack="true" runat="server" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:CheckBox runat="server" ID="chkSelected" OnCheckedChanged="chkSelected_CheckedChanged" AutoPostBack="true" ToolTip="select" />
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="ODI Waiver" HeaderStyle-CssClass="styleGridHeader">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtODIWaiver" Enabled="false" Width="100px"
                                                                Style="text-align: right" CssClass="md-form-control form-control login_form_content_input requires_true" 
                                                                Text='<%# Eval("ODI_Waiver")%>' runat="server"  AutoPostBack="true"  OnTextChanged="txtODIWaived_TextChanged"></asp:TextBox>
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                                        <ItemStyle Width="10%" HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="CRC Waiver" HeaderStyle-CssClass="styleGridHeader">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtCRCWaiver" Enabled="false" Width="100px" Style="text-align: right" 
                                                                CssClass="md-form-control form-control login_form_content_input requires_true" 
                                                                Text='<%# Eval("CRC_Waiver")%>'  AutoPostBack="true" OnTextChanged="txtMemoWaived_TextChanged" runat="server"></asp:TextBox>
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                                        <ItemStyle Width="10%" HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="CCB Refund" HeaderStyle-CssClass="styleGridHeader">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtCCBRefund" Width="100px" Style="text-align: right" Enabled="false" 
                                                                CssClass="md-form-control form-control login_form_content_input requires_true" 
                                                                Text='<%# Eval("CCB_Refund")%>'  AutoPostBack="true" OnTextChanged="txtCCBRefund_TextChanged" runat="server"></asp:TextBox>
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                                        <ItemStyle Width="10%" HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Closure Amount" HeaderStyle-CssClass="styleGridHeader">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblclosureamount" runat="server" />
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
