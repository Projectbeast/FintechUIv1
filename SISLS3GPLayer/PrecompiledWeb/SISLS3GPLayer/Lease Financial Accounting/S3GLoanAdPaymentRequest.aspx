<%@ page language="C#" autoeventwireup="true" title="Payment Request" masterpagefile="~/Common/S3GMasterPageCollapse.master" inherits="Loan_Admin_S3GLoanAdminPaymentRequest, App_Web_sp1i5jlb" enableeventvalidation="false" %>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="SL Account" Visible="false">
                                                                            ...
                                                                            <FooterTemplate>
                                                                                <div class="md-input" style="margin: 0px;">
                                                                                    ...
                                                                                    <asp:Label ID="lblFooterSL_Code" ToolTip="SL Account" runat="server" Visible="false" ></asp:Label>
                                                                                    <span class="highlight"></span>
                                                                                    <span class="bar"></span>
                                                                                </div>
                                                                            </FooterTemplate>
                                                        ...
                                                        <div class="gird">
                                                            <asp:GridView runat="server" ToolTip="Payment Adjustment grid" ShowFooter="true"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="GL Account" Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblAdjGLCode" ToolTip="GL Account" Width="100%" runat="server" Text='<%#Eval("GL_Code")%>' Visible="false"></asp:Label>
