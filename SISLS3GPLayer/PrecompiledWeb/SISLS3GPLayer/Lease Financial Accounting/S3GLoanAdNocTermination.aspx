<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="LoanAdmin_S3GLoanAdNocTermination, App_Web_prcfklo5" title="NOC" %>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-9 col-xs-12">
                                    <div class="md-input">
                                        <uc2:Suggest ID="ddlGUARANTOR" ValidationGroup="VGNoc" runat="server" ToolTip="Name" class="md-form-control form-control login_form_content_input requires_true"
                                            ServiceMethod="GetCustomerList" OnItem_Selected="ddlGUARANTOR_Item_Selected" AutoPostBack="true"
