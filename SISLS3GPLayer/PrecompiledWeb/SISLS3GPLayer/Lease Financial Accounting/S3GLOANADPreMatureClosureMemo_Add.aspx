<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="LoanAdmin_S3GLOANADPreMatureClosureMemo_Add, App_Web_ycyxh5gd" title="Untitled Page" enableeventvalidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div id="tab-content" class="tab-content">
                <div class="tab-pane fade in active show" id="tab1">
                                ...
                                <cc1:TabPanel runat="server" HeaderText="General" ID="tbgeneral" CssClass="tabpan"
                                    ...
                                    <ContentTemplate>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                <div class="md-input">
                                                    <asp:TextBox ID="txtPMCReqDate" runat="server" onchange="" autocomplete="off" ReadOnly="false"
                                                        Enabled="true"  AutoPostBack="true" OnTextChanged="txtPMCReqDate_Changed" 
                                            ...
                                            <%-- <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                        <div class="md-input">
                                                            <asp:TextBox ID="txtClosureDate" runat="server" AutoPostBack="True" 
                                                                class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                                                            <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/calendaer.gif" Visible="false" />
                                                            <cc1:CalendarExtender runat="server" Format="dd/MM/yyyy" TargetControlID="txtClosureDate"
                                                                PopupButtonID="Image2" ID="CalendarExtender1" Enabled="True">
                                                            </cc1:CalendarExtender>
                                                            <div class="validation_msg_box">
                                                                <asp:RequiredFieldValidator ID="rfvClosureDate" runat="server" Display="Dynamic"
                                                                    ControlToValidate="txtClosureDate" ValidationGroup="Pre Mature Closure" ErrorMessage="Enter the Closure Date"
                                                                    CssClass="validation_msg_box_sapn"></asp:RequiredFieldValidator>
                                                            </div>
                                                            <span class="highlight"></span>
                                                            <span class="bar"></span>
                                                            <label>
                                                                <asp:Label runat="server" Text="Closure Date" ID="lblClosureDate"
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                <div class="md-input">
                                                    <asp:TextBox ID="txtValidityDate" runat="server" ReadOnly="false"
                                                        autocomplete="off" Enabled="true" OnTextChanged="txtValidityDate_TextChanged" AutoPostBack="true"
                                                        class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                                                    <%--<asp:Image ID="Image2" runat="server" ImageUrl="~/Images/calendaer.gif" Visible="false" />--%>
                                                    <cc1:CalendarExtender runat="server" TargetControlID="txtValidityDate"
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                                <div class="md-input">
                                                    ...
                                                    <uc4:ICM ID="ucAccountLov" onblur="fnLoadAccount()" runat="server" AutoPostBack="true" ShowHideAddressImageButton="false" DispalyContent="Both" OnItem_Selected="ucAccountLov_Item_Selected"
                                                        strLOV_Code="ACC_PMC_MEMO" ServiceMethod="GetAccuntNoList" class="md-form-control form-control" />
                                ...
                                <cc1:TabPanel runat="server" HeaderText="General" ID="tbAccDetails" CssClass="tabpan"
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="row" id="dvAssetdtls" runat="server">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <asp:Panel runat="server" ID="pnlAssetDtls" CssClass="stylePanel" GroupingText="Asset Details">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="gird">
                                                                ...
                                                                <asp:GridView ID="grvCashFlow" runat="server" AutoGenerateColumns="False" OnRowDataBound="grvCashFlow_RowDataBound"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Tax Rate">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblVATRate" MaxLength="20" Text='<%#Eval("Taxpercentage")%>' runat="server"
                                                                                    Style="text-align: right;"></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Right" Width="10%" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="VAT Amount">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblVATAmount" MaxLength="20" Text='<%#Eval("Taxamount")%>' runat="server"
                                                                                    Style="text-align: right;"></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Right" Width="10%" />
                                                                        </asp:TemplateField>

                                                                        <asp:TemplateField HeaderText="Account Closure Amount (Inc. VAT)">
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Remarks">
                                                                         ...
                                                                         <asp:TemplateField Visible="false" HeaderText="Tax Applicable">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblTaxApplicable" Text='<%#Eval("Tax_Applicable")%>' runat="server"
                                                                                    Style="text-align: right;"></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Right" Width="10%" />
                                                                        </asp:TemplateField>
                    ...
                    <div align="right" class="fixed_btn">
                        ...
                        <button class="css_btn_enabled" id="btnSave" onclick="if(fnCheckPageValidators('Pre Mature Closure'))"
    ...
    <div runat="server" id="dvCommonPopup" style="display: none; width: 80%; height: 40%; position: absolute; margin-top: -110px;">
        <div id="Div1" style="float: right; width: 50px; height: 50px; cursor: pointer; background-image: none; position: absolute; margin-top: -15px; margin-left: -25px;">
        ...
        <div>
            <asp:Panel ID="pnlAccountDetails" CssClass="stylePanel" runat="server"
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <div>
                            <asp:Panel ID="pnlDetails" GroupingText="Repayment Details" CssClass="stylePanel" runat="server" Visible="false">
                            ...
                            <asp:Panel ID="pnlLIPPenality" GroupingText="LIP Penalty" CssClass="stylePanel" runat="server" Visible="false">
                                <div id="div2" runat="server" style="height: 350px;">
                            ...
                            <asp:Panel ID="pnlFutureInsurance" GroupingText="LIP Penalty" CssClass="stylePanel" runat="server" Visible="false">
                                <div id="div5" runat="server" style="height: 350px;">
