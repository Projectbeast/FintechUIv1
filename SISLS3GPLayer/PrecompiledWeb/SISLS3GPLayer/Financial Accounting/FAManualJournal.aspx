<%@ page language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="Financial_Accounting_FAManualJournal, App_Web_4hds5vgj" title="Untitled Page" %>
            ...
            <div id="tab-content" class="tab-content">
                <div class="tab-pane fade in active show" id="tab1">
                    <div class="row">
                        <div class="col">
                            <h6 class="title_name">
                                <asp:Label runat="server" Text="Manual Journal" ID="lblHeading" CssClass="styleDisplayLabel">
                                </asp:Label>
                        </div>
                    </div>
                                        ...
                                        <ContentTemplate>
                                            <div>
                                                        ...
                                                        <div class="row">
                                                            <asp:Panel ID="pnlHeader" runat="server" CssClass="stylePanel" GroupingText="Header details">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                        <div class="md-input">
                                                                            <asp:TextBox ID="txtMJVDate" ToolTip="MJV Date" runat="server" AutoPostBack="True" class="md-form-control form-control login_form_content_input requires_true"
                                                                                onmouseover="txt_MouseoverTooltip(this)" OnTextChanged="txtMJVDate_TextChanged"></asp:TextBox>
                                                                    ...
                                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                        <div class="md-input">
                                                                            <asp:TextBox ID="txtMJVValueDate" AutoPostBack="True" OnTextChanged="txtMJVValueDate_TextChanged"
                                                                            ...
                                                                            <span class="bar"></span>
                                                                            <label>
                                                                                <asp:Label ID="lblMJVValueDate" runat="server" CssClass="styleReqFieldLabel" Text="MJV Value Date"></asp:Label>
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Branch" HeaderStyle-CssClass="styleGridHeader">
                                                                                    ...
                                                                                    <EditItemTemplate>
                                                                                        ...
                                                                                        <div class="md-input" style="margin: 0px;">
                                                                                            <asp:DropDownList ID="ddlLocationE" runat="server" Width="90px" CssClass="md-form-control form-control login_form_content_input" DropDownStyle="DropDownList" OnSelectedIndexChanged="ddlLocationE_SelectedIndexChanged"
                                                                                                AutoPostBack="True"
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Account">
                                                                                    ...
                                                                                    <FooterTemplate>
                                                                                        <div class="md-input" style="margin: 0px;">
                                                                                            <UC:Suggest ID="ddlGLCode" runat="server" IsMandatory="true" AutoPostBack="true"
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Sub Account">
                                                                                    ...
                                                                                    <FooterTemplate>
                                                                                        <div class="md-input" style="margin: 0px;">
                                                                                            <UC:Suggest ID="ddlSLCode" runat="server" IsMandatory="false" ServiceMethod="GetSLCodeList"
                                                                                    ...
                                                                                    <EditItemTemplate>
                                                                                        <div class="md-input" style="margin: 0px;">
                                                                                            <UC:Suggest ID="ddlSLCode" runat="server" IsMandatory="false" ServiceMethod="GetEditSLCodeList" AutoPostBack="true"
                                                                                    ...
                                                                                    <FooterTemplate>
                                                                                        <div class="md-input" style="margin: 0px;">
                                                                                            <asp:TextBox MaxLength="15" runat="server" ID="txtDebit" onkeypress="fnAllowNumbersOnly(true,false,this)"
                                                                                                onmouseover="txt_MouseoverTooltip(this)" Style="text-align: right;" Width="105px" ToolTip="Debit" class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                                                                                    ...
                                                                                    <FooterTemplate>
                                                                                        <div class="md-input" style="margin: 0px;">
                                                                                            <asp:TextBox MaxLength="15" runat="server" ID="txtCredit" ToolTip="Credit" class="md-form-control form-control login_form_content_input requires_true"
                                                                                                onmouseover="txt_MouseoverTooltip(this)" onkeypress="fnAllowNumbersOnly(true,false,this)" Width="105px"
                                                                                ...
                                                                                <asp:TemplateField HeaderText="DIM2" Visible="False">
                                                                                    ...
                                                                                    <FooterTemplate>
                                                                                        ...
                                                                                        <asp:DropDownList ID="TddlDim2" Width="120px" runat="server" AutoPostBack="true"
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Remarks">
                                                                                    <ItemTemplate>
                                                                                        ...
                                                                                        <asp:TextBox runat="server" TextMode="MultiLine" Text='<%#Eval("Remarks")%>'
                                                                                            ReadOnly="true" ToolTip="Remarks" ID="txtRemarks" Width="250px" Height="60px"></asp:TextBox>

                                                                                    </ItemTemplate>
                                                                                    <FooterTemplate>
                                                                                        <div class="md-input" style="margin: 0px;">
                                                                                            <asp:TextBox runat="server" ValidationGroup="Footer" MaxLength="100"
                                                                                                ToolTip="Remarks" onkeyup="maxlengthfortxt(100);" ID="txtRemarks" TextMode="MultiLine" Width="250px" Height="60px" Wrap="true"></asp:TextBox>
                                                                                            <span class="highlight"></span>
                                                                                            <span class="bar"></span>
                                                                                        </div>
                                                                                    ...
                                                                                    <EditItemTemplate>
                                                                                        <div class="md-input" style="margin: 0px;">
                                                                                            <asp:TextBox runat="server" Text='<%#Eval("Remarks")%>'
                                                                                                ToolTip="Remarks" ValidationGroup="Footer" MaxLength="100" onkeyup="maxlengthfortxt(100);" Width="250px" Height="60px" Wrap="true"
                                                ...
                                                <div align="right" class="fixed_btn">
                                                    ...
                                                    <button class="css_btn_enabled" id="btnCancelMJV" title="MJV Cancel[Alt+C]" onclick="if(fnCancelClick())" causesvalidation="false" onserverclick="btnCancelMJV_Click" runat="server"
