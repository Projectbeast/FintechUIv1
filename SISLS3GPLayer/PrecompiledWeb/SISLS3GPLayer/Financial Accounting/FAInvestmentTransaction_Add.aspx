<%@ page language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" enableeventvalidation="true" inherits="Financial_Accounting_FAInvestmentTransaction_Add, App_Web_jj5zdzwe" title="Investment Transaction" %>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <tr>
                                                                    ...
                                                                    <td class="styleFieldAlign" style="width: 25%;">
                                                                        ...
                                                                        <cc1:CalendarExtender runat="server" Format="dd/MM/yyyy" TargetControlID="txtDate" OnClientDateSelectionChanged="checkDate_NextSystemDate"
                                            ...
                                            <asp:Panel ID="pnlInvestmentTransaction" runat="server" GroupingText="Investment Transaction Details"
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td class="styleFieldAlign" style="width: 25%;">
                                                            <asp:TextBox ID="txtUnitFaceValue" runat="server" onmouseover="txt_MouseoverTooltip(this)"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="styleFieldLabel">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="styleFieldAlign">
                                                            <asp:TextBox ID="txtOtherChanges" runat="server" onpaste="return false;" onkeypress="fnAllowNumbersDesimal(false)"
                                                                AutoPostBack="true" Style="text-align: right;" OnTextChanged="txtOtherChanges_TextChanged"
                                                                onmouseover="txt_MouseoverTooltip(this)"></asp:TextBox>
                                                        </td>
                                                        <td class="styleFieldLabel">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="styleFieldAlign">
                                                            <asp:TextBox ID="txtMarketValue" runat="server" onpaste="return false;" onkeypress="fnAllowNumbersDesimal(false)" Style="text-align: right;"
                                                              AutoPostBack ="true" OnTextChanged="txtMarketValue_TextChanged" onmouseover="txt_MouseoverTooltip(this)"></asp:TextBox>
                            ...
                            <cc1:TabPanel runat="server" ID="tpPhysicalDemat" CssClass="tabpan" BackColor="Red"
                                ...
                                <ContentTemplate>
                                    <asp:UpdatePanel ID="updemat" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:Panel ID="pnldemat" runat="server" GroupingText="Physical/Demat Details" CssClass="stylePanel" Width ="100%">
