<%@ page title="" language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="Financial_Accounting_FA_MultiLocation_JV, App_Web_hqzzel3u" %>
                                                    ...
                                                    <tr>
                                                        <td class="styleButtonArea" align="center">
                                                            <asp:Button runat="server" ID="btnSave" OnClientClick="return fnCheckPageValidators('Header');"
                                                                ToolTip="Save,Alt+S" CssClass="styleSubmitButton" ValidationGroup="Header" Text="Save"
                                                            ...
                                                            &nbsp;<asp:Button runat="server" ID="btnCancel" Text="Exit" CausesValidation="False"
