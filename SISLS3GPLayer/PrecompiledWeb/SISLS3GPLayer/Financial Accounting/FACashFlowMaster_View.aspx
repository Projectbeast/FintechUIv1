<%@ page language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="Financial_Accounting_FACashFlowMaster_View, App_Web_mv5fp02i" %>
        ...
        <ContentTemplate>
            <div id="tbMain" runat="server">
                            ...
                            <asp:GridView ID="grvPaging" runat="server" HeaderStyle-CssClass="styleGridHeader"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Activity" SortExpression="Activity"
                                        HeaderStyle-CssClass="styleGridHeader">
                                        <ItemTemplate>
                                            <asp:Label ID="lblActivity" runat="server" ToolTip="Activity" Text='<%# Bind("LOOKUP_DESC") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderTemplate>
                                                        ...
                                                        <th style="padding: 0px !important; background: none !important;">
                                                            <div class="md-input" style="margin: 0px;">
                                                                <asp:TextBox AutoCompleteType="None" ID="txtHeaderSearch1" ToolTip="Activity"
                                                                    MaxLength="50" runat="server" class="md-form-control form-control login_form_content_input requires_true"
                                    ...
                                    <asp:TemplateField HeaderText="Flow Type" SortExpression="Flow_Type"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblFlowType" runat="server" ToolTip="Flow Type" Text='<%# Bind("Flow_Type") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderTemplate>
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <thead>
                                    ...
                                    <asp:TemplateField HeaderText="CashFlowFlag_Desc" SortExpression="Cash_Flow_Flag"
                                        HeaderStyle-CssClass="styleGridHeader">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCashFlowFlag" runat="server" ToolTip="CashFlow Flag Description" Text='<%# Bind("Flag_Desc") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderTemplate>
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <thead>
                ...
                <div align="right" class="fixed_btn">
                    ...
                    <button class="css_btn_enabled" id="btnBranchShowAll" onserverclick="btnBranchShowAll_Click" title="Show the Details, Alt+H" runat="server"
