<%@ page title="S3G - Pricing Approval" language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="S3GORGPricingApproval_View, App_Web_iftlmgmy" %>
                    ...
                    <td class="styleFieldAlign">
                        <table align="center">
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnGo" Text="Go" runat="server" AccessKey="G" ToolTip="Go,Alt+G" CssClass="styleSubmitButton" OnClick="btnGo_Click" />
                                </td>
                            </tr>
                        </table>
                    </td>
