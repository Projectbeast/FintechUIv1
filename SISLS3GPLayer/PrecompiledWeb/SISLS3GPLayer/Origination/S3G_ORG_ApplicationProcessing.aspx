<%@ page title="" language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" maintainscrollpositiononpostback="true" inherits="Origination_S3G_ORG_ApplicationProcessing, App_Web_jfqvryns" enableeventvalidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function funCalDebtPurchase() {
            ...
            fnthousands_separators("txtPrePaymentLimitFWC", 2);
            fnthousands_separators("txtDebtPurchaseLimitFWC", 2);
        }
