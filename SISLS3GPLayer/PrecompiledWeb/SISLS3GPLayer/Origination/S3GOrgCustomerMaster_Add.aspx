<%@ page title="" language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Origination_S3GOrgCustomerMaster_Add, App_Web_hirsyic0" enableeventvalidation="false" %>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                            <div class="md-input">
                                                                                ...
                                                                                <div class="validation_msg_box">
                                                                                    <asp:RequiredFieldValidator ValidationGroup="Personal Details" ID="rfvFactoringLimit" runat="server"
                                                                        ...
                                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                            <div class="md-input">
                                                                                ...
                                                                                <div class="validation_msg_box">
                                                                                    <asp:RequiredFieldValidator ValidationGroup="Personal Details" ID="rfvFacLimitExp" runat="server"
                                                            ...
                                                            <div style="margin-top: 10px;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                            <div class="md-input">
                                                                                <asp:TextBox ID="txtMaxLenLimit" runat="server" MaxLength="20"
                                                                                ...
                                                                                <div class="validation_msg_box">
                                                                                    <asp:RequiredFieldValidator ValidationGroup="Personal Details" ID="rfvMaxLenLimit" runat="server"
                                                                                ...
                                                                                <span class="bar"></span>
                                                                                <label>
                                                                                    <asp:Label runat="server" ID="lbl_MaximumLendingLimit" CssClass="styleReqFieldLabel" Text="Maximum Lending Limit" ToolTip="Maximum Lending Limit"></asp:Label>
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                            <div class="md-input">
                                                                                ...
                                                                                <div class="validation_msg_box">
                                                                                    <asp:RequiredFieldValidator ValidationGroup="Personal Details" ID="rfvMaxLenLimiExpDate" runat="server"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Cut Off Date">
                                                                ...
                                                                <EditItemTemplate>
                                                                    ...
                                                                    <%--   <cc1:FilteredTextBoxExtender ID="ftxtcutoff" runat="server" ValidChars="/-" FilterType="Custom,Numbers"
                                                                Enabled="true" TargetControlID="txtCutOffDateE">
                                                            </cc1:FilteredTextBoxExtender>--%>
                                                                    <div class="validation_msg_box">
                                                                ...
                                                                <FooterTemplate>
                                                                    ...
                                                                    <%-- <cc1:FilteredTextBoxExtender ID="ftxtcutoff" runat="server" ValidChars="/-" FilterType="Custom,Numbers"
                                                                Enabled="true" TargetControlID="txtCutOffDateF">
                                                            </cc1:FilteredTextBoxExtender>--%>
                                                                    <div class="validation_msg_box">
            ...
            <asp:Panel ID="plCreditLimithis" GroupingText="Limit History Details" CssClass="stylePanel" runat="server"
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <asp:Panel GroupingText="Maxmimum Lending Limit History Details" ToolTip="Maxmimum Lending Limit History Details"
                                    ...
                                    <div class="gird" style="max-height: 250px; overflow-y: scroll;">
                                        <asp:GridView ID="grvMaximumLimitHis" runat="server" AllowPaging="false" AutoGenerateColumns="False"
                                            ToolTip="Maxmimum Lending Limit History Details"
                                            EmptyDataText="No Bank Details Found!..."
                                            class="gird_details" HeaderStyle-CssClass="styleGridHeader">
                                            <Columns>
                                                <asp:BoundField DataField="Maximum_Limit" ItemStyle-HorizontalAlign="Right" HeaderText="Maximum Lending Limit">
                                                    <ItemStyle Width="5%" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="Maximum_Exp_Date" HeaderText="Maximum Lending Limit Expiry Date">
                                                    <ItemStyle Width="5%" Wrap="True" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="Modified_By" HeaderText="Modified By">
                                                    <ItemStyle Width="5%" Wrap="True" />
