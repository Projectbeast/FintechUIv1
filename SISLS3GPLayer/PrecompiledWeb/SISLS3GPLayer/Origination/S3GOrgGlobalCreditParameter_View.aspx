<%@ page title="Global Credit Parameter view" language="C#" validaterequest="false" autoeventwireup="true" inherits="Origination_S3GOrgGlobalCreditParameter_View, App_Web_midi1nyg" masterpagefile="~/Common/S3GMasterPageCollapse.master" %>
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnQuery" ImageUrl="~/Images/spacer.gif" CssClass="styleGridQuery"
                                            CommandArgument='<%# Bind("Global_Credit_Parameter_ID") %>' CommandName="Query"
                                            runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnEdit" CssClass="styleGridEdit" ImageUrl="~/Images/spacer.gif"
                                            CommandArgument='<%# Bind("Global_Credit_Parameter_ID") %>' CommandName="Modify"
                                            runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
