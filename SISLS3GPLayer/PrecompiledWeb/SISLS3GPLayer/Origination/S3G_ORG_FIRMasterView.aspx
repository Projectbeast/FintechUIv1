<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Origination_S3G_ORG_FIRMasterView, App_Web_jfqvryns" title="Untitled Page" %>
                            ...
                            <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnQuery" ImageUrl="~/Images/spacer.gif" CssClass="styleGridQuery"
                                            CommandArgument='<%# Bind("FIR_ID") %>' CommandName="Query" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" >
                                    ...
                                    <ItemTemplate>
                                       <asp:ImageButton ID="imgbtnEdit" CssClass="styleGridEdit" ImageUrl="~/Images/spacer.gif"
                                            CommandArgument='<%# Bind("FIR_ID") %>'  CommandName="Modify"
                                        runat="server" />
                                    </ItemTemplate>
