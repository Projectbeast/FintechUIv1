<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Reports_S3G360ViewReport, App_Web_dy5ultuc" %>
                                            ...
                                            <div class="gird">
                                                <asp:GridView ID="grvprimeaccount" runat="server" AutoGenerateColumns="False" ShowFooter="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Entity Ledger" ItemStyle-HorizontalAlign="left" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                <asp:Button ID="BtnEntityLedger" runat="server" Text="Entity Ledger" ToolTip="Entity Ledger" OnClick="BtnEntityLedger_Click" CssClass="grid_btn"></asp:Button>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Collateral " ItemStyle-HorizontalAlign="left" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                <asp:Button ID="BtnCollateral" runat="server" Text="Collateral" ToolTip="Collateral" OnClick="BtnCollateral_Click" CssClass="grid_btn"></asp:Button>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div id="Div4" class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                     ...
                                     <div id="Div5" class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                        <div class="md-input">
                                            <asp:TextBox ID="txtCCBAmount" runat="server" class="md-form-control form-control login_form_content_input requires_true" ReadOnly="true"></asp:TextBox>
                                            <span class="highlight"></span>
                                            <span class="bar"></span>
                                            <label>
                                                <asp:Label ID="Label3" runat="server" CssClass="styleFieldLabel" Text="CCB Amount"></asp:Label>
                                            </label>
                                        </div>
                                    </div>
                                </div>
