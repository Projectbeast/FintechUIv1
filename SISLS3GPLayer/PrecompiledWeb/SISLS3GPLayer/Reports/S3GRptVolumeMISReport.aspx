<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Reports_S3GRptJournalQuery, App_Web_dy5ultuc" title="Journal Query" %>
    ...
    <div id="tab-content" class="tab-content">
        <div class="tab-pane fade in active show" id="tab1">
            <div class="row">
                <div class="col">
                    <h6 class="title_name">
                        <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="Business Report">
                        </asp:Label>
                    </h6>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <asp:Panel ID="pnlJournalDetails" runat="server" CssClass="stylePanel" GroupingText="Business Reports" Width="100%">

                        <div id="divJournalDetails" runat="server" style="height: 350px; width: 100%; overflow-x: scroll; overflow-y: scroll;">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="gird">
                                        <asp:GridView ID="grvVolumeMIS" OnRowDataBound="grvVolumeMIS_DataBound" runat="server" Width="100%" AutoGenerateColumns="true" OnRowCreated="grvVolumeMIS_RowCreated" RowStyle-HorizontalAlign="Center" CellPadding="0" CellSpacing="0" ShowFooter="false">
                                        </asp:GridView>
                                    </div>
                                </div>
                            </div>
