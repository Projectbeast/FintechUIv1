<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Reports_S3GProbableDelinquentReport, App_Web_qvacefhr" %>
            ...
            <div id="tab-content" class="tab-content">
                <div class="tab-pane fade in active show" id="tab1">
                    <div class="row">
                        <div class="col">
                            <h6 class="title_name">
                                <asp:Label runat="server" ID="lblHeading" CssClass="styleDisplayLabel" Text="Probable Delinquent Report">
                                </asp:Label>
                            </h6>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <asp:Panel runat="server" ID="PnlDemandStatement" CssClass="stylePanel" GroupingText="INPUT CRITERIA">
                                <div class="row">
                                    ...
                                    <div id="Div3" class="col-lg-4 col-md-4 col-sm-6 col-xs-12" runat="server" visible="false">
                                        <div class="md-input">
