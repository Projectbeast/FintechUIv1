<%@ page title="" language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="FileTracking_S3GFileTrackRequest, App_Web_ke4311yt" %>
                        ...
                        <asp:Panel ID="pnlFileRequest" Width="100%" GroupingText="File Request" CssClass="stylePanel"
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="md-input">
                                        <asp:DropDownList ID="ddlLocation" runat="server" AutoPostBack="true" class="md-form-control form-control" ToolTip="Branch" OnSelectedIndexChanged="ddlLocation_SelectedIndexChanged" >
                                        </asp:DropDownList>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="md-input">
                                        <uc2:Suggest ID="txtProposalNumber" AutoPostBack="true" runat="server" ServiceMethod="GetProposalList"
                                            CssClass="md-form-control form-control login_form_content_input" IsMandatory="true" ErrorMessage="Select a Proposal Number" ValidationGroup="btnSave" class="md-form-control form-control" OnItem_Selected="txtProposalNumber_Item_Selected" />
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="md-input">
                                        ...
                                        <span class="bar"></span>
                                        <label>
                                            <asp:Label runat="server" Text="Reason for Request" ID="lblRemarks" CssClass="styleDisplayLabel"></asp:Label>
                                        </label>
                                        <div class="validation_msg_box">
                                            <asp:RequiredFieldValidator ID="rfvRemarks" runat="server" Display="Dynamic" InitialValue="" CssClass="validation_msg_box_sapn"
                                                ValidationGroup="btnSave" ErrorMessage="Enter Reason for Request" ControlToValidate="txtRemarks"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" runat="server" id="dvRequestNumber" visible="false">
                                    <div class="md-input">
                                        <asp:TextBox ID="txtRequestNumber" Enabled="false" ToolTip="Request Number" TabIndex="-1" class="md-form-control form-control login_form_content_input requires_true" runat="server" />
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>
                                            <asp:Label ID="lblRequestNumber" CssClass="styleDisplayLabel" runat="server" Text="Request Number"></asp:Label>
                                        </label>
                                    </div>
                                </div>
                            </div>
