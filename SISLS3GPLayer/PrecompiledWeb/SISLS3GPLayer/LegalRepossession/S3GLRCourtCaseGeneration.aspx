<%@ page title="" language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="LegalRepossession_S3GLRCourtCaseGeneration, App_Web_prpaho0u" %>
        ...
        <ContentTemplate>
            <div id="tab-content" class="tab-content">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <cc1:TabContainer ID="tcCaseGeneration" runat="server" ActiveTabIndex="0" CssClass="styleTabPanel"
                                        ...
                                        <ContentTemplate>
                                            <div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <%--<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                                        <div class="md-input">
                                                            <asp:DropDownList ID="DropDownList1" runat="server" class="md-form-control form-control"></asp:DropDownList>
                                                            <div class="validation_msg_box">
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlFIRStatus" Enabled="False"
                                                            ...
                                                            <span class="bar"></span>
                                                            <label>
                                                                <asp:Label ID="Label1" runat="server" Text="ROP Status"></asp:Label>
                                                            </label>
                                                        </div>
                                                    </div>--%>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                                        <div class="md-input">
                                                            <asp:TextBox ID="txtModBy" runat="server" ToolTip="Modified by" Enabled="false" class="md-form-control form-control login_form_content_input requires_true" Style="text-align: right"></asp:TextBox>

                                                            <span class="highlight"></span>
                                                            <span class="bar"></span>
                                                            <label>
                                                                <asp:Label ID="lbltxtModBy" runat="server" CssClass="styleDisplayLabel" Text="Modified by"></asp:Label>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                                        <div class="md-input">
                                                            <asp:TextBox ID="txtModifiedon" Enabled="false" runat="server" ToolTip="Modified On" class="md-form-control form-control login_form_content_input requires_true" Style="text-align: right"></asp:TextBox>

                                                            <span class="highlight"></span>
                                                            <span class="bar"></span>
                                                            <label>
                                                                <asp:Label ID="lbltxtModifiedon" runat="server" CssClass="styleDisplayLabel" Text="Modified On"></asp:Label>
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <%--   <cc1:CollapsiblePanelExtender ID="cpeDemo" runat="Server" TargetControlID="pnlAccountDetails"
                                                        ExpandControlID="divFormatHelp" CollapseControlID="divFormaBase" Collapsed="True"
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <asp:Panel ID="divFormaBase" runat="server" CssClass="accordionHeader" Width="98.5%">
                                                ...
                                                <cc1:CollapsiblePanelExtender ID="cpeDemo" runat="Server" TargetControlID="pnlRopDetails"
                                                    ExpandControlID="pnlRop" CollapseControlID="pnlRop" Collapsed="false"
                                                    TextLabelID="lblimgROPDetails" ImageControlID="imgROPDetails" ExpandedText="(Hide Details...)"
                                                    CollapsedText="(Show Details...)" ExpandedImage="~/Images/collapse_blue.jpg"
                                                    CollapsedImage="~/Images/expand_blue.jpg" SuppressPostBack="true" SkinID="CollapsiblePanelDemo" />
                                                <div style="background-color: rgba(247, 247, 247, 0.63);">
                                                    <asp:Panel ID="pnlRop" runat="server" CssClass="accordionHeader" Width="98.5%">
                                                        <div style="float: left;">
                                                            ROP Details
                                                        </div>
                                                        <div style="float: left; margin-left: 20px;">
                                                            <asp:Label ID="lblimgROPDetails" runat="server">(Show Details...)</asp:Label>
                                                        </div>
                                                        <div style="float: right; vertical-align: middle;">
                                                            <asp:ImageButton ID="imgROPDetails" runat="server" ImageUrl="~/Images/expand_blue.jpg"
                                                                AlternateText="(Show Details...)" />
                                                        </div>
                                                    </asp:Panel>
                                                    <asp:Panel ID="pnlRopDetails" runat="server" GroupingText="ROP Details"
                                                        CssClass="stylePanel" Width="100%">
                                                        <asp:GridView Width="100%" ID="grvROPDetails" runat="server" class="gird_details" OnRowDataBound="grvROPDetails_RowDataBound" ShowHeaderWhenEmpty="True"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="ROP Document Number">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton runat="server" ID="lblROPDocumentNumber" Text='<%#Eval("ROP_Document_Number") %>'></asp:LinkButton>
                                                                        <asp:Label runat="server" ID="lblISAssigned" Text='<%#Eval("IS_Assigned") %>'></asp:Label>

                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField Visible="false" HeaderText="ROP Document NumberLbl">
                                                                    <ItemTemplate>
                                                                        <asp:Label runat="server" ID="lblROP_Document_Number" Text='<%#Eval("ROP_Document_Number") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField Visible="false" HeaderText="Case ID">
                                                                    <ItemTemplate>
                                                                        <asp:Label runat="server" ID="lblCaseId" Text='<%#Eval("CASE_ID") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="ROP Number">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton runat="server" ID="lblROPNumber" Text='<%#Eval("ROP_Number") %>'></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                ...
                                                <cc1:CollapsiblePanelExtender ID="CollapseAccount" runat="Server" TargetControlID="pnlAccountDetails"
                                                    ExpandControlID="pnlAccount" CollapseControlID="pnlAccount" Collapsed="false"
                                                    TextLabelID="lblAccountDetails" ImageControlID="imgAccountDetails" ExpandedText="(Hide Details...)"
                                                    CollapsedText="(Show Details...)" ExpandedImage="~/Images/collapse_blue.jpg"
                                                    CollapsedImage="~/Images/expand_blue.jpg" SuppressPostBack="true" SkinID="CollapsiblePanelDemo" />
                                                <div style="background-color: rgba(247, 247, 247, 0.63);">
                                                    <asp:Panel ID="pnlAccount" runat="server" CssClass="accordionHeader" Width="98.5%">
                                                        <div style="float: left;">
                                                            Account Details
                                                        </div>
                                                        <div style="float: left; margin-left: 20px;">
                                                            <asp:Label ID="lblAccountDetails" runat="server">(Show Details...)</asp:Label>
                                                        </div>
                                                        <div style="float: right; vertical-align: middle;">
                                                            <asp:ImageButton ID="imgAccountDetails" runat="server" ImageUrl="~/Images/expand_blue.jpg"
                                                                AlternateText="(Show Details...)" />
                                                        </div>
                                                    </asp:Panel>
                                                ...
                                                <cc1:CollapsiblePanelExtender ID="collapseAccountDues" runat="Server" TargetControlID="pnlAccDues"
                                                    ExpandControlID="pnlAccountHdr" CollapseControlID="pnlAccountHdr" Collapsed="true"
                                                    TextLabelID="lblimgcollapseAccountDues" ImageControlID="imgcollapseAccountDues" ExpandedText="(Hide Details...)"
                                                    CollapsedText="(Show Details...)" ExpandedImage="~/Images/collapse_blue.jpg"
                                                    CollapsedImage="~/Images/expand_blue.jpg" SuppressPostBack="true" SkinID="CollapsiblePanelDemo" />
                                                <div style="background-color: rgba(247, 247, 247, 0.63);">
                                                    <asp:Panel ID="pnlAccountHdr" runat="server" CssClass="accordionHeader" Width="98.5%">
                                                        <div style="float: left;">
                                                            Account Due Details
                                                        </div>
                                                        <div style="float: left; margin-left: 20px;">
                                                            <asp:Label ID="lblimgcollapseAccountDues" runat="server">(Show Details...)</asp:Label>
                                                        </div>
                                                        <div style="float: right; vertical-align: middle;">
                                                            <asp:ImageButton ID="imgcollapseAccountDues" runat="server" ImageUrl="~/Images/expand_blue.jpg"
                                                                AlternateText="(Show Details...)" />
                                                        </div>
                                                    </asp:Panel>
                                                    <asp:Panel GroupingText="Account Dues" ID="pnlAccDues" runat="server" CssClass="stylePanel" Width="100%">
                                                        <asp:GridView ID="grdAccountDues" runat="server" AutoGenerateColumns="False" OnRowDataBound="grdAccountDues_RowDataBound" EmptyDataText="No records found" ShowHeaderWhenEmpty="True"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="Account Number">
                                                                    <ItemTemplate>
                                                                        <asp:Label runat="server" ID="lblPANUM" Text='<%#Eval("PANUM") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                ...
                                                <cc1:CollapsiblePanelExtender ID="collapseCheque" runat="Server" TargetControlID="pnlChequeDetails"
                                                    ExpandControlID="pnlCheque" CollapseControlID="pnlCheque" Collapsed="false"
                                                    TextLabelID="lblimgChequeDetails" ImageControlID="imgChequeDetails" ExpandedText="(Hide Details...)"
                                                    CollapsedText="(Show Details...)" ExpandedImage="~/Images/collapse_blue.jpg"
                                                    CollapsedImage="~/Images/expand_blue.jpg" SuppressPostBack="true" SkinID="CollapsiblePanelDemo" />
                                                <div style="background-color: rgba(247, 247, 247, 0.63);">
                                                    <asp:Panel ID="pnlCheque" runat="server" CssClass="accordionHeader" Width="98.5%">
                                                        <div style="float: left;">
                                                            Cheque Details
                                                        </div>
                                                        <div style="float: left; margin-left: 20px;">
                                                            <asp:Label ID="lblimgChequeDetails" runat="server">(Show Details...)</asp:Label>
                                                        </div>
                                                        <div style="float: right; vertical-align: middle;">
                                                            <asp:ImageButton ID="imgChequeDetails" runat="server" ImageUrl="~/Images/expand_blue.jpg"
                                                                AlternateText="(Show Details...)" />
                                                        </div>
                                                    </asp:Panel>
                                                    ...
                                                    <div class="gird">
                                                        <asp:GridView Width="100%" ID="gvGuarDetails" runat="server" class="gird_details" EmptyDataText="No records found"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Account Number">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblAccountNumber" runat="server" Text='<%#Eval("ACCOUNT_NO")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                ...
                                                <%----Open Pdc Details Start--%>
                                                <cc1:CollapsiblePanelExtender ID="collapsePdc" runat="Server" TargetControlID="pnlPdcdtls"
                                                    ExpandControlID="pnlPdc" CollapseControlID="pnlPdc" Collapsed="false"
                                                    TextLabelID="lblimgPdcDetails" ImageControlID="imgPDCDetails" ExpandedText="(Hide Details...)"
                                                    CollapsedText="(Show Details...)" ExpandedImage="~/Images/collapse_blue.jpg"
                                                    CollapsedImage="~/Images/expand_blue.jpg" SuppressPostBack="true" SkinID="CollapsiblePanelDemo" />
                                                <div style="background-color: rgba(247, 247, 247, 0.63);">
                                                    <asp:Panel ID="pnlPdc" runat="server" CssClass="accordionHeader" Width="98.5%">
                                                        <div style="float: left;">
                                                            PDC Details
                                                        </div>
                                                        <div style="float: left; margin-left: 20px;">
                                                            <asp:Label ID="lblimgPdcDetails" runat="server">(Show Details...)</asp:Label>
                                                        </div>
                                                        <div style="float: right; vertical-align: middle;">
                                                            <asp:ImageButton ID="imgPDCDetails" runat="server" ImageUrl="~/Images/expand_blue.jpg"
                                                                AlternateText="(Show Details...)" />
                                                        </div>
                                                    </asp:Panel>
                                                ...
                                                <%-- <div class="gird col-lg-12 col-md-12 col-sm-12 col-xs-12">--%>
                                                <cc1:CollapsiblePanelExtender ID="collpseOverdue" runat="Server" TargetControlID="pnlOverdue"
                                                    ExpandControlID="pnlOverdueHdr" CollapseControlID="pnlCheque" Collapsed="false"
                                                    TextLabelID="lblimgcollpseOverdue" ImageControlID="imgcollpseOverdue" ExpandedText="(Hide Details...)"
                                                    CollapsedText="(Show Details...)" ExpandedImage="~/Images/collapse_blue.jpg"
                                                    CollapsedImage="~/Images/expand_blue.jpg" SuppressPostBack="true" SkinID="CollapsiblePanelDemo" />
                                                <div style="background-color: rgba(247, 247, 247, 0.63);">
                                                    <asp:Panel ID="pnlOverdueHdr" runat="server" CssClass="accordionHeader" Width="98.5%">
                                                        <div style="float: left;">
                                                            Over Due Details
                                                        </div>
                                                        <div style="float: left; margin-left: 20px;">
                                                            <asp:Label ID="lblimgcollpseOverdue" runat="server">(Show Details...)</asp:Label>
                                                        </div>
                                                        <div style="float: right; vertical-align: middle;">
                                                            <asp:ImageButton ID="imgcollpseOverdue" runat="server" ImageUrl="~/Images/expand_blue.jpg"
                                                                AlternateText="(Show Details...)" />
                                                        </div>
                                                    </asp:Panel>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <asp:Panel GroupingText="ROP Details" ID="pnlFIRDetails" runat="server"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                                                    <div class="md-input">
                                                                        <asp:TextBox ID="txtFIRRemarks" runat="server" ToolTip="ROPROP Remarks" TextMode="MultiLine" class="md-form-control form-control login_form_content_input requires_true lowercase" onkeyup="maxlengthfortxt(200)"></asp:TextBox>
                                                                        <span class="highlight"></span>
                                                                        <span class="bar"></span>
                                                                        <label>
                            ...
                            <div class="row">
                                <div class="col">
                                    <cc1:TabPanel ID="tbCourt" runat="server" HeaderText="tbCourt">
                                        <HeaderTemplate>
                                            Court Case Details                                
                                        </HeaderTemplate>
                                        <ContentTemplate>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <asp:Panel GroupingText="Lawyer Details" ID="Panel3" runat="server"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                                                    <div class="md-input">
                                                                        <asp:DropDownList ID="ddlLawyerType" runat="server" ToolTip="Court Level" AutoPostBack="true"
                                                                            OnSelectedIndexChanged="ddlLawyerType_SelectedIndexChanged" class="md-form-control form-control">
                                                                        </asp:DropDownList>

                                                                        <span class="highlight"></span><span class="bar"></span>
                                                                        <%--<div class="validation_msg_box">
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlcourtlev" Enabled="False"
                                                                                SetFocusOnError="True" CssClass="validation_msg_box_sapn" Display="Dynamic" InitialValue="0" ErrorMessage="Select Court level"
                                                                                ValidationGroup="Lawyer Type"></asp:RequiredFieldValidator>
                                                                        </div>--%>
                                                                        <label>
                                                                            <asp:Label runat="server" Text="Lawyer Type" ID="Label3" CssClass="styleReqFieldLabel"></asp:Label></label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                                                    <div class="md-input">
                                                                        ...
                                                                        <uc2:Suggest ID="ddlAdvocate" ToolTip="Lawyer" IsMandatory="true" ErrorMessage="Select the Lawyer" runat="server"
                                                                            ValidationGroup="ROP Case Filing" ServiceMethod="GetLawyerDetails"
                                                                            class="md-form-control form-control" />
                                                                        <asp:HiddenField ID="hdnInternalLawyer" runat="server" />

                                                                        <%-- <div class="validation_msg_box">
                                                                            <asp:RequiredFieldValidator ID="rfvddlAdvocate" runat="server" ControlToValidate="ddlAdvocate" 
                                                                ...
                                                                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                                                    <div class="md-input">
                                                                        <asp:TextBox ID="txtLawyerDate" runat="server" ToolTip="Lawyer Effective Date"
                                                                            class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                                                                        <cc1:CalendarExtender ID="calLEDate" runat="server" Enabled="True" OnClientDateSelectionChanged="checkDate_LawyerDate" TargetControlID="txtLawyerDate">
                                                                        </cc1:CalendarExtender>
                                                                        <div class="validation_msg_box">
                                                                            <asp:RequiredFieldValidator ID="rfvLawyerdate" runat="server" ControlToValidate="txtLawyerDate" Enabled="false"
                                                                                SetFocusOnError="true" CssClass="validation_msg_box_sapn" Display="Dynamic" ErrorMessage="Enter the Effective Date"
                                                                                ValidationGroup="ROP Case Filing"></asp:RequiredFieldValidator>
                                                                        </div>
                                                                        <span class="highlight"></span>
                                                                        <span class="bar"></span>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" Text="Delete" CssClass="grid_btn_delete"
                                                                                    OnClientClick="return confirm('Do you want to Delete this record?');" AccessKey="E" ToolTip="Delete[Alt+Shift+E]">
                                                                                </asp:LinkButton>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                            ...
                                                            <div class="gird">
                                                                <asp:GridView Width="100%" ID="grvProsecution" runat="server" AutoGenerateColumns="False" OnRowCommand="grvProsecution_RowCommand"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Prosecution No">
                                                                            ...
                                                                            <FooterTemplate>
                                                                                <asp:TextBox runat="server" class="md-form-control form-control login_form_content_input requires_true" ID="txtFProsecutionNo"></asp:TextBox>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                               ...
                                                               <asp:TemplateField HeaderText="Prosecution Value">
                                                                    ...
                                                                    <FooterTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Accounting Expert">
                                                                            <ItemTemplate>
                                                                                <%--<asp:Label ID="lblAccountingExpert" runat="server" Text='<%# Eval("Accounting_Expert") %>'></asp:Label>--%>
                                                                                <asp:TextBox runat="server" class="md-form-control form-control login_form_content_input" Text='<%# Eval("Accounting_Expert") %>' TextMode="MultiLine" onkeyup="maxlengthfortxt(150);" ID="txtAccountingExpert"></asp:TextBox>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:TextBox runat="server" class="md-form-control form-control login_form_content_input" TextMode="MultiLine" onkeyup="maxlengthfortxt(150);" ID="txtAccountingExpertF"></asp:TextBox>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Hearing Attended By">
                                                                            ...
                                                                            <FooterTemplate>
                                                                                <div class="md-input" style="margin: 0px;">
                                                                                    ...
                                                                                    <asp:TextBox ID="txtHearingAttBy" runat="server" MaxLength="50" Text='<%# Eval("HearingAttBy") %>'
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Hearing Date">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblHearingDate" runat="server" Text='<%# Eval("Hearing_Date") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <div class="md-input" style="margin: 0px;">
                                                                                    <asp:TextBox ID="txtHearingFDate" runat="server" Text='<%# Eval("Hearing_Date") %>' class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                ...
                <div align="right">
                    ...
                    <button class="css_btn_enabled" id="btnSave" onserverclick="btnSave_Click" runat="server" onclick="if(fnCheckPageValidators('ROP Case Filing'))" validationgroup="ROP Case Filing"
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td align="center" colspan="2">
                    ...
                    <button class="css_btn_enabled" id="btnUpload" onserverclick="btnUpload_Click" runat="server" causesvalidation="false" title="Upload[Alt+X]"
                        type="button">
                    ...
                    <button class="css_btn_enabled" id="btnUploadCancel" onserverclick="btnUploadCancel_Click" runat="server" causesvalidation="false" title="Exit[Alt+X]" onclick="if(fnConfirmExit())"
                        type="button">
                                        ...
                                        <asp:GridView ID="grvUploadedFiles" Width="100%" runat="server" class="gird_details" AutoGenerateColumns="false" ShowFooter="false" OnRowDataBound="grvUploadedFiles_RowDataBound" OnRowDeleting="grvUploadedFiles_RowDeleting">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkDelete" runat="server" Text="Delete" CssClass="grid_btn_delete" CausesValidation="false" CommandName="Delete"></asp:LinkButton>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                            </Columns>
