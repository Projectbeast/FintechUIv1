<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Collection_S3GClnPDCEntry, App_Web_x5tdsxrh" title="PDC Entry" enableeventvalidation="false" %>
                                                            ...
                                                            <asp:UpdatePanel ID="UpPDCDetails" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <asp:Panel ID="pnlGRDSeqYes" runat="server" CssClass="stylePanel" GroupingText="PDC Information"
                                                                        Visible="false">
                                                                        <div class="gird">
                                                                            <asp:GridView runat="server" ID="GRVPDCDetails" AutoGenerateColumns="False" OnRowDataBound="GRVPDCDetails_RowDataBound" ToolTip="PDC Entry Details" EmptyDataText="No Pending Installments found">
                                                                                <Columns>
                                                                                    <%--Prime A/c No--%>
