<%@ page title="" language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Collection_S3GClnChqRepHandingOverAck_AccountDept, App_Web_3jwyxbhk" %>
            ...
            <table width="100%" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="top" class="stylePageHeading">
                        <asp:Label runat="server" Text="Cheque Representation Handing Over Ack. Accounts Department" ID="lblHeading" CssClass="styleDisplayLabel">
                        </asp:Label>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td rowspan="2">
                                    ...
                                    <asp:Panel ID="pnlAck" GroupingText="Cheque Handing over by Cheuqe custodian"
                                        Width="100%" CssClass="stylePanel" BorderColor="#77B6E9" BorderWidth="0" runat="server">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center">
                                                    <asp:Button ID="btnAck" runat="server" OnClientClick="return CheckMandatory_one(this)" CssClass="styleSubmitButton"
                                                        ToolTip="Acknowledge, Alt+K" AccessKey="K" OnClick="btnAck_Click" Width="80px" Text="Acknowledge" />
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
