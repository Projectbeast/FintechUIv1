<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Collection_S3G_DSE_Incentive_Process, App_Web_x5tdsxrh" %>
        ...
        <ContentTemplate>
            ...
            <div>
                        ...
                        <asp:Panel ID="pnlHeaderDetails" runat="server" CssClass="stylePanel" BorderWidth="1">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="md-input">
                                        ...
                                        <span class="bar"></span>
                                        <label>
                                            <asp:Label runat="server" Text="Branch" ID="lblLocation" CssClass="styleDisplayLabel">
                                            </asp:Label>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="md-input">
                                        ...
                                        <span class="bar"></span>
                                        <label>
                                            <asp:Label runat="server" Text="Scheme Type" ID="lblScheme" CssClass="styleReqFieldLabel">
                                            </asp:Label>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <asp:Panel ID="pnlMarketingExecutive" runat="server" CssClass="stylePanel" Width="100%" GroupingText="Marketing Officer Name">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="gird">
                                                    <asp:GridView ID="gvLoadMarketingExecutive" runat="server" Width="100%" AutoGenerateColumns="false"
                                                        OnRowDataBound="gvLoadMarketingExecutive_RowDataBound">
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr align="center">
                                                                            <td>
                                                                                <asp:Label runat="server" ID="lblMarkettingExecutive" Text="Marketing Officer Name" CssClass="styleDisplayLabel"></asp:Label>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label Text='<%#Eval("Mark_off_Name") %>' runat="server" ID="lblGvMarketingExecutive" />
                ...
                <div align="right">
                    ...
                    <button class="css_btn_enabled" id="btnSave" visible="false" title="Save[Alt+S]"
                        onclick="if(fnCheckPageValidators('Ok',false))" causesvalidation="false" runat="server"
                        type="button" accesskey="S" validationgroup="Ok">
                        <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>S</u>ave
                    </button>

                    <button class="css_btn_enabled" id="btnClear" title="Clear[Alt+L]" 
                        causesvalidation="false" onserverclick="btnClear_Click" runat="server" type="button" accesskey="L">
                        <i class="fa fa-eraser" aria-hidden="true"></i>&emsp;C<u>l</u>ear
                    </button>
                    <button class="css_btn_enabled" id="btnExit" title="Exit[Alt+X]" onclick="if(parent.RemoveTab())" 
                        causesvalidation="false" runat="server"
                        type="button" accesskey="X" visible="false" > 
