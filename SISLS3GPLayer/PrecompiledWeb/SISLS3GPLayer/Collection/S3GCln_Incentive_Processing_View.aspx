<%@ page title="" language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Collection_S3GCln_Incentive_Processing_View, App_Web_la20gqab" %>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                <div class="md-input">
                                    ...
                                    <cc1:CalendarExtender ID="ceFromMonthYr" runat="server" BehaviorID="calendar1" Format="yyyyMM" TargetControlID="txtFrmMonthyr" OnClientShown="onCalendarShown">
