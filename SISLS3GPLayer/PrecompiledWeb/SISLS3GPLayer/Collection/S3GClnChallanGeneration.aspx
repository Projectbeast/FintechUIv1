<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Collection_S3GClnChallanGeneration, App_Web_x5tdsxrh" title="Untitled Page" %>
            ...
            <div id="tab-content" class="tab-content">
                <div class="tab-pane fade in active show">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="md-input">
                                <asp:CheckBox ID="chkPastReceipts" runat="server" AutoPostBack="true" OnCheckedChanged="chkPastReceipts_CheckedChanged"></asp:CheckBox>
