<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Collection_S3GClnReceiptProcessing, App_Web_wom33hv0" title="Untitled Page" enableeventvalidation="false" %>
                                                                ...
                                                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                                    <div class="md-input">
                                                                        ...
                                                                        <cc1:CalendarExtender ID="calDocDate" runat="server" Enabled="True" Format="DD/MM/YYYY"
                                                                            PopupButtonID="imgDocdate" TargetControlID="txtDocDate" OnClientDateSelectionChanged="checkDate_NextSystemDate">
