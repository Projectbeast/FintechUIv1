<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Common/S3GMasterPageCollapse.master" inherits="Collection_S3GDealerCommissionRateMaster_View, App_Web_x5tdsxrh" %>
        ...
        <ContentTemplate>
            <div id="tbMain" runat="server">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="gird">
                            <asp:GridView Width="100%" ID="gvDNC" runat="server" AutoGenerateColumns="False"
                                DataKeyNames="DEALER_COMM_ID" OnRowDataBound="gvDNC_RowDataBound"
                                ...
                                <Columns>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgbtnQuery" ImageUrl="~/Images/spacer.gif" CssClass="styleGridQuery"
                                                CommandArgument='<%# Bind("DEALER_COMM_ID") %>' CommandName="Query" runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="styleGridHeader">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgbtnEdit" CssClass="styleGridEdit" ImageUrl="~/Images/spacer.gif"
                                                CommandArgument='<%# Bind("DEALER_COMM_ID") %>' CommandName="Modify" runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Entity Name" SortExpression="ENTITY_NAME">
                                        <ItemTemplate>
                                            <asp:Label ID="lblConstant_Code" runat="server" Text='<%# Bind("ENTITY_NAME") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderTemplate>
                                                ...
                                                <thead>
                                                    <tr align="center">
                                                        <th style="padding: 0px !important; background: none !important;">
                                                            <asp:LinkButton ID="lnkbtnSortCode" runat="server" Text="Dealer Code/Name" ToolTip="Sort By Dealer Code/Name"
                                                    ...
                                                    <tr align="left">
                                                        <th style="padding: 0px !important; background: none !important;">
                                                            <div class="md-input" style="margin: 0px;">
                                                                <asp:TextBox AutoCompleteType="None" ID="txtHeaderSearch1" runat="server" AutoPostBack="true" ToolTip="Dealer Code/Name"
                                    ...
                                    <asp:TemplateField HeaderText="Dealer Commission Description" SortExpression="RATE_TYPE_DESC">
                                        <ItemTemplate>
                                            <asp:Label ID="lblUserGroupName" runat="server" Text='<%# Bind("RATE_TYPE_DESC") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderTemplate>
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <thead>
                                                    <tr align="center">
                                                        <th style="padding: 0px !important; background: none !important;">
                                                            <asp:LinkButton ID="lnkbtnUserGroupName" OnClick="FunProSortingColumn"
                                                                runat="server" ToolTip="Sort By Dealer Commission Description" Text="Dealer Commission Description" Style="text-decoration: none;"></asp:LinkButton>
                                                    ...
                                                    <tr align="left">
                                                        <th style="padding: 0px !important; background: none !important;">
                                                            <div class="md-input" style="margin: 0px;">
                                                                <asp:TextBox AutoCompleteType="None" ID="txtHeaderSearch2" runat="server" AutoPostBack="true" ToolTip="Dealer Commission Description"
                ...
                <div align="right" class="fixed_btn">
                    ...
                    <button class="css_btn_enabled" id="btnShowAll" onserverclick="btnShowAll_Click" title="Show the Details, Alt+H" runat="server"
