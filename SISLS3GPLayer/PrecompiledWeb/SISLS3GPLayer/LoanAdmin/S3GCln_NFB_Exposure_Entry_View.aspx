<%@ page title="" language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" enableeventvalidation="false" autoeventwireup="true" inherits="LoanAdmin_S3GCln_NFB_Exposure_Entry_View, App_Web_ccy20lsg" %>
            ...
            <div id="tab-content" class="tab-content">
                <div class="tab-pane fade in active show" id="tab1">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 grid">
                            <asp:GridView ID="grvPaging" runat="server" AutoGenerateColumns="False" Width="100%" OnRowDataBound="grvPaging_RowDataBound" OnRowCommand="grvPaging_RowCommand">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Guarantee No" Visible="false">
                                        <HeaderTemplate>
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <thead>
                                                    <tr align="center">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 grid">
                            <asp:GridView ID="grvExcel" runat="server" AutoGenerateColumns="False" Width="100%">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Guarntee No">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Gurantor">
                                        <ItemTemplate>
                                            <asp:Label ID="lblGurantor" runat="server" Text='<%# Eval("Gurantor")%>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Guanrtee Type">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Expiry Month">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Auto Renewal">
                                        <ItemTemplate>
                    ...
                    <div align="right" class="fixed_btn">
                        ...
                        <button class="css_btn_enabled" id="btnExporttoExcel" title="Export to Excel[Alt+E]" causesvalidation="false"
