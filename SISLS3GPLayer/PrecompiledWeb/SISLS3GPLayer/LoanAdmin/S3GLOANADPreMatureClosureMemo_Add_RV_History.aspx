<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="LoanAdmin_S3GLOANADPreMatureClosureMemo_Add_RV_History, App_Web_fteskag1" title="Untitled Page" enableeventvalidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div id="tab-content" class="tab-content">
                <div class="tab-pane fade in active show" id="tab1">
                    <div class="row">
                        <div class="col">
                            <h6 class="title_name">
                                <asp:Label runat="server" Text="PreMature Closure Memo" ID="lblHeading" CssClass="styleDisplayLabel"> </asp:Label>
                            </h6>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <cc1:TabPanel runat="server" HeaderText="General"
                                            ...
                                            <ContentTemplate>
                                                <div class="row">
                                                    ...
                                                    <div style="display: none" class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                        <div class="md-input">
                                                            <asp:CheckBox ID="chkIgnoreLastCheques" runat="server" AutoPostBack="true"
                                                                OnCheckedChanged="chkIgnoreLastCheques_CheckedChanged"
                                                                onclick="fnIncludeLastCheque(this)"></asp:CheckBox>
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                                        <div class="md-input">
                                                            ...
                                                            <uc4:ICM ID="ucAccountLov" onblur="fnLoadAccount()" runat="server" AutoPostBack="true" ShowHideAddressImageButton="false" DispalyContent="Both" OnItem_Selected="ucAccountLov_Item_Selected"
                                                                strLOV_Code="ACC_RVK_HIS" ServiceMethod="GetAccuntNoList" class="md-form-control form-control" />
                            ...
                            InitialValue="0" SetFocusOnError="True"></asp:RequiredFieldValidator>--%>
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                        <div class="md-input">
                                                            <uc2:Suggest ID="ddlClsoureRvNo" runat="server" AutoPostBack="true"
                                                                class="md-form-control form-control" ToolTip="Revocation No" OnItem_Selected="ddlClsoureRvNo_Item_Selected" ServiceMethod="WebGetRevocationNo"
                                                                IsMandatory="false" />
                                                            <span class="highlight"></span>
                                                            <span class="bar"></span>
                                                            <label>
                                                                <asp:Label ID="lblClsoureRvNo" runat="server" Text="Revocation No" ToolTip="Revocation No" CssClass="styleDisplayLabel"></asp:Label>
                                                            </label>
                                                        </div>
                                                    </div>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvtxtCustomerNameDummy" runat="server" ErrorMessage="Select the Customer"
                                            ...
                                            Display="Dynamic"></asp:RequiredFieldValidator>
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                        <div class="md-input">
                                                            <asp:TextBox ID="txtBranch" Enabled="false" AutoPostBack="true" ToolTip="Branch"
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                        <div class="md-input">
                                                            <asp:TextBox ID="txtPreclosureType" Enabled="false" runat="server" AutoPostBack="True"
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                        <div class="md-input">
                                                            <asp:TextBox ID="txtPMCReqDate" runat="server" onchange="" autocomplete="off" ReadOnly="true"
                                                            ...
                                                            <span class="bar"></span>
                                                            <label>
                                                                <asp:Label runat="server" Text="Closure Date" ID="lblAccountClosureDate"
                                                    ...
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                        <div class="md-input">
                                                            <asp:TextBox ID="txtRevocationDate" runat="server" autocomplete="off" ReadOnly="true"
                                                                Enabled="false"
                                                                class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                                                            <span class="highlight"></span>
                                                            <span class="bar"></span>
                                                            <label>
                                                                <asp:Label runat="server" Text="Revocation Date" ID="lblRevocation"
                                                                    CssClass="styleDisplayLabel"></asp:Label>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                        ...
                                                        <asp:LinkButton ID="lnkViewAccountDetails" Enabled="false" runat="server" Text="View Account" CssClass="styleDisplayLabel" AccessKey="V"
                                                    ...
                                                    <div style="display: none" class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                        <div class="md-input">
                                                            <asp:CheckBox ID="chkBoxWriteOff" AutoPostBack="true" OnCheckedChanged="chkBoxWriteOff_CheckedChanged" runat="server"></asp:CheckBox>
                                                            <asp:Label ID="lblWriteOff" runat="server" Text="Write Off" CssClass="styleDisplayLabel"></asp:Label>

                                                        </div>
                                                    </div>
                                                    <div style="display: none" id="divddlWriteOff" runat="server" visible="false" class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                        <div class="md-input">
                                                    ...
                                                    <div style="display: none" class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                        <div class="md-input">
                                                            <asp:TextBox ID="txtDiscountRate" onchange="funCheckRange();" Style="text-align: right" runat="server" MaxLength="6"
                                                                class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                                                            <cc1:FilteredTextBoxExtender ID="ftxtFinanceAmount" runat="server" TargetControlID="txtDiscountRate"
                                                                FilterType="Numbers,Custom" ValidChars="." Enabled="True">
                                                            </cc1:FilteredTextBoxExtender>
                                                            <div class="validation_msg_box">
                                                                <asp:RequiredFieldValidator ID="rfvDiscountRate" ErrorMessage="Enter Discount Rate" runat="server" ControlToValidate="txtDiscountRate"
                                                                    CssClass="validation_msg_box_sapn" Display="Dynamic" ValidationGroup="Pre Mature Closure"></asp:RequiredFieldValidator>
                                                            </div>
                                                            <span class="highlight"></span>
                                                            <span class="bar"></span>
                                                    ...
                                                    <div style="display: none" class="col-lg-3 col-md-4 col-sm-6 col-xs-12" style="display: none">
                                                        <div class="md-input">
                                                            ...
                                                            <span class="bar"></span>
                                                            <label>
                                                                <asp:Label ID="lblStatus" Text="Settlement Status" runat="server" CssClass="styleDisplayLabel"></asp:Label>
                                                            </label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <cc1:TabPanel runat="server" HeaderText="General" ID="tbCashFlow" CssClass="tabpan"
                                            ...
                                            <ContentTemplate>
                                                    ...
                                                    <div style="display: none" class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                        <div class="md-input">
                                                            <asp:TextBox ID="txtClosureBy" runat="server" ReadOnly="True"
                                                                class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                                                            <%-- <div class="validation_msg_box">
                                                                <asp:RequiredFieldValidator Width="1px" ID="rfvClsoureBy" runat="server"
                                                                    ControlToValidate="txtClosureBy" ValidationGroup="Pre Mature Closure"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <asp:Panel runat="server" ID="Panel2" CssClass="stylePanel" GroupingText="Cashflow Details"
                                                            Width="90%">
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="gird">
                                                                        <%--<div id="div2" style="overflow-x: hidden; overflow-y: scroll; width: 100%; height: 700px"
                                                                            runat="server">--%>
                                                                        ...
                                                                        <asp:GridView ID="grvCashFlow" runat="server" AutoGenerateColumns="False" OnRowDataBound="grvCashFlow_RowDataBound"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Waived Amount">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtWaived" MaxLength="10" Width="100px" OnTextChanged="txtWaived_TextChanged"
                                                                                            AutoPostBack="true" Style="text-align: right; border-color: White; display: none;" onkeypress="fnAllowNumbersOnly(true,false,this);"
                                                                                ...
                                                                                <asp:TemplateField Visible="false" HeaderText="Payable Amount">
                                                                                    <ItemTemplate>
                                                                                ...
                                                                                <asp:TemplateField Visible="false" HeaderText="Received Amount">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblReceived" MaxLength="20" Text='<%#Eval("Received1")%>' runat="server"
                                                                                            Style="text-align: right;"></asp:Label>
                                                                                    </ItemTemplate>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <cc1:TabPanel runat="server" HeaderText="Financial Movements" ID="tbFinanacialMovements" CssClass="tabpan"
                                            BackColor="Red" Enabled="true">
                                            <HeaderTemplate>
                                                Financial Movements
                                            </HeaderTemplate>
                                            <ContentTemplate>
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <asp:Panel runat="server" ID="pnlFinancialMovements" CssClass="stylePanel" GroupingText="Financial Movements">
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="gird">
                                                                        <div id="div1" style="overflow: auto; width: 100%;" runat="server">

                                                                            <asp:GridView ID="grvFinancialMovements" runat="server" HeaderStyle-CssClass="styleGridHeader"
                                                                                RowStyle-HorizontalAlign="left" AutoGenerateColumns="False" Width="100%">
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:BoundField HeaderText="Txn Description" DataField="CashFlw_Desc" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                                                                                    <asp:BoundField HeaderText="Account Description" DataField="GL_SL_DESC" ItemStyle-HorizontalAlign="Left" />
                                                                                    <asp:BoundField HeaderText="Document Date" DataField="Document_Date" ItemStyle-HorizontalAlign="Left" />
                                                                                    <asp:BoundField HeaderText="Txn Amount" DataField="TxnAmount" ItemStyle-HorizontalAlign="right" />
                                                                                    <asp:BoundField HeaderText="Txn Type" DataField="TxnType" ItemStyle-HorizontalAlign="Left" />
                                                                                </Columns>
                                                                                <HeaderStyle CssClass="styleGridHeader" />
                                                                                <RowStyle HorizontalAlign="Center" />
                                                                            </asp:GridView>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <cc1:TabPanel runat="server" HeaderText="General" ID="tbRevocation" CssClass="tabpan"
                                            BackColor="Red" Enabled="true">
                                            <HeaderTemplate>
                                                Revocation
                                            </HeaderTemplate>
                                            <ContentTemplate>
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <asp:Panel runat="server" ID="pnlRevocation" CssClass="stylePanel" GroupingText="Revocation">
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="gird">
                                                                        <div id="div2" style="overflow: auto; width: 100%;" runat="server">

                                                                            <asp:GridView ID="grvRevocation" runat="server" HeaderStyle-CssClass="styleGridHeader"
                                                                                RowStyle-HorizontalAlign="left" AutoGenerateColumns="False" Width="100%">
                                                                                <Columns>
                                                                                    <asp:TemplateField ItemStyle-Width="2%" HeaderText="Sl.No.">
                                                                                        <ItemTemplate>
                    ...
                    <div style="display: none" align="right" class="fixed_btn">
                        <%--<button class="css_btn_enabled" id="btnGo" runat="server"  onserverclick="btnGO_Click"   ValidationGroup="Pre Mature Closure"
                             onclick="if(fnCheckPageValidators('btnGO'))"
                            type="button" accesskey="G" causesvalidation="false" title="GO[Alt+G]">
                            <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>G</u>o
                        </button>--%>
                        ...
                        <button class="css_btn_enabled" id="btnEmail" onserverclick="btnEmail_Click" causesvalidation="false" runat="server"
                            type="button" accesskey="M" title="Email[Alt+M]">
                        ...
                        <button class="css_btn_enabled" id="btnPrint" onserverclick="btnPrint_Click" causesvalidation="false" runat="server"
                            type="button" title="Print[Alt+P]">
                            <i class="fa fa-eraser" aria-hidden="true"></i>&emsp;<u>P</u>rint
                        </button>

                        <button class="css_btn_enabled" id="btnClosure" onserverclick="btnClosure_Click" causesvalidation="false" runat="server" visible="false"
                            type="button" title="Closure Cancellation[Alt+N]">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fnMoveNextTab(Source_Invoker) {
            ...
            if (newindex == tab._tabs.length - 2) {
