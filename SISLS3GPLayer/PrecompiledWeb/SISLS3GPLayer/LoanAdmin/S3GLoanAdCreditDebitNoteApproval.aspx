<%@ page language="C#" autoeventwireup="true" title="S3G - Manual Journal Approval" inherits="S3GLoanAdManualJournalApproval_Add, App_Web_iryvojbu" masterpagefile="~/Common/S3GMasterPageCollapse.master" %>
            ...
            <table width="100%" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="top" class="stylePageHeading">
                        <asp:Label runat="server" Text="Credit Debit Note Approval" ID="lblHeading" CssClass="styleDisplayLabel">
                        </asp:Label>
                    </td>
                </tr>
                <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            &nbsp;<table width="100%" border="0">
                                                                ...
                                                                <tr>
                                                                    <td class="styleFieldLabel">
                                                                        <asp:Label ID="lblmjvNo" runat="server" Text="CRDR Number" CssClass="styleReqFieldLabel"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td class="styleFieldLabel">
                                                                        <asp:Label ID="lblDate" runat="server" Text="CRDR Date"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td class="styleFieldLabel">
                                                                        <asp:Label ID="lblstatus" runat="server" Text="CRDR Status"></asp:Label>
                                                                    </td>
                                                                    <td>
