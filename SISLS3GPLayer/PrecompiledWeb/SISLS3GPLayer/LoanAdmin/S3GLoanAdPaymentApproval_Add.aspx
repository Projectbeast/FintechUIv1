<%@ page language="C#" autoeventwireup="true" title="S3G - Payment Approval" inherits="S3GLoanAdPaymentApproval_Add, App_Web_a0fm2otg" masterpagefile="~/Common/S3GMasterPageCollapse.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                                                        ...
                                                                        <asp:GridView ID="grvApprovalDetails" runat="server" AutoGenerateColumns="false"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Approval Date" ItemStyle-Width="15%">
                                                                                    <ItemTemplate>
                                                                                       <asp:TextBox ID="txtApprovalDate" Text='<%# Bind("Task_StatusDate") %>' runat="server"></asp:TextBox>
                                                                                        <cc1:CalendarExtender runat="server" TargetControlID="txtApprovalDate" PopupButtonID="imgAccountdate" Format="dd-MMM-yyyy"
    ...
    <script language="javascript" type="text/javascript">
        function checkDate_ApprovalDate(sender, args) {
            ...
            var varApplicationDate = document.getElementById('ctl00_ContentPlaceHolder1_txtPaymentReqDate').value;
            ...
            if (selectedDate < varapplndate) {
                alert('Approval Date should be greater than or equal to Payment Request Date');
