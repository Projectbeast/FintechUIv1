<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" enableeventvalidation="false" inherits="LoanAdmin_S3GLoanAdFactoringInvoiceLoading, App_Web_nqjy25qa" title="Factoring Invoice Loading" %>
                        ...
                        <asp:Panel ID="pnlFactoringDetails" runat="server" CssClass="stylePanel" GroupingText="Factoring Invoice Details"
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                        <div class="md-input">
                                            <asp:TextBox runat="server" ID="txtFILDate" Enabled="false" class="md-form-control form-control login_form_content_input requires_true" ToolTip="FIL Date"></asp:TextBox>
                                            <div class="validation_msg_box">
