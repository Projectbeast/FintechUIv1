<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" masterpagefile="~/Common/S3GMasterPageCollapse.master" inherits="S3G_Application_ProcessReports, App_Web_0ejwr0sq" %>
            ...
            <div class="tab-pane fade in active show" id="tab1">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Panel ID="pnlAppProcessRpt" runat="server" GroupingText="Statement Of Account" CssClass="stylePanel">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="md-input">
                                        ...
                                        <asp:DropDownList ID="cmbddlModule" runat="server" ToolTip="Module" AutoPostBack="true" Enabled="false"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="md-input">
                                        ...
                                        <asp:DropDownList ID="ddlReportName" runat="server" ToolTip="Report Name" AutoPostBack="true" Enabled="false"
                                    ...
                                    <asp:GridView ID="grvCustomerSOA" runat="server" AutoGenerateColumns="False" ToolTip="Customer Statement Of Account" EmptyDataText="No Records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Customer Code">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblVoucherNo" runat="server" Text='<%# Bind("CUSTOMER_CODE")  %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Customer Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblVoucherDate" runat="server" Text='<%# Bind("CUSTOMER_NAME")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Credit Amount" ItemStyle-Width="90px">
                                                <ItemTemplate>
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="lblCreditF" Text="Total Credit" runat="server" ToolTip="Total Credit" Visible="false"></asp:Label>
                                                </FooterTemplate>
                                                <FooterStyle HorizontalAlign="Right" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:TemplateField>
                               <%--             <asp:TemplateField HeaderText="" ItemStyle-Width="90px" Visible="true">
                                                <ItemTemplate>
