<%@ page language="C#" masterpagefile="~/Common/S3GMasterPageCollapse.master" autoeventwireup="true" inherits="Collection_S3G_CLN_PDCMaintenance, App_Web_k0kfymif" enableeventvalidation="false" %>
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <asp:Panel ID="pnlMaintenance" runat="server" CssClass="stylePanel" GroupingText="Maintenance">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                            <div class="md-input">
                                                                <asp:DropDownList ID="ddlToStaus" runat="server" AutoPostBack="true" ToolTip="To Status" OnSelectedIndexChanged="ddlToStatus_SelectedIndexChanged" class="md-form-control form-control">
                                                                </asp:DropDownList>
                                                                <span class="highlight"></span>
                                                                <span class="bar"></span>
                                                                <label>
                                                        ...
                                                        <div id="divNtddays" runat="server" visible="false" class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                            <div class="md-input">
                                                                <asp:TextBox ID="txtNTDDays" runat="server" MaxLength="2" class="md-form-control form-control login_form_content_input requires_true"
                                                                    ToolTip="NTD Days" Style="text-align: right;"></asp:TextBox>
                                                                <span class="highlight"></span>
                                                                <span class="bar"></span>
                                                                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txtNTDDays"
                                                                    FilterType="Custom" ValidChars="0123456789" Enabled="true">
                                                                </cc1:FilteredTextBoxExtender>
                                                               
                                                                <label>
                                                                    <asp:Label runat="server" Text="NTD Days" ID="lblNtddays" CssClass="styleDisplayLabel" ToolTip="NTD Days"></asp:Label>
                                                                </label>
                                                            </div>
                                                        </div>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="New Bank">
                                                                                    <ItemTemplate>
                                                                                        <uc:Suggest ID="ucgvDraweeBank" ToolTip="Drawee Bank" runat="server"
                                                                                            ServiceMethod="GetDraweeBankList" WatermarkText="--Select--"
                                                                                            OnItem_Selected="ucgvDraweeBank_Item_Selected" AutoPostBack="true" />
                                                                                        <span class="highlight"></span>
                                                                                        <span class="bar"></span>
                                                                                    </ItemTemplate>
