<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Common/S3GMasterPageCollapse.master" inherits="Reports_S3GRptChequeReturnReport, App_Web_k0kfymif" %>
        ...
        <ContentTemplate>
            <div>
                <div class="row">
                    <div class="col">
                        <h6 class="title_name">
                            <asp:Label ID="lblHeading" runat="server" CssClass="styleDisplayLabel" Text="Cheque Return Report"></asp:Label>
                        </h6>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Panel ID="pnlChequeReturnReport" runat="server" CssClass="stylePanel" Width="97%" GroupingText="Cheque Return Report">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                    <div class="md-input">
                                        <asp:TextBox ID="txtDateFrom" runat="server" ToolTip="Receipt Date From"
                                            class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                                        <div class="validation_msg_box">
                                            <asp:RequiredFieldValidator ID="rfvDateFrom" runat="server" ControlToValidate="txtDateFrom" Enabled="false" ErrorMessage="Select Receipt Date From"
                                                Display="Dynamic" ValidationGroup="btnGo" CssClass="validation_msg_box_sapn"></asp:RequiredFieldValidator>
                                        </div>
                                        <asp:Image ID="imgDateFrom" runat="server" ImageUrl="~/Images/calendaer.gif" ToolTip="Receipt Date From" Visible="false" />
                                        ...
                                        <span class="bar"></span>
                                        <label>
                                            <asp:Label ID="lblDateFrom" runat="server" CssClass="styleDisplayLabel" Text="Receipt Date From" ToolTip="Receipt Date From"></asp:Label>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                    <div class="md-input">
                                        <asp:TextBox ID="txtDateTo" runat="server"
                                            OnTextChanged="txtDateTo_TextChanged" AutoPostBack="true" ToolTip="Receipt Date To"
                                            class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                                        <div class="validation_msg_box">
                                            <asp:RequiredFieldValidator ID="rfvDateTo" runat="server" ControlToValidate="txtDateTo" ErrorMessage="Select Receipt Date To"
                                                Display="Dynamic" ValidationGroup="btnGo" Enabled="false" CssClass="validation_msg_box_sapn"></asp:RequiredFieldValidator>
                                        </div>
                                        <asp:Image ID="imgDateTo" runat="server" ImageUrl="~/Images/calendaer.gif" ToolTip="Date To" Visible="false" />
                                        ...
                                        <span class="bar"></span>
                                        <label>
                                            <asp:Label ID="lblDateTo" runat="server" CssClass="styleDisplayLabel" Text="Receipt Date To" ToolTip="Receipt Date To"></asp:Label>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                    <div class="md-input">
                                        <asp:TextBox ID="Txt_Chq_Rtn_datefrom" runat="server" ToolTip="Cheque Return From"
                                            class="md-form-control form-control login_form_content_input requires_true"></asp:TextBox>
                                        <div class="validation_msg_box">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                ControlToValidate="Txt_Chq_Rtn_datefrom" ErrorMessage="Select Cheque Return From"
                                                Display="Dynamic" ValidationGroup="btnGo" CssClass="validation_msg_box_sapn"></asp:RequiredFieldValidator>
                                        </div>
                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/calendaer.gif" ToolTip="Cheque Return From" Visible="false" />
                                        ...
                                        <span class="bar"></span>
                                        <label>
                                            <asp:Label ID="Label1" runat="server" CssClass="styleReqFieldLabel" Text="Cheque Return From" ToolTip="Cheque Return From"></asp:Label>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                    <div class="md-input">
                                        ...
                                        <div class="validation_msg_box">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Txt_Chq_Rtn_dateTo"
                                                ErrorMessage="Select Cheque Return Date To"
                                                Display="Dynamic" ValidationGroup="btnGo" CssClass="validation_msg_box_sapn"></asp:RequiredFieldValidator>
                                        </div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 styleFieldLabel">
                                    <div class="md-input">
                                        <asp:CheckBox ID="chkAccountLevel" AutoPostBack="true" OnCheckedChanged="chkAccountLevel_CheckedChanged" runat="server" ToolTip="Account Level" />
                                        <span class="highlight"></span>
                                        <span class="bar"></span>

                                        <asp:Label ID="lblAccountLevel" runat="server" CssClass="styleDisplayLabel" Text="Account Level" ToolTip="Account Level"></asp:Label>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 styleFieldLabel" runat="server" id="DivAccountNo">
                                    <div class="md-input">
                                        ...
                                        <cc1:AutoCompleteExtender ID="aceCommonCon" MinimumPrefixLength="3" OnClientPopulated="Common_ItemPopulated" OnClientItemSelected="Common_ItemSelected"
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 styleFieldLabel" runat="server" id="DivDebt">
                                    <div class="md-input">
                                        <asp:DropDownList ID="ddlDebtCollectorType" runat="server"
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 styleFieldLabel" runat="server" id="DivFirstChqRtn">
                                    <div class="md-input">
            ...
            <div class="row">
                ...
                <div id="trLocationCustLevel" runat="server" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <asp:GridView ID="GrdLocationCustLevel" runat="server" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Line Of Business">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLOBB" runat="server" Text='<%#Bind("[Line Of Business]") %>' ToolTip="Line Of Business"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Branch">
                                                ...
                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLocation" runat="server" Text='<%#Bind("Location") %>' ToolTip="Branch"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
            ...
            <div class="row">
                <div id="trAccountLevel" runat="server" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <asp:Panel ID="PnlAccountLevel" runat="server" CssClass="stylePanel" Width="97%" GroupingText="Cheque Return Report Details - AccountLevel">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="gird">
                                        ...
                                        <asp:GridView ID="GrdAccountLevel" runat="server" AutoGenerateColumns="false">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Line Of Business">
                                                    ...
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblLOBDetails" runat="server" Text='<%#Bind("LOB_NAME") %>' ToolTip="Line Of Business"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Branch">
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblLocation" runat="server" Width="90px" Text='<%#Bind("Location") %>' ToolTip="Branch"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Customer Name">
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCustomerName" runat="server" Width="130px" Text='<%#Bind("[Customer_Name]") %>' ToolTip="Customer Name"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Mobile Number">
                                                    ...
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblMobileNumber" runat="server" Width="130px" Text='<%#Bind("Mobile_No") %>' ToolTip="Mobile Number"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Account No">
                                                    ...
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblAccountNo" runat="server" Width="80px" Text='<%#Bind("[Account No]") %>' ToolTip="Account No"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
