<%@ page title="" language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="Reports_FA_RPT_Deal_Availment, App_Web_aagoig1p" %>
                        ...
                        <asp:GridView ID="grvtransaction" runat="server" AutoGenerateColumns="False"  BorderWidth="2"
                            ...
                            <asp:TemplateField HeaderText="Commitment Amount">
                                ...
                                <asp:TemplateField HeaderText="Fund Type">
                                    <ItemTemplate>
                                        <asp:Label ID="lblfundtype" runat="server" Text='<%# Bind("fund_type") %>' ToolTip="Currency"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                  ...
                                  <asp:TemplateField HeaderText="Facility Amount">
                                    <ItemTemplate>
                                        <asp:Label ID="lblfacilityamount" runat="server" Text='<%# Bind("facility_amount1") %>' ToolTip="Facility Amount"></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lblfacilityamountTotal" runat="server" Text="" ToolTip="Total"></asp:Label>
                                    </FooterTemplate>
                                    <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left"  />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Currency">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcurrency" runat="server" Text='<%# Bind("currency_code") %>' ToolTip="Currency"></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Fee">
                                    <ItemTemplate>
                                        <asp:Label ID="lblfee" runat="server" Text='<%# Bind("Fee") %>' ToolTip="Fee"></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lblfeetotal" runat="server" ToolTip="sum of  Fee amount" Text=""></asp:Label>
                                    </FooterTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="Tranche Ref. no.">
                                    <ItemTemplate>
                                        <asp:Label ID="lbltrancherefno" runat="server" Text='<%# Bind("tranche_ref_no") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left"  />
                                    <FooterStyle HorizontalAlign="Left" />
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lbltransactionnumber" runat="server" Text='<%# Bind("transaction_number") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left"  />
                                    <FooterStyle HorizontalAlign="Left" />
                                 ...
                                 <asp:TemplateField HeaderText="Transaction Amount">
                                    <ItemTemplate>
                                        <asp:Label ID="lbltransactionamt" runat="server" Text='<%# Bind("trans_amt1") %>' ToolTip="Facility Amount"></asp:Label>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lbltransactionamtTotal" runat="server" Text="" ToolTip="Total"></asp:Label>
                                    </FooterTemplate>
                                    <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left"  />
                                </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Variable Rate">
                                    <ItemTemplate>
                                        <asp:Label ID="lblvariablerate" runat="server" Text='<%# Bind("variable_rate") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left"  />
                                    <FooterStyle HorizontalAlign="Left" />
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblavailmentdate" runat="server"  Text='<%# Bind("avail_date") %>' ToolTip="Date"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left"  />
                                </asp:TemplateField>
                               ...
                               <asp:TemplateField HeaderText="COF">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcof" runat="server" Text='<%# Bind("cof") %>' ToolTip="COF"></asp:Label>
                                    </ItemTemplate>
