<%@ page title="" language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="Reports_FA_RPT_Fund_Availability, App_Web_aagoig1p" %>
            ...
            <div id="divTransaction" runat="server" style="overflow: scroll; height: 200px; display:none" >
                    ...
                    <td>
                        <asp:GridView ID="grvtransaction" runat="server" AutoGenerateColumns="False"  BorderWidth="2"
                            ...
                            <asp:TemplateField HeaderText="Drawdown Amount" Visible="false">
                                    <ItemTemplate>
