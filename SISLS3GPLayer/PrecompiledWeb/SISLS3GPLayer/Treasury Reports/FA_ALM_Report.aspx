<%@ page title="" language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="Reports_FA_ALM_Report, App_Web_u0nem2mh" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <%--Row For Date Range--%>
                        <tr>
                            <td class="styleFieldLabel" >
                                <asp:Label runat="server" ID="lblFromDate" Text="Structural Liquidity Report as on" />
                            </td>
        ...
        <tr>
            ...
            <tr>
            <td>
                <asp:Panel ID="pnlalm" runat="server" Visible="false" GroupingText="ALM Report"
                            ...
                            <td>
                                <div style="height: 250px; overflow: auto">
                                        ...
                                        <asp:GridView ID="grvliability" runat="server" AutoGenerateColumns="True" ShowFooter="false"
                                            RowStyle-Width="0" Width="100%" OnRowDataBound="grvliability_RowDataBound">
                                            <Columns>
