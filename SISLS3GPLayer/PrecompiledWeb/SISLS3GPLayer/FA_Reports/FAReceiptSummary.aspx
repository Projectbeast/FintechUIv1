<%@ page language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="Reports_FAReceiptSummary, App_Web_upeq32zu" title="Untitled Page" %>
        ...
        <ContentTemplate>
            <div id="tab-content" class="tab-content">
                <div class="tab-pane fade in active show" id="tab1">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <asp:Panel ID="pnlInput" runat="server" CssClass="stylePanel" GroupingText="Input Criteria">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="md-input">
                                            <asp:CheckBox ID="chkLocationPrint" runat="server" AutoPostBack="true"
                                                OnCheckedChanged="ddlSL_SelectedIndexChanged" />
                                            <span class="highlight"></span>
                                            <span class="bar"></span>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="md-input">
                                            ...
                                            <cc1:ComboBox ID="ddlSLFrom" runat="server" CssClass="WindowsStyle" DropDownStyle="DropDownList"
                                                AppendDataBoundItems="true" CaseSensitive="false" AutoCompleteMode="SuggestAppend"
                                                AutoPostBack="true" OnCheckedChanged="ddlSL_SelectedIndexChanged">
                                            </cc1:ComboBox>
                                            <div class="validation_msg_box">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="md-input">
                                            <asp:CheckBox ID="chkSubAccount" runat="server"
                                                AutoPostBack="true" OnCheckedChanged="ddlSL_SelectedIndexChanged" />
                                            <span class="highlight"></span>
                                            <span class="bar"></span>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <asp:Panel ID="pnlSummary" runat="server" Visible="false" GroupingText="Receipt Summary Details"
                    ...
                    <div align="right">
                        ...
                        <button class="css_btn_enabled" id="btnEmail" onserverclick="btnEmail_Click" runat="server"
                            type="button" causesvalidation="false" accesskey="E" title="Email,Alt+E" visible="false">
                            <i class="fa fa-file-excel-o" aria-hidden="true"></i>&emsp;<u>E</u>mail
                        </button>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <asp:CustomValidator ID="cvReceiptSummary" runat="server" CssClass="styleMandatoryLabel"
                                Enabled="true" />
                        </div>
                    </div>
                </div>
