<%@ page language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="Reports_FA_RPT_BankBook, App_Web_upeq32zu" enableeventvalidation="false" title="" %>
            ...
            <div id="tab-content" class="tab-content">
                <div class="tab-pane fade in active show" id="tab1">
                    <div class="row">
                        <div class="col">
                            <h6 class="title_name">
                                <asp:Label runat="server" Text="Bank Book Report" ID="lblHeading" CssClass="styleDisplayLabel">
                                </asp:Label>
                            </h6>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <asp:Panel ID="pnlTransactionDetails" runat="server" Visible="false" GroupingText="Account Ledger Details"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblAcc" runat="server" Text='<%#Eval("Account") %>' ToolTip="Selected Account" />
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Instrument No">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblInstrumentNo" runat="server" Text='<%# Bind("INSTRUMENT_NO") %>' Width="150 px" ToolTip="Description"></asp:Label>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Instrument Date">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblInstrumentDate" runat="server" Text='<%# Bind("INSTRUMENT_DATE") %>' Width="150 px" ToolTip="Description"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                                                        <ItemStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                    ...
                    <asp:Panel ID="Panel1" runat="server" GroupingText="" Width="100%" CssClass="stylePanel">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="gird">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="gird">
                                                <asp:GridView ID="grvTransExcel" runat="server" AutoGenerateColumns="false" ShowFooter="true"
                                                    RowStyle-Width="0" Width="100%" OnRowDataBound="grvTransExcel_RowDataBound" >
                                                    <Columns>
                                                        <%--Serial Number--%>
                                                        <%-- <asp:TemplateField HeaderText="Sl No">
                                                    <ItemTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Instrument Date">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblInstrumentDate" runat="server" Text='<%# Bind("INSTRUMENT_DATE") %>' ToolTip="Description"></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Description">
                                            <ItemTemplate>
                                                ...
                                                <br />
                                                <asp:Label ID="lblremarks" runat="server" Text='<%#Eval("Remarks") %>' ToolTip="Sub Account" Visible="false" />
                                                <asp:HiddenField ID="hdnSelGL" runat="server" Value='<%#Eval("col1") %>' />
                                                <asp:HiddenField ID="hdnSelSL" runat="server" Value='<%#Eval("col2") %>' />
