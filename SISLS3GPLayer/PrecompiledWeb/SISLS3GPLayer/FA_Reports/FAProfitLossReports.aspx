<%@ page language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="FA_Reports_FAProfitLossReports, App_Web_upeq32zu" title="Untitled Page" enableeventvalidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="tab-content" class="tab-content">
        <div class="tab-pane fade in active show" id="tab1">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <asp:Panel ID="pnlInput" runat="server" CssClass="stylePanel" GroupingText="Input Details">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="md-input">
                                    <asp:DropDownList ID="ddlReportType" runat="server" ToolTip="Report Type"
                                        class="md-form-control form-control login_form_content_input requires_true">
                                        <asp:ListItem Value="0" Text="--Select--"> </asp:ListItem>
                                        <asp:ListItem Value="1" Text="P and L fixed format">  </asp:ListItem>
                                        <asp:ListItem Value="2" Text="Balance sheet fixed format">  </asp:ListItem>
                                    </asp:DropDownList>
                                    <div class="validation_msg_box">
                                        <asp:RequiredFieldValidator ID="revReportType" ValidationGroup="btnGo" CssClass="validation_msg_box_sapn"
                                            runat="server" ControlToValidate="ddlReportType" SetFocusOnError="True" ErrorMessage="Select Report Type"
                                            Display="Dynamic" InitialValue="0">
                                        </asp:RequiredFieldValidator>
                                    </div>
                                    <span class="highlight"></span>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="md-input">
                                    <cc1:ComboBox ID="ddlActivity" runat="server" CssClass="WindowsStyle" DropDownStyle="DropDownList"
                                        AppendDataBoundItems="true" CaseSensitive="false" AutoCompleteMode="SuggestAppend"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddl_SelectedIndexChanged" Visible="false">
                                    </cc1:ComboBox>
                                    <div class="validation_msg_box">
                                    ...
                                    <span class="bar"></span>
                                    <label class="tess">
                                        <asp:Label runat="server" ID="lblActivity" CssClass="styleReqFieldLabel" Text="Activity" Visible="false"></asp:Label>
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="md-input">
                                    <asp:CheckBox ID="chkschPL" runat="server" ToolTip="Scheduled PL" Checked="true" Visible="false" />
                                    <asp:Label runat="server" ID="lblscheduledPL" Text="Scheduled P and L" Visible="false" />
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <asp:Panel ID="pnlscheduledPL" runat="server" CssClass="stylePanel" Visible="false" GroupingText="Profit and Loss/Balance Sheet">
