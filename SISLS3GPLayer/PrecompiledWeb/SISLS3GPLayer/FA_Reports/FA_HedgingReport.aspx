<%@ page language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="Reports_FA_HedgingReport, App_Web_upeq32zu" %>
                    ...
                    <table width="100%">
                        <tr>
                            <td class="styleFieldLabel" width="17%">
                                <asp:Label runat="server" ID="lblActivity" CssClass="styleReqFieldLabel" Text="Agent Name"></asp:Label>
                            </td>
                            ...
                            <asp:TemplateField HeaderText="Repay Due Amt">
                                <ItemTemplate>
                                    <asp:Label ID="lblRepayDueAmt" runat="server" Text='<%# Bind("Repay_Due_Amt") %>'
                                        ToolTip="Repay Due Amt"></asp:Label>
                                </ItemTemplate>
