<%@ page language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="FA_Reports_FAProfitLossReport, App_Web_ygb51gin" title="Untitled Page" enableeventvalidation="false" %>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="md-input">
                                    <asp:DropDownList ID="ddlReportType" runat="server" ToolTip="Report Type"
                                        ...
                                        <asp:ListItem Value="1" Text="P and L">  </asp:ListItem>
                                        <asp:ListItem Value="2" Text="Balance Sheet">  </asp:ListItem>
                                    </asp:DropDownList>
                                    <div class="validation_msg_box">
                                    ...
                                    <span class="bar"></span>
                                    <label class="tess">
                                        <asp:Label runat="server" ID="Label1" CssClass="styleReqFieldLabel" Text="Denomination"></asp:Label>
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
