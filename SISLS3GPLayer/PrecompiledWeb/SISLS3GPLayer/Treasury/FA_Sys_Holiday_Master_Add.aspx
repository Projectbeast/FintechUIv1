<%@ page title="" language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="System_Admin_FA_Sys_Holiday_Master_Add, App_Web_zogfwrp2" %>
                        ...
                        <tr>
                            ...
                            <td class="styleDisplayLabel">
                                <%--<asp:DropDownList ID="ddlLocation" runat="server" ToolTip="Location" AutoPostBack="true"
                                    Width="165px" />--%>
                                       <UC:Suggest ID="ddlLocation" runat="server" ServiceMethod="GetBranchList" AutoPostBack ="true"  ItemToValidate ="Value" ValidationGroup="btnSave" IsMandatory="true" ErrorMessage="Select Location" />
