<%@ page language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="Financial_Accounting_FAActualInterest, App_Web_ezlcepmc" %>
                                            ...
                                            <%--<div id="divInterest" runat="server" style="overflow: auto; height: 400px; display: none">--%>
                                                <asp:GridView ID="grvInterestCost" runat="server" AutoGenerateColumns="false" Width="100%"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Arrived Interest" FooterStyle-HorizontalAlign="Center"
