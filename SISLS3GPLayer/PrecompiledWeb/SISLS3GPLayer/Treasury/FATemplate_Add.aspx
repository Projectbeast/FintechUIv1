<%@ page title="" language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="FATemplate_Add, App_Web_ezlcepmc" %>
                                    ...
                                    <td>
                                       <%-- <cc1:ComboBox ID="ddlLocation" runat="server" CssClass="WindowsStyle" DropDownStyle="DropDownList"
                                            ...
                                            AutoCompleteMode="SuggestAppend" MaxLength="0" />--%>
                                              <UC:Suggest ID="ddlLocation" runat="server" ServiceMethod="GetBranchList" OnItem_Selected="ddlLocation_SelectedIndexChanged" AutoPostBack ="true"  ItemToValidate ="Value" ValidationGroup="Save" IsMandatory="true" ErrorMessage="Select Location" />
