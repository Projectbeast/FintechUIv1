<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Common/FAMasterPageCollapse.master" inherits="Treasury_Consortium_Master_View, App_Web_insjbia3" title="Untitled Page" %>
        ...
        <table width="100%" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:GridView ID="grvPaging" runat="server" AutoGenerateColumns="False" Width="100%" OnRowDataBound="grvPaging_RowDataBound" OnRowCommand="grvPaging_RowCommand">
                            <Columns>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnQuery" ImageUrl="~/Images/spacer.gif" CssClass="styleGridQuery"
                                            CommandArgument='<%# Bind("Cons_Id") %>' CommandName="Query" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Modify" >
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnEdit" ImageUrl="~/Images/spacer.gif" CssClass="styleGridEdit"
                                            AlternateText="Modify" CommandArgument='<%# Bind("Cons_Id") %>' runat="server"
                                            CommandName="Modify" />
                                    </ItemTemplate>
                                    <HeaderTemplate>
                                ...
                                <%--  for Location--%>
                                <asp:TemplateField HeaderText="Consortium Name">
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr align="center">
                                                <td>
                                                    <asp:LinkButton ID="lnkbtnSort1" runat="server" Text="Consortium Name" ToolTip="Sort Location"
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblConsName" runat="server" Text='<%# Bind("Consortium_Name") %>'></asp:Label>
                                    </ItemTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="Created Date">
                                    <HeaderTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr align="center">
                                                <td>
                                                    <asp:LinkButton ID="lnkbtnSort2" runat="server" Text="Created Date" ToolTip="Sort Location"
                                                        CssClass="styleGridHeader" OnClick="FunProSortingColumn"> </asp:LinkButton>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblCreatedDate" runat="server" Text='<%# Bind("Created_Date") %>'></asp:Label>
                                           ...
                                           <%--<asp:TemplateField HeaderText="Resolution Amount">
                                    <ItemTemplate>
                                        <asp:Label ID="lblResAmount" runat="server" Text='<%# Bind("Resolution_Amount") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <%-- <asp:TemplateField HeaderText="Start Date">
                                    <ItemTemplate>
                                        <asp:Label ID="lblBudgetType" runat="server" Text='<%# Bind("Start_Date") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                  ...
                  <asp:TemplateField HeaderText="End Date">
                                    <ItemTemplate>
                                        <asp:Label ID="lblBudgetPattern" runat="server" Text='<%# Bind("End_Date") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="styleGridHeader" HorizontalAlign="Center" />
