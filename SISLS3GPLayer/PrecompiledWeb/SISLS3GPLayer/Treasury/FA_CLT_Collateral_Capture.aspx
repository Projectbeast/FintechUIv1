<%@ page title="" language="C#" masterpagefile="~/Common/FAMasterPageCollapse.master" autoeventwireup="true" inherits="Financial_Accounting_FA_CLT_Collateral_Capture, App_Web_zogfwrp2" %>
                    ...
                    <cc1:TabPanel runat="server" HeaderText="General" ID="tabgeneral" CssClass="tabpan"
                        ...
                        <ContentTemplate>
                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="styleFieldAlign" width="28%">
                                                        ...
                                                        <uc2:LOV ID="ucLov" onblur="fnLoadEntity()" runat="server" DispalyContent="Code"
                                                            TextWidth="65%" LOV_Code="FUN" />
                                                        <asp:Button ID="btnCreateCustomer" runat="server" Text="Create" Style="display: none;"
                                                            OnClick="btnCreateCustomer_Click" CssClass="styleSubmitShortButton" CausesValidation="False" />
                                ...
                                <tr>
                                    <td>
                                        <asp:Panel ID="pnlCaptureDetails" Visible="False" runat="server" CssClass="stylePanel"
                                            GroupingText="Deal Details">
                                            <div runat="server" id="divDeal" class="container" style="height: 250px; overflow-x: hidden;
                                                ...
                                                <asp:GridView ID="grvDealDetails" runat="server" AutoGenerateColumns="False" BorderWidth="2px"
                                                    ShowFooter="True" OnRowDataBound="grvDealDetails_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Facility Amount" ItemStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblFacility" runat="server" Style="text-align: right;" Text='<%#Eval("Facility_Amount") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Select">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblAccount" runat="server" Text='<%#Eval("Account") %>' Visible="false"></asp:Label>
                                                            </ItemTemplate>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <asp:Button ID="btnClear" runat="server" CausesValidation="False" CssClass="styleSubmitButton"
                                            OnClick="btnClear_Click" OnClientClick="return fnConfirmClear();" Text="Clear_FA" />
                                ...
                                <tr>
                                    <td>
                                        <asp:ValidationSummary ID="vsGo" runat="server" ValidationGroup="Main" HeaderText="Correct the following validation(s):" />
                                    </td>
                                </tr>
                            </table>
                        </ContentTemplate>
                            ...
                            <asp:Panel runat="server" ID="pnlHighLiqDetails" ScrollBars="Horizontal" CssClass="stylePanel"
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txthInterest" Style="text-align: right" runat="server" Width="65px"
                                                MaxLength="5" ToolTip="Interest Percent" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txthMaturityValue" Style="text-align: right" runat="server" Width="90px"
                                                ToolTip="Maturity Value" MaxLength="12" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txthMarketRate" Style="text-align: right" MaxLength="20" Width="150px"
                                                runat="server" ToolTip="Market Rate" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txthMarketValue" Style="text-align: right" ContentEditable="false"
                                                ToolTip="Market Value" Width="150px" MaxLength="20" runat="server" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="styleFieldLabel">
                                    ...
                                    <tr>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txthownership" Style="text-align: right" MaxLength="3" Width="60px"
                                                runat="server" ToolTip="Ownership %" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td align="center" width="100%" valign="top" height="30px">
                                            ...
                                            <asp:Button ID="btnhClearH" runat="server" CausesValidation="False" OnClick="btnClearH_Click"
                                                CssClass="styleSubmitShortButton" Text="Clear_FA" />
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        <asp:TemplateField HeaderText="Select">
                                            <ItemTemplate>
                                                <asp:RadioButton ID="rdSelect" runat="server" Checked="false" AutoPostBack="true"
                                                    OnCheckedChanged="rdHSelect_CheckedChanged" Text="" Style="padding-left: 7px" />
                                            </ItemTemplate>
                            ...
                            <asp:Panel runat="server" ID="pnlMedLiqDetails" ScrollBars="Horizontal" CssClass="stylePanel"
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txtMValue" Style="text-align: right" runat="server" ToolTip="Value"
                                                Width="90px" MaxLength="12" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txtMMarketValue" Style="text-align: right" runat="server" MaxLength="12"
                                                Width="90px" ToolTip="Market Value" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txtMOwnership" Style="text-align: right" MaxLength="3" Width="60px"
                                                runat="server" ToolTip="Ownership %" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                ...
                                <asp:GridView ID="gvMMedLiqDetails" runat="server" AutoGenerateColumns="false" OnRowDeleting="gvMedLiqDetails_RowDeleting"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:RadioButton ID="rdSelect" runat="server" Checked="false" AutoPostBack="true"
                                                    OnCheckedChanged="rdMSelect_CheckedChanged" Text="" Style="padding-left: 7px" />
                                            </ItemTemplate>
                            ...
                            <asp:Panel runat="server" ID="pnlLowLiqDetails" ScrollBars="Horizontal" CssClass="stylePanel"
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txtLUnitRate" Style="text-align: right" runat="server" MaxLength="12"
                                                Width="120px" ToolTip="Unit Rate" onkeypress="fnAllowNumbersOnly(true,false,this)">
                                            </asp:TextBox>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txtLValue" Style="text-align: right" ReadOnly="false" ToolTip="Value"
                                                runat="server" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txtLMarketValue" Style="text-align: right" runat="server" MaxLength="12"
                                                Width="120px" ToolTip="Market Value" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txtLOwnership" Style="text-align: right" MaxLength="3" Width="60px"
                                                runat="server" ToolTip="Ownership %" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td align="center" width="100%">
                                            <asp:Button ID="btnAddL" runat="server" CssClass="styleSubmitShortButton" Text="Add"
                                                OnClick="btnAddL_Click" ValidationGroup="AddLOWLiqSec" />
                                ...
                                <asp:GridView ID="gvLLowLiqDetails" runat="server" AutoGenerateColumns="false" OnRowDeleting="gvLowLiqDetails_RowDeleting"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:RadioButton ID="rdSelect" runat="server" Checked="false" AutoPostBack="true"
                                                    Text="" Style="padding-left: 7px" OnCheckedChanged="rdLSelect_CheckedChanged" />
                                            </ItemTemplate>
                                            <ItemStyle Width="20px" />
                                        </asp:TemplateField>
                                ...
                                <asp:GridView ID="gvLowLiqDetails" runat="server" Visible="false" AutoGenerateColumns="false"
                                    OnRowDeleting="gvLowLiqDetails_RowDeleting" OnRowDataBound="gvLowLiqDetails_RowDataBound"
                                    ShowFooter="true">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Collateral Type ID" Visible="false">
                                            <ItemTemplate>
                            ...
                            <asp:Panel runat="server" ID="pnlCommodityDetails" ScrollBars="Horizontal" CssClass="stylePanel"
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txtCUnitPrice" Style="text-align: right" MaxLength="12" Width="120px"
                                                ToolTip="Unit Price" onkeypress="fnAllowNumbersOnly(true,false,this)" runat="server"></asp:TextBox>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txtCValue" Style="text-align: right" onkeypress="fnAllowNumbersOnly(true,false,this)"
                                                ToolTip="Value" runat="server" Width="120px"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txtCUnitMarketPrice" Style="text-align: right" MaxLength="12" onkeypress="fnAllowNumbersOnly(true,false,this)"
                                    ...
                                    <tr>
                                        ...
                                        <td class="styleFieldAlign">
                                            <asp:TextBox ID="txtCOwnership" Style="text-align: right" MaxLength="3" Width="60px"
                                                runat="server" ToolTip="Ownership %" onkeypress="fnAllowNumbersOnly(true,false,this)"></asp:TextBox>
                                ...
                                <asp:GridView ID="gvCCommoDetails" runat="server" AutoGenerateColumns="false" OnRowCommand="gvCommoDetails_RowCommand"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:RadioButton ID="rdSelect" runat="server" Checked="false" AutoPostBack="true"
                                                    Text="" Style="padding-left: 7px" OnCheckedChanged="rdCSelect_CheckedChanged" />
                                        ...
                                        <asp:TemplateField HeaderText="Unit Qty" ItemStyle-HorizontalAlign="Right">
                                            <ItemTemplate>
                                ...
                                <asp:GridView ID="gvFFinDetails" runat="server" AutoGenerateColumns="false" OnRowDeleting="gvFinDetails_RowDeleting"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:RadioButton ID="rdSelect" runat="server" Checked="false" AutoPostBack="true"
                                                    Text="" Style="padding-left: 7px" OnCheckedChanged="rdFSelect_CheckedChanged" />
                                            </ItemTemplate>
                                            <ItemStyle Width="20px" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Sl No" Visible="true" ItemStyle-HorizontalAlign="Center">
